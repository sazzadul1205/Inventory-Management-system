// pages/frontend/FAQ/ImplementationSection/ImplementationSection1.jsx

/**
 * Implementation Section Component
 * A comprehensive implementation FAQ section featuring:
 ...
 * - Implementation timeline with visual milestone indicators
 * - Statistics display (avg implementation time, success rate, customers migrated)
 * - Results count when searching
 * - Empty state for no search results
 * - Resources section (Implementation Guide, Video Tutorials, Checklist)
 * - "Need help with implementation" contact CTA with link
...
const ImplementationSection1 = ({ config }) => {
  // ==================== STATE MANAGEMENT ====================
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
            ...
            <span className={`bg-linear-to-r ${config?.title?.highlightGradient || 'from-blue-600 to-indigo-600'} bg-clip-text text-transparent`}>
              {config?.title?.highlightedText || 'Guide'}
            </span>{' '}
        ...
        <div className="mb-12">
          ...
          <div className="relative">
            {/* Vertical Line */}
            <div className="absolute left-1/2 transform -translate-x-1/2 w-0.5 h-full bg-linear-to-b from-blue-500 to-indigo-500 dark:from-blue-400 dark:to-indigo-400" aria-hidden="true" />
            <div className="space-y-8">
              {timeline.map((phase, index) => (
                <div key={index} className={`relative flex items-center ${index % 2 === 0 ? 'flex-row' : 'flex-row-reverse'}`}>
                  <div className="w-1/2" />
                  <div className="absolute left-1/2 transform -translate-x-1/2 w-4 h-4 bg-blue-600 dark:bg-blue-500 rounded-full border-4 border-white dark:border-gray-800 shadow-lg z-10" />
                  <div className={`w-1/2 ${index % 2 === 0 ? 'pr-12 text-right' : 'pl-12'}`}>
                    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 p-6 border border-gray-100 dark:border-gray-700">
                      <div className="flex justify-center mb-3 text-blue-600 dark:text-blue-400">
                        {getIcon(phase.icon, "w-8 h-8")}
                      </div>
                      <div className="text-sm text-blue-600 dark:text-blue-400 font-semibold mb-1">{phase.duration}</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="bg-linear-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-800 rounded-2xl p-6 text-center border border-blue-100 dark:border-gray-700 transition-all duration-300 hover:shadow-lg">
            ...
            <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">Checklist</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
...
export default ImplementationSection1;