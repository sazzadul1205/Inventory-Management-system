// pages/frontend/FAQ/AccountManagementSection/AccountManagementSection3.jsx

/**
 * Account Management Section Component - Knowledge Base with Glossary
 * A comprehensive account management knowledge base featuring:
 * - Tab navigation (FAQs and Glossary)
 ...
 * - Account glossary with term definitions
 * - Statistics display (active users, response time, satisfaction rate)
 ...
 * - Empty state with "Contact Account Support" CTA
 * - Account support section with hours and email contact
 * - Contact form modal with issue type selection
 * - "Still have account questions" contact CTA with link
...
const AccountManagementSection3 = ({ config }) => {
  ...
  const [contactForm, setContactForm] = useState({ name: '', email: '', accountIssue: '', message: '' });
  ...
  const getIcon = useCallback((iconName, className = "w-5 h-5") => {
    ...
    const IconComponent = icons[iconName] || HiOutlineUser;
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <div
            ...
            aria-label="Account management badge"
          >
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300">
            {config?.description || "Find answers to common questions about account setup, security settings, billing, and more."}
          </p>
        </div>
        ...
        <div className="flex justify-center border-b border-gray-200 dark:border-gray-700 mb-12">
          <button
            ...
            className={`flex items-center gap-2 px-6 py-3 text-sm font-medium transition-all duration-300 ${activeTab === 'faq'
              ? 'text-blue-600 dark:text-blue-400 border-b-2 border-blue-600'
              : 'text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300'
              }`}
            aria-label="Show frequently asked questions"
          >
            {getIcon("question", "w-4 h-4")}
            Frequently Asked Questions
          </button>
          <button
            onClick={() => setActiveTab('glossary')}
            className={`flex items-center gap-2 px-6 py-3 text-sm font-medium transition-all duration-300 ${activeTab === 'glossary'
              ? 'text-blue-600 dark:text-blue-400 border-b-2 border-blue-600'
              : 'text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300'
              }`}
            aria-label="Show account glossary"
          >
            {getIcon("id", "w-4 h-4")}
            Account Glossary
          </button>
        ...
        {/* ==================== POPULAR QUESTIONS SECTION - FAQ TAB ONLY ==================== */}
        {activeTab === 'faq' && popularQuestions.length > 0 && searchQuery === '' && (
          <div className="mb-8">
        ...
        {/* ==================== SEARCH AND ACTION BAR - FAQ TAB ONLY ==================== */}
        {activeTab === 'faq' && (
          <div className="flex flex-col md:flex-row gap-4 mb-8">
            <div className="flex-1 relative" ref={searchRef}>
              ...
              <input
                ...
                aria-label="Search account questions"
              />
              {searchQuery && (
                <button
                  onClick={clearSearch}
        ...
        {/* ==================== EXPANDED FILTERS PANEL - FAQ TAB ONLY ==================== */}
        ...
        {/* ==================== FAQ ACCORDION VIEW - FAQ TAB ONLY ==================== */}
        {activeTab === 'faq' && (
        ...
        {/* ==================== SAVED FAQS SECTION - FAQ TAB ONLY ==================== */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 text-center border border-gray-100 dark:border-gray-700">
              <div className="text-sm text-gray-600 dark:text-gray-400">
                <div className="font-semibold text-gray-900 dark:text-white">Account Support Hours</div>
                <div className="mt-2">Monday - Friday: 9am - 6pm EST</div>
                <div className="mt-1">Weekend: Limited support</div>
                <div className="mt-3 text-blue-600 dark:text-blue-400 font-mono text-sm">support@inventory-platform.com</div>
              </div>
            </div>
          </div>
        </div>
        ...
        {showContactForm && (
          <div
            ...
            role="dialog"
            aria-label="Account support form"
            aria-modal="true"
          >
            <div
