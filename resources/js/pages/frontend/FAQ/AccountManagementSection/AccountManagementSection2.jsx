// pages/frontend/FAQ/AccountManagementSection/AccountManagementSection2.jsx

/**
 * Account Management Section Component with Advanced Features
 * A comprehensive account management FAQ and help center featuring:
 ...
 * - Category filters for organizing FAQs (Account Setup, Security, Billing, Settings)
...
const AccountManagementSection2 = ({ config }) => {
  // ==================== STATE MANAGEMENT ====================
  ...
  return (
    <section
      ...
      role="region"
      aria-label="Account Management Help Center"
    >
        ...
        <div className="max-w-6xl mx-auto space-y-4 mb-12">
          {filteredFaqs.map((faq, index) => {
            ...
            return (
              ...
              >
                {/* Header - using div with role="button" instead of button to avoid nesting buttons */}
                <div
                ...
                >
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    {/* Save button - now properly separated from the main click handler */}
                    <button
                      onClick={(e) => {
...
export default AccountManagementSection2;