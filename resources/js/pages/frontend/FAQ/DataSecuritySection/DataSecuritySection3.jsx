// frontend/FAQ/DataSecuritySection/DataSecuritySection3.jsx
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {securityMetrics.map((metric, index) => (
              <div key={index} className="bg-linear-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-800 rounded-2xl p-6 text-center">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {certifications.map((cert, index) => (
              <div key={index} className="bg-white dark:bg-gray-800 rounded-xl shadow-md hover:shadow-lg transition-all p-4 text-center group cursor-pointer" onClick={() => setShowSecurityReport(true)}>
                ...
                <div className="mt-2 opacity-0 group-hover:opacity-100 text-blue-600 text-xs transition-opacity">View Report →</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="mb-12">
          <div className="flex flex-wrap justify-center gap-3">
            {complianceBadges.map((badge, index) => (
              <div key={index} className="flex items-center gap-2 px-3 py-1.5 bg-green-50 dark:bg-green-900/20 rounded-full">
        ...
        {showSecurityReport && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4" onClick={() => setShowSecurityReport(false)}>
            <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl max-w-2xl w-full max-h-[80vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
              <div className="sticky top-0 bg-white dark:bg-gray-800 p-6 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white">Security Report</h3>
                <button onClick={() => setShowSecurityReport(false)} className="text-gray-500 hover:text-gray-700">✕</button>
              </div>
              <div className="p-6">
                <div className="space-y-6">
                  <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <h4 className="font-bold text-gray-900 dark:text-white">SOC 2 Type II Report</h4>
                    </div>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Last audit: December 2023</p>
                    <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">No material findings. All controls operating effectively.</p>
                  </div>
                  <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-4">
                    <div className="flex items-center gap-2 mb-2">
                      <HiOutlineCheck className="w-5 h-5 text-green-600" />
                      <h4 className="font-bold text-gray-900 dark:text-white">ISO 27001 Certification</h4>
                    </div>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Valid through: December 2025</p>
                    <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">Certificate #: ISO-27001-2023-0421</p>
                  </div>
                  <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
                    <button className="w-full py-3 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition-all">
                      <HiOutlineDownload className="inline w-4 h-4 mr-2" />
                      Download Full Report (PDF)
                    </button>
                    <p className="text-xs text-gray-500 text-center mt-3">Available under NDA. Contact security team for access.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 text-center">
              <div className="text-sm text-gray-600 dark:text-gray-400">
                <div className="font-mono text-blue-600">security@inventory-platform.com</div>
                <div className="mt-2">PGP Key available upon request</div>
                <div className="mt-3 text-xs">24/7 Security Incident Response</div>
                <div className="mt-2 text-xs text-green-600">Bug Bounty Program Active</div>
              </div>
            </div>
          </div>
        </div>
        ...
        {showContactForm && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4" onClick={() => setShowContactForm(false)}>
            <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl max-w-md w-full p-8" onClick={(e) => e.stopPropagation()}>
              ...
              <p className="text-xs text-gray-500 text-center mt-4">For critical security issues, please call our emergency hotline.</p>
            </div>
          </div>
        )}
