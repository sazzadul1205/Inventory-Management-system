// frontend/FAQ/IntegrationsSection/IntegrationsSection2.jsx
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {allIntegrations.slice(0, 8).map((integration, index) => (
              <div key={index} className="bg-white dark:bg-gray-800 rounded-xl shadow-md hover:shadow-lg transition-all p-4 text-center">
