// pages/frontend/FAQ/IntegrationsSection/IntegrationsSection2.jsx

/**
 * Integrations Section Component with Advanced Features
 * A comprehensive integrations FAQ and help center featuring:
 ...
 * - Popular integrations grid with status indicators
...
const IntegrationsSection2 = ({ config }) => {
  ...
  return (
    <section
      ...
      role="region"
      aria-label="Integrations Help Center"
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* ==================== FAQ ACCORDION (Fixed - No nested buttons) ==================== */}
        <div className="max-w-6xl mx-auto space-y-4 mb-12">
          {filteredFaqs.map((faq, index) => {
            ...
            return (
              ...
              >
                {/* Header - Not a button, just a div with click handler */}
                <div
