// frontend/FAQ/IntegrationsSection/IntegrationsSection3.jsx
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {allIntegrations.slice(0, 8).map((integration, index) => (
              <div key={index} className="bg-white dark:bg-gray-800 rounded-xl shadow-md hover:shadow-lg transition-all p-4 text-center group">
                ...
                <div className="mt-2 text-xs text-green-600">{integration.status}</div>
                <button className="mt-3 opacity-0 group-hover:opacity-100 text-blue-600 text-xs font-semibold transition-all">
                  View Details
                </button>
              </div>
            ))}
                  ...
                  <div className="space-y-3">
                    {apiEndpoints.map((endpoint, idx) => (
                      <button
                        ...
                        className="w-full text-left p-3 rounded-lg border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-all group"
                      >
                      ...
                      <div key={idx} className="p-5 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                        ...
                        {openFaq === `${category.id}-${idx}` && (
                          <div className="mt-4 pt-4 border-t border-gray-100 dark:border-gray-700">
                            ...
                            {/* Code Snippet for API Questions */}
                            {faq.codeSnippet && (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-2 px-6 py-2 border border-blue-600 text-blue-600 rounded-lg font-semibold hover:bg-blue-50 transition-all"
                >
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6">
              <div className="text-sm font-mono text-gray-600 dark:text-gray-400">
                <div className="text-green-600">GET /api/v1/inventory</div>
                <div className="text-blue-600 mt-2">POST /api/v1/orders</div>
                <div className="text-purple-600 mt-2">PUT /api/v1/products/{'{id}'}</div>
                <div className="text-gray-400 mt-2">...and 50+ more endpoints</div>
              </div>
            </div>
          </div>
        </div>
