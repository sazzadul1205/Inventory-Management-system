// pages/frontend/FAQ/IntegrationsSection/IntegrationsSection3.jsx

/**
 * Integrations Section Component - Knowledge Base with API Playground
 * A comprehensive integrations knowledge base featuring:
 ...
 * - Popular integrations grid with hover effects
 * - Statistics display (available integrations, API calls, connected apps, setup time)
 ...
 * - Empty state with "Ask about an Integration" CTA
 * - API documentation call-to-action with SDKs link
 * - Contact form modal for integration-specific questions
...
const IntegrationsSection3 = ({ config }) => {
  ...
  const [contactForm, setContactForm] = useState({ name: '', email: '', integration: '', message: '' });
  ...
  const allIntegrations = config?.allIntegrations || [];
  ...
  const handleHelpful = useCallback((faqId, isHelpful) => {
    setHelpfulVotes(prev => {
      ...
      localStorage.setItem('integrationFaqHelpfulVotes', JSON.stringify(newVotes));
      return newVotes;
    });
  }, []);
  ...
  const handleSaveFaq = useCallback((faqId) => {
    setSavedFaqs(prev => {
      const newSaved = prev.includes(faqId)
        ...
        : [...prev, faqId];
      localStorage.setItem('savedIntegrationFaqs', JSON.stringify(newSaved));
      return newSaved;
    });
  }, []);
  ...
  const handleContactSubmit = useCallback((e) => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        setContactForm({ name: '', email: '', integration: '', message: '' });
      }, 2000);
    }, 500);
  }, [contactForm]);
  ...
  // ==================== API HANDLER (USES STATE, NOT filteredFaqs) ====================
  /**
  ...
  const handleExport = useCallback(() => {
    ...
    linkElement.setAttribute('download', 'integrations-faq-export.json');
    linkElement.click();
  ...
  useEffect(() => {
    const savedVotes = localStorage.getItem('integrationFaqHelpfulVotes');
    if (savedVotes) {
      setHelpfulVotes(JSON.parse(savedVotes));
    }
    const saved = localStorage.getItem('savedIntegrationFaqs');
    if (saved) {
  ...
  return (
    <section
      ...
      role="region"
      aria-label="Integrations Knowledge Base"
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
            {allIntegrations.slice(0, 8).map((integration, index) => (
              <div
                key={index}
                className="bg-white dark:bg-gray-800 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 p-4 text-center border border-gray-100 dark:border-gray-700 group"
              >
                ...
                <div className="mt-2 text-xs text-green-600 dark:text-green-400">{integration.status}</div>
                <button className="mt-3 opacity-0 group-hover:opacity-100 text-blue-600 dark:text-blue-400 text-xs font-semibold transition-all duration-200">
                  View Details
                </button>
              </div>
            ))}
        ...
        <div className="mb-8 text-center">
          <button
            ...
            aria-label={showApiPlayground ? "Hide API playground" : "Try API playground"}
          >
            {getIcon("code", "w-5 h-5")}
            {showApiPlayground ? 'Hide API Playground' : 'Try API Playground'}
          </button>
        </div>

        {/* ==================== API PLAYGROUND ==================== */}
        {showApiPlayground && (
          <div className="mb-12 bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden border border-gray-100 dark:border-gray-700 animate-fadeIn">
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-3">
                    {apiEndpoints.map((endpoint, idx) => (
                      <button
                        ...
                        className="w-full text-left p-3 rounded-lg border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-all duration-200 group"
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-2">
                            <span className={`text-xs font-mono px-2 py-1 rounded ${endpoint.method === 'GET' ? 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400' :
                              endpoint.method === 'POST' ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400' :
                          ...
                          {getIcon("arrow-right", "w-4 h-4 text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors")}
                        </div>
                ...
                <div>
                  ...
                  <div className="bg-gray-900 dark:bg-gray-950 rounded-lg p-4 min-h-75">
                    {isLoading ? (
                        ...
                        <div key={faqKey} className="p-5 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-200">
                          ...
                          {openFaq === faqKey && (
                            <div className="mt-4 pt-4 border-t border-gray-100 dark:border-gray-700 animate-fadeIn">
                              ...
                              {/* Code Snippet Example for API Questions */}
                              {faq.codeSnippet && (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                Build custom integrations with our comprehensive RESTful API. Complete documentation, SDKs, and code examples available.
              </p>
              <div className="flex flex-wrap gap-3">
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-2 px-6 py-2.5 border border-blue-600 dark:border-blue-400 text-blue-600 dark:text-blue-400 rounded-lg font-semibold hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-all duration-300 transform hover:scale-105"
                >
        ...
        {showContactForm && (
          <div
            ...
            role="dialog"
            aria-label="Integration question form"
            aria-modal="true"
          >
            <div
            ...
            >
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white">Integration Question</h3>
                <button
                  onClick={() => setShowContactForm(false)}
              ...
              {!contactSubmitted ? (
                <form onSubmit={handleContactSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={contactForm.integration}
                      onChange={(e) => setContactForm({ ...contactForm, integration: e.target.value })}
                      placeholder="e.g., Shopify, SAP, Custom API"
                      className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                      required
                    />
                  </div>
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="Please describe your integration needs..."
                      required
                    />
                  </div>
                  <button
                ...
                <div className="text-center py-6">
                  ...
                  <p className="text-gray-600 dark:text-gray-400">Our integration team will respond within 24 hours.</p>
                </div>
              )}
        ...
        <div className="text-center">
          <div className="inline-flex flex-col sm:flex-row items-center gap-5 p-6 bg-linear-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-800 rounded-2xl border border-blue-100 dark:border-gray-700">
            ...
            >
              {config?.contactButtonText || "Contact Integration Support"}
      ...
      <style>{`
        ...
        @media print {
          ...
          .bg-white, .dark\\:bg-gray-800 {
            background: white !important;Hey, Cortana. 
          }
        }
        .bg-noise-pattern {
