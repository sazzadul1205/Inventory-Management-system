...
const PageHero = ({ heroData }) => {
  ...
  const title = heroData?.title || 'Latest';
  const highlightedText = heroData?.highlightedText || 'Insights & Updates';
  const description = heroData?.description || 'Stay up to date with the latest industry trends, product updates, and expert insights from our team.';
  ...
  return (
    <section
      className="relative bg-linear-to-r from-purple-600 to-pink-700 dark:from-purple-900 dark:to-pink-900 text-white overflow-hidden"
      aria-label="Blog page hero section"
    >
      ...
      <div className="container mx-auto px-4 py-20 md:py-28 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <nav aria-label="Breadcrumb" className="flex items-center justify-center gap-2 text-sm text-purple-100 dark:text-purple-200 mb-6">
            <a href="/" className="hover:text-white dark:hover:text-purple-100 transition-colors">Home</a>
            <span aria-hidden="true">•</span>
            <span className="text-white dark:text-white" aria-current="page">Blog</span>
          </nav>
...
const Blog = ({ pageData = { meta: {}, sections: [] } }) => {
