...
const ISOCertificationsSection1 = ({ config }) => {
    ...
    return (
        <section
            ...
            role="region"
            aria-label="ISO Certifications Section"
        >
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center max-w-3xl mx-auto mb-12">
                    ...
                    <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
                        {config?.title?.prefix || "Certified by"} <span className="bg-linear-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">{config?.title?.highlight || "International Standards"}</span> {config?.title?.suffix || ""}
                    </h2>

                    <p className="text-xl text-gray-600 dark:text-gray-400">
                        {config?.description || "We maintain multiple ISO certifications demonstrating our commitment to information security, quality management, and data protection. These internationally recognized standards validate our operational excellence."}
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                    {standards.map((standard, idx) => (
                        <div
                            ...
                            onClick={() => setActiveStandard(activeStandard === idx ? -1 : idx)}
                        >
                ...
                <div className="mb-16 bg-gray-50 dark:bg-gray-800 rounded-3xl p-8 border border-gray-200 dark:border-gray-700">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div className="text-center">
                            ...
                            <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Enhanced Security</h4>
                            <p className="text-sm text-gray-600 dark:text-gray-400">Proven security controls and risk management practices</p>
                        </div>
                        <div className="text-center">
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-400">Internationally accepted security framework</p>
                        </div>
                        <div className="text-center">
                            <div className="w-12 h-12 rounded-full bg-purple-100 dark:bg-purple-900/30 flex items-center justify-center mx-auto mb-3">
                                <HiOutlineUsers className="w-6 h-6 text-purple-600" />
                            </div>
                            <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Customer Trust</h4>
                            <p className="text-sm text-gray-600 dark:text-gray-400">Demonstrated commitment to security and quality</p>
                        </div>
                        <div className="text-center">
                            <div className="w-12 h-12 rounded-full bg-orange-100 dark:bg-orange-900/30 flex items-center justify-center mx-auto mb-3">
                                <HiOutlineRefresh className="w-6 h-6 text-orange-600" />
                            </div>
                            <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Continuous Improvement</h4>
                            <p className="text-sm text-gray-600 dark:text-gray-400">Regular audits drive ongoing enhancement</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-12 bg-linear-to-r from-blue-600 to-purple-600 dark:from-blue-500 dark:to-purple-500 rounded-3xl p-8 text-white text-center">
                    ...
                    <h3 className="text-2xl font-bold mb-4">
                        Questions About ISO Certifications?
                    </h3>
