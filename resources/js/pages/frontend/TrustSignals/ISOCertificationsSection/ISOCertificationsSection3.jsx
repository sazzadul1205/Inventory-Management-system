...
const ISOCertificationsSection3 = ({ config }) => {
    ...
    const handleSubmit = (e) => {
        ...
        const newId = `ISO-${Math.random().toString(36).substring(2, 10).toUpperCase()}`;
    ...
    const standards = useMemo(() => config?.standards || [
        {
            ...
            isFeatured: true,
            videoUrl: '/videos/iso27001-overview.mp4'
        },
        {
            id: 'iso27017',
            title: 'ISO/IEC 27017',
        ...
        >
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                                        ...
                                        <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-xl border border-gray-200 dark:border-gray-700">
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                {story.standardsMet?.map((std, sid) => (
                                                    <span key={sid} className="text-xs bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded-full">{std}</span>
                                                ))}
                                            </div>
                                            {story.videoUrl && (
                                                <button
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-xl border border-gray-200 dark:border-gray-700">
                        ...
                        {formSubmitted ? (
                            <div className="text-center py-12">
                                ...
                                <p className="text-gray-500 text-sm">Our compliance team will review and provide access to the ISO certification documents within 2 business days.</p>
                            </div>
                        ) : (
                ...
                {showStandardModal && selectedStandardDetail && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 overflow-y-auto" onClick={() => setShowStandardModal(false)}>
                        <div className="relative max-w-2xl w-full bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-2xl my-8" onClick={(e) => e.stopPropagation()}>
                            ...
                            <div className="p-6">
                                <div className="flex items-start justify-between mb-4">
                                    ...
                                    <button onClick={() => setShowStandardModal(false)} className="w-8 h-8 bg-gray-100 dark:bg-gray-700 rounded-full flex items-center justify-center text-gray-500 hover:bg-gray-200 transition-colors">
                                ...
                                {selectedStandardDetail.videoUrl && (
                                    <button
                                        onClick={() => { setCurrentVideo(selectedStandardDetail.videoUrl); setShowVideoModal(true); setShowStandardModal(false); }}
                                ...
                                <div className="flex gap-3">
                                    ...
                                    <button onClick={() => setShowStandardModal(false)} className="px-4 py-2 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg font-semibold hover:bg-gray-200 transition-colors">
                                        Close
                                    </button>
                                </div>
                            </div>
