...
/**
 * ISO Certifications Section II - Advanced ISO Hub with Filtering
 *
 * Unique Design Elements:
 * - Stats Cards with Trend Indicators (Certifications, Audit Success, Certification Body, Scope)
 * - Multi-tab UI (ISO Standards, Request Documents, FAQ)
 * - Search Functionality to Filter ISO Standards
 * - Standard Type Filter with Active Filter Indicators
 * - Sort Dropdown (Name, Expiry Date)
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8 mb-12">
          <div>
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl">
              {config?.description ||
                "We maintain multiple ISO certifications demonstrating our commitment to information security, quality management, and data protection."}
            </p>
          </div>
