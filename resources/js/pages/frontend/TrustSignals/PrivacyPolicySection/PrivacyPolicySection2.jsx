...
/**
 * Privacy Policy Section II - Advanced Privacy Center with Interactive Features
 *
 * Unique Design Elements:
 * - Stats Cards for Compliance Metrics with Gradient Backgrounds
 * - Search Functionality to Filter Policy Sections
 * - Quick Navigation Pills for Fast Section Access
 ...
 * - Data Types, Purposes, and Rights Tags Display
 * - LocalStorage Persistence for Cookie Preferences
 * - Success Toast for Preference Saving
 * - Last Updated Date Display
 * - Download Privacy Policy PDF Button
...
const PrivacyPolicySection2 = ({ config }) => {
  ...
  /**
   * Get section badge color based on id
   */
  const getSectionBadgeColor = (id) => {
    const colors = {
      'introduction': 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400',
      'information-collection': 'bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-400',
      'use-of-information': 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400',
      'data-sharing': 'bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400',
      'data-security': 'bg-rose-100 text-rose-700 dark:bg-rose-900/30 dark:text-rose-400',
      'your-rights': 'bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-400',
      'cookies': 'bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-400',
      'data-retention': 'bg-pink-100 text-pink-700 dark:bg-pink-900/30 dark:text-pink-400',
      'international-transfers': 'bg-cyan-100 text-cyan-700 dark:bg-cyan-900/30 dark:text-cyan-400',
      'policy-updates': 'bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-gray-300',
      'contact-us': 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400'
    };
    return colors[id] || 'bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-gray-300';
  };
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8 mb-12">
          <div>
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-4">
              ...
              {config?.title?.suffix || 'Matters to Us'}
            </h1>

            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl">
              {config?.description ||
                "We are committed to transparency about how we collect, use, and protect your personal information. This policy explains our data practices."}
            </p>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {stats.map((stat, idx) => (
              <div
                key={idx}
                className={`bg-linear-to-br ${stat.gradient} rounded-2xl p-3 shadow-lg text-white text-center min-w-24`}
              >
        ...
        <div className="bg-linear-to-r from-blue-600 to-purple-600 dark:from-blue-500 dark:to-purple-500 rounded-3xl p-8 text-white text-center">
          ...
          <p className="text-blue-100 text-sm">
            ...
            <a href="mailto:dpo@supplychainpro.com" className="underline hover:text-white">
