            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center max-w-4xl mx-auto mb-12">
                    ...
                    <h1 className="text-5xl md:text-7xl font-bold text-gray-900 dark:text-white mb-6">
                        {config?.title?.prefix || "Meeting Global"} <span className="bg-linear-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">{config?.title?.highlight || "Compliance"}</span>
                    </h1>
                    ...
                    <div className="grid md:grid-cols-2 gap-6 mb-12">
                        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
                            ...
                            <ul className="space-y-3">
                                <li><a href="#" className="text-sm text-blue-600 hover:underline flex items-center justify-between"><span>SOC 2 Type II Report</span><HiOutlineDownload className="w-4 h-4" /></a></li>
                                <li><a href="#" className="text-sm text-blue-600 hover:underline flex items-center justify-between"><span>ISO 27001 Certificate</span><HiOutlineDownload className="w-4 h-4" /></a></li>
                                <li><a href="#" className="text-sm text-blue-600 hover:underline flex items-center justify-between"><span>GDPR Compliance Statement</span><HiOutlineDownload className="w-4 h-4" /></a></li>
                                <li><a href="#" className="text-sm text-blue-600 hover:underline flex items-center justify-between"><span>PCI DSS Attestation</span><HiOutlineDownload className="w-4 h-4" /></a></li>
                            </ul>
                        </div>
                        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
                            <div className="flex items-center gap-3 mb-4">
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">Need specific compliance documentation? Contact our compliance team.</p>
                            <a href="mailto:compliance@supplychainpro.com" className="inline-flex items-center gap-2 text-blue-600 font-semibold">
