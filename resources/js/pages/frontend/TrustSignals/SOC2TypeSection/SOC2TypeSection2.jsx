...
/**
 * SOC 2 Type II Section - Advanced Compliance Hub with Tabs
 *
 * Unique Design Elements:
 * - Stats Cards with Trend Indicators (SOC 2 Type II, Uptime SLA, Monitoring, Audit Cycle)
 * - Multi-tab UI (Trust Services, Request Report, FAQ)
 ...
 * - Responsive Grid Layout for Trust Services and FAQs
 *
        ...
        {activeTab === 'faq' && (
          <div className="grid md:grid-cols-2 gap-4 mb-12">
            {faqs.map((faq, idx) => (
              <div
                key={idx}
                className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-md transition-all duration-300"
              >
