...
const SOC2TypeSection1 = ({ config }) => {
    const [activeTrustService, setActiveTrustService] = useState(0);
    ...
    return (
        <section
            ...
            role="region"
            aria-label="SOC 2 Type II Section"
        >
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center max-w-3xl mx-auto mb-12">
                    ...
                    <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
                        {config?.title?.prefix || "Validated by"} <span className="bg-linear-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">{config?.title?.highlight || "SOC 2 Type II"}</span> {config?.title?.suffix || ""}
                    </h2>
                    ...
                    <div className="flex flex-col lg:flex-row gap-8 items-center">
                        <div className="lg:w-1/3">
                            <div className="w-32 h-32 rounded-2xl bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center mx-auto">
                                <HiOutlineCertificate className="w-16 h-16 text-blue-600" />
                            </div>
                        </div>
                        <div className="lg:w-2/3">
                            <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">What is SOC 2 Type II?</h3>
                            <p className="text-gray-600 dark:text-gray-400 mb-4">
                                SOC 2 (Service Organization Control 2) is an auditing standard developed by the American Institute of CPAs (AICPA). It evaluates how we manage customer data based on five trust service criteria.
                            </p>
                            <p className="text-gray-600 dark:text-gray-400">
                                Type II means our controls are tested over a period of time (not just a point in time), providing greater assurance about their effectiveness. Our audit covers security, availability, processing integrity, confidentiality, and privacy.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {trustServices.map((service, idx) => (
                            <div
                                ...
                                onClick={() => setActiveTrustService(activeTrustService === idx ? -1 : idx)}
                            >
