...
const GDPRComplianceSection3 = ({ config }) => {
    ...
    const handleSubmit = (e) => {
        ...
        const newId = `GDPR-${Math.random().toString(36).substring(2, 10).toUpperCase()}`;
    ...
    const principles = config?.principles || [
        {
            ...
            videoUrl: "/videos/gdpr-principle-1.mp4"
        },
        {
        ...
        >
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            ...
                            >
                                ...
                                {activePrinciple === idx && (
                                    <div className="mt-4 pt-4 border-t border-gray-100 dark:border-gray-700">
                                        ...
                                        {principle.videoUrl && (
                                            <button
                                                onClick={(e) => { e.stopPropagation(); setCurrentVideo(principle.videoUrl); setShowVideoModal(true); }}
                ...
                {activeTab === 'request' && (
                    <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-xl border border-gray-200 dark:border-gray-700">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-gray-600 dark:text-gray-400">Exercise your data protection rights by submitting a request. We'll respond within 30 days.</p>
                        </div>
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                ...
                                                <input type="text" name="country" value={formData.country} onChange={handleInputChange} className="w-full px-4 py-3 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl" placeholder="e.g., Germany" />
                                            </div>
                                        </div>
                                    </div>
                                )}
                ...
                <div className="mt-12 bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-xl border border-gray-200 dark:border-gray-700 text-center">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-2xl mx-auto">We have appointed a Data Protection Officer to oversee GDPR compliance and serve as your point of contact for privacy matters.</p>
                ...
                {showRightsModal && selectedRight && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 overflow-y-auto" onClick={() => setShowRightsModal(false)}>
                        <div className="relative max-w-md w-full bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-2xl" onClick={(e) => e.stopPropagation()}>
                            <div className="bg-blue-600 p-4">
                                <div className="flex items-center justify-between">
                                    ...
                                    <button onClick={() => setShowRightsModal(false)} className="text-white hover:text-gray-200">
