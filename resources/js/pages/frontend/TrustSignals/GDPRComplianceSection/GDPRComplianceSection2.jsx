...
/**
 * GDPR Compliance Section II - Advanced GDPR Hub with Tabs
 *
 * Unique Design Elements:
 * - Stats Cards with Trend Indicators (Compliance, Breach Notification, Response Time, DPO)
 * - Multi-tab UI (Principles, Your Rights, Submit Request)
 * - GDPR Principles Grid with Expandable Details and Status Indicators
 * - Data Subject Rights Cards with Legal Basis and Process Time
 * - Expandable Rights Details with Submission Integration
 * - GDPR Request Form with Validation and Error Messages
            ...
            {rights.map((right, idx) => (
              ...
              >
                ...
                <button
                  ...
                  aria-label={expandedRight === idx ? 'Show less' : 'Learn more'}
                >
                ...
                {expandedRight === idx && (
                  <div className="mt-4 pt-4 border-t border-gray-100 dark:border-gray-700 animate-fadeIn">
                    ...
                    <button
                      onClick={() => navigateToRequest(right.title)}
                      className="mt-3 inline-flex items-center gap-1 text-blue-600 dark:text-blue-400 text-sm font-semibold hover:underline"
