...
const News = ({ pageData = { meta: {}, sections: [] } }) => {
  ...
  const pageSeoData = useMemo(() => ({
    title: seo.title || meta.title || "News | Breaking News & Updates",
    description: seo.description || meta.description || "Stay informed with the latest news, announcements, and important updates from our company and the industry. Get breaking news and press releases as they happen.",
    keywords: seo.keywords || meta.keywords || "news, breaking news, press releases, media coverage, company announcements, industry events, product launches, awards, recognition",
    ogImage: seo.ogImage || meta.ogImage || "/news-og-image.jpg",
  ...
  return (
    <>
      <Head>
        ...
        <meta name="news_keywords" content={pageSeoData.keywords} />
        <meta property="article:published_time" content={seo.publishedTime || meta.publishedTime} />
        <meta property="article:modified_time" content={seo.modifiedTime || meta.modifiedTime} />
