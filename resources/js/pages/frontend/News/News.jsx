...
const PageHero = ({ heroData }) => {
  ...
  const title = heroData?.title || 'Breaking';
  const highlightedText = heroData?.highlightedText || 'News & Updates';
  const description = heroData?.description || 'Stay informed with the latest news, announcements, and important updates from our company and the industry.';
      ...
      <div className="container mx-auto px-4 py-20 md:py-28 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <nav aria-label="Breadcrumb" className="flex items-center justify-center gap-2 text-sm text-blue-100 dark:text-blue-200 mb-6">
            ...
            <span className="text-white dark:text-white" aria-current="page">News</span>
          </nav>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mt-10">
            <button
              ...
              aria-label="Subscribe to news alerts"
            >
              Subscribe
            </button>
            <button
