// frontend/Blog/PressReleasesSection/PressReleasesSection1.jsx

/**
 * Press Releases Section - Official Media Hub
 *
 * Unique design elements:
 * - Featured press release spotlight with impact metrics
 * - Year filter for chronological navigation
 * - Category filter chips with icons
 * - Save/bookmark functionality for releases
 * - Expandable content sections with executive quotes
 * - Author attribution with avatars
 * - Read time and view count metrics
 * - PDF download links for official releases
 * - Embargo indicator badges for sensitive announcements
 ...
 *
 * All icons from react-icons (hi, fa, hi2)
...
const PressReleasesSection1 = ({ config }) => {
  ...
  // Get featured release (first release marked as featured, otherwise first in filtered list)
  const featuredRelease = useMemo(() => {
    const featured = allReleases.find((r) => r.isFeatured);
    return featured || filteredReleases[0];
  }, [allReleases, filteredReleases]);

  // Regular releases (excluding featured release)
  ...
  return (
    <section
      ...
      role="region"
      aria-label="Press Releases - Official Media Hub"
      itemScope
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
            ...
            <span className="bg-linear-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
              {config?.title?.highlight || 'Press Releases'}
            </span>{' '}
            {config?.title?.suffix || ''}
          </h2>
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400">
            {config?.description ||
              'Get the latest official announcements, company news, and media resources from SupplyChainPro.'}
          </p>
        </div>
        ...
        <div className="relative max-w-2xl mx-auto mb-8">
          ...
          <input
            ...
            placeholder={
              ...
              'Search press releases by title, topic, or keyword...'
            }
        ...
        {featuredRelease && !hasActiveFilters && (
          <div className="mb-16">
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      <div className="flex items-center gap-1 text-sm text-gray-500 dark:text-gray-400">
                        ...
                        <span>{formatRelativeDate(featuredRelease.date)}</span>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-3">
                      ...
                      >
                        ...
                        {savedReleases.includes(featuredRelease.id)
                          ? 'Saved'
                          : 'Save for Later'}
                      </button>
                  ...
                  {release.content && (
                    <div className="mb-4">
                      <button
                        ...
                        aria-label={isExpanded ? 'Show less' : 'Read key highlights'}
                      >
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-gray-100 dark:border-gray-700">
                    ...
                    <div className="flex items-center gap-3">
                      <button
                        ...
                        aria-label={isSaved ? 'Remove from saved' : 'Save press release'}
                      >
                        {getIcon('bookmark', 'w-4 h-4')}
                      </button>
                      {release.pdfUrl && (
          ...
          <div className="mt-12 bg-white dark:bg-gray-800 rounded-3xl p-8 border border-gray-200 dark:border-gray-700 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-2xl mx-auto">
              {config?.newsletter?.description ||
                'Subscribe to receive official press releases and company announcements directly in your inbox.'}
            </p>
            <form
              onSubmit={(e) => {
                e.preventDefault();
