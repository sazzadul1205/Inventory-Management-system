...
const BarcodeScanningSection3 = ({ config }) => {
  ...
  const screenshots = config?.screenshots || [
    { src: "/barcode-screenshots/scan-view.png", title: "Scan View", description: "Point and scan interface" },
    { src: "/barcode-screenshots/batch-mode.png", title: "Batch Mode", description: "Scan multiple items quickly" },
    { src: "/barcode-screenshots/product-info.png", title: "Product Info", description: "Instant product details" },
    { src: "/barcode-screenshots/history.png", title: "Scan History", description: "Track all scans" }
  ];
            ...
            {stats.map((stat, idx) => (
              <div key={idx} className="flex items-center gap-3 bg-gray-50 dark:bg-gray-800 rounded-2xl px-5 py-2 shadow-sm border border-gray-200 dark:border-gray-700">
                <div className="w-8 h-8 rounded-full bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center">
                  {stat.icon === 'qrcode' ? <HiOutlineQrcode className="w-4 h-4 text-blue-600" /> :
                    stat.icon === 'bolt' ? <HiOutlineLightningBolt className="w-4 h-4 text-blue-600" /> :
                      stat.icon === 'check' ? <HiOutlineCheckCircle className="w-4 h-4 text-blue-600" /> :
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-100 dark:border-gray-700">
                      ...
                      {feature.videoUrl && (
                        <button
                          ...
                          className="mt-3 text-blue-600 text-sm font-semibold flex items-center gap-1 hover:underline"
                        >
