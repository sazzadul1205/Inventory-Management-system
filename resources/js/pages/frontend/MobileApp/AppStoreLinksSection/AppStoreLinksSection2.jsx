          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {stats.map((stat, idx) => (
              <div key={idx} className="bg-white dark:bg-gray-800 rounded-2xl p-3 shadow-lg border border-gray-200 dark:border-gray-700 text-center min-w-24">
                ...
                {stat.store === 'appstore' && <div className="text-xs text-blue-500 mt-1">App Store</div>}
                {stat.store === 'playstore' && <div className="text-xs text-green-500 mt-1">Play Store</div>}
              </div>
            ))}
          </div>
        </div>
