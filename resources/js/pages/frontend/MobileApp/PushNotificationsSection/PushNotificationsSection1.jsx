...
const PushNotificationsSection1 = ({ config }) => {
    ...
    return (
        <section
            ...
            role="region"
            aria-label="Push Notifications Section"
        >
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center max-w-3xl mx-auto mb-12">
                    ...
                    <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
                        {config?.title?.prefix || "Never Miss an"} <span className="bg-linear-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">{config?.title?.highlight || "Important Update"}</span> {config?.title?.suffix || ""}
                    </h2>
                        ...
                        <div key={idx} className="flex items-center gap-3 bg-gray-50 dark:bg-gray-800 rounded-2xl px-6 py-3 shadow-sm border border-gray-200 dark:border-gray-700">
                            <div className="w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center">
                                {stat.icon === 'bolt' ? <HiOutlineLightningBolt className="w-5 h-5 text-blue-600" /> :
                                 ...
                                 stat.icon === 'bell' ? <HiOutlineBell className="w-5 h-5 text-blue-600" /> :
                                 <HiOutlineCog className="w-5 h-5 text-blue-600" />}
                            </div>
                            <div>
                                                ...
                                                >
                                                    <div className="flex items-start gap-3">
                                                        <div className="w-8 h-8 rounded-full bg-gray-100 dark:bg-gray-700 flex items-center justify-center shrink-0">
                                                            {getIcon(notif.icon, "w-4 h-4 text-gray-500")}
                                                        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                    {notificationTypes.map((type, idx) => (
                        ...
                        >
                            ...
                            <div className="p-6">
                                <div className={`w-14 h-14 rounded-2xl bg-linear-to-r ${type.color} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-xl border border-gray-200 dark:border-gray-700 mb-12">
                    <h3 className="text-xl font-bold text-center text-gray-900 dark:text-white mb-6">Customize Your Notification Preferences</h3>
                    ...
                    <div className="text-center mt-6">
                        <button className="text-blue-600 text-sm font-semibold hover:underline">Manage all notification preferences →</button>
                    </div>
                </div>
