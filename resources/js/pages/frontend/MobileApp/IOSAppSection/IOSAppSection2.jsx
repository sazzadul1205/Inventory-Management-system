...
/**
 * iOS App Section II - Advanced iOS App Hub with Tabs & Features
 *
 ...
 * - Features Grid with Expandable Details and Category Badges
 * - Compatibility Section with Device Requirements (iPhone, iPad, Mac)
 * - Reviews Section with Star Ratings and User Avatars
          ...
          <div className="space-y-6 mb-12">
            ...
            <div className="text-center">
              <button className="text-blue-600 dark:text-blue-400 font-semibold hover:underline" aria-label="Read all reviews">
                Read all 5,000+ reviews on the App Store →
              </button>
            </div>
          </div>
        )}
