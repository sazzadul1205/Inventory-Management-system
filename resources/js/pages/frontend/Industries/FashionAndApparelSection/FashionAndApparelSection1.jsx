// page/frontend/Industries/FashionAndApparelSection/FashionAndApparelSection1.jsx
...
const FashionAndApparelSection1 = ({ config }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 right-0 w-1/3 h-full bg-linear-to-l from-pink-50/30 to-transparent dark:from-pink-900/5 pointer-events-none" aria-hidden="true"></div>
      <div className="absolute bottom-0 left-0 w-1/3 h-full bg-linear-to-r from-rose-50/30 to-transparent dark:from-rose-900/5 pointer-events-none" aria-hidden="true"></div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
            {stats.map((stat, index) => (
              <div key={index} className="text-center p-6 bg-gray-50 dark:bg-gray-800/50 rounded-2xl">
                ...
                <div className="text-2xl font-bold text-pink-600 dark:text-pink-400 mb-1">{stat.value}</div>
          ...
          {activeTab === 'overview' && (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="mt-8">
                  <Link
                    ...
                    className="inline-flex items-center gap-2 px-6 py-3 bg-pink-600 text-white rounded-lg font-semibold hover:bg-pink-700 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
                  >
              ...
              <div className="relative">
                <div className="bg-linear-to-br from-pink-100 to-rose-100 dark:from-pink-900/20 dark:to-rose-900/20 rounded-2xl p-8">
                  <div className="text-6xl mb-4 text-center">👗</div>
                  <div className="grid grid-cols-2 gap-4">
                    <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-xl shadow-sm">
                      <div className="text-2xl font-bold text-pink-600">500+</div>
                      <div className="text-xs text-gray-500">Fashion Brands</div>
                    </div>
                    <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-xl shadow-sm">
                    ...
                    <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-xl shadow-sm">
                      ...
                      <div className="text-xs text-gray-500">Inventory Accuracy</div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          {activeTab === 'solutions' && (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {solutions.map((solution, index) => (
                <div key={index} className="p-6 bg-linear-to-br from-pink-50 to-rose-50 dark:from-pink-900/10 dark:to-rose-900/10 rounded-2xl hover:shadow-lg transition-all">
        ...
        {config?.showFeatures && (
          <div className="mb-12 bg-gray-50 dark:bg-gray-800/50 rounded-2xl p-8">
            <h3 className="text-xl font-bold text-gray-900 dark:text-white text-center mb-6">
              {config?.features?.title || "Why Fashion & Apparel Leaders Choose Us"}
            </h3>
        ...
        {config?.showSustainability && (
          <div className="mb-12 text-center">
            <div className="inline-flex items-center gap-3 px-6 py-3 bg-pink-50 dark:bg-pink-900/20 rounded-full">
              <HiOutlineShieldCheck className="w-5 h-5 text-pink-600" />
              <span className="text-sm text-gray-700 dark:text-gray-300">{config?.sustainabilityText || "Sustainable Practices | Ethical Sourcing | Circular Fashion Ready"}</span>
            </div>
          </div>
        )}
