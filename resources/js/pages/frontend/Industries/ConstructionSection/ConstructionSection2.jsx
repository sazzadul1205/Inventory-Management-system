// page/frontend/Industries/ConstructionSection/ConstructionSection2.jsx
...
const ConstructionSection2 = ({ config }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/4 right-0 w-96 h-96 bg-amber-200 dark:bg-amber-900/20 rounded-full filter blur-3xl" aria-hidden="true"></div>
      <div className="absolute bottom-1/4 left-0 w-96 h-96 bg-orange-200 dark:bg-orange-900/20 rounded-full filter blur-3xl" aria-hidden="true"></div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative bg-white dark:bg-gray-800 rounded-3xl shadow-2xl overflow-hidden mb-12">
              ...
              <div className="flex items-center justify-between flex-wrap gap-4">
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <HiOutlineLocationMarker className="w-4 h-4 text-amber-200" />
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-6 border-b border-gray-200 dark:border-gray-700">
              {currentCase.results?.map((result, idx) => (
                <div key={idx} className="text-center">
                  <div className="text-2xl font-bold text-amber-600 dark:text-amber-400">{result.value}</div>
            ...
            <div className="p-6">
              ...
              {currentCase.projectType && (
                <div className="mt-4 flex flex-wrap gap-2">
                  {currentCase.projectType.map((badge, idx) => (
                    <span key={idx} className="text-xs px-2 py-1 bg-amber-50 dark:bg-amber-900/20 text-amber-700 dark:text-amber-400 rounded-full">
                      {badge}
                    </span>
                  ))}
                </div>
              ...
              {currentCase.testimonial && (
                <div className="mt-6 p-6 bg-amber-50 dark:bg-amber-900/20 rounded-2xl">
              ...
              <div className="mt-6 flex flex-col sm:flex-row gap-3">
                <Link
                  ...
                  className="px-4 py-2 bg-amber-600 text-white rounded-lg font-semibold hover:bg-amber-700 transition-colors inline-flex items-center gap-2 justify-center"
                >
                ...
                <Link
                  ...
                  className="px-4 py-2 border-2 border-amber-600 text-amber-600 rounded-lg font-semibold hover:bg-amber-50 dark:hover:bg-amber-900/20 transition-colors inline-flex items-center gap-2 justify-center"
                >
              ...
              {config?.additionalCases?.map((caseStudy, index) => (
                ...
                >
                  <div className="p-6">
                    ...
                    <div className="mb-3">
                      <span className="text-xl font-bold text-amber-600">{caseStudy.result}</span>
                    ...
                    <Link
                      href={caseStudy.link}
                      className="inline-flex items-center gap-1 text-amber-600 font-semibold text-sm hover:gap-2 transition-all"
                    >
                      Read Story
        ...
        {config?.showCostCalculator && (
          <div className="bg-linear-to-r from-amber-50 to-orange-50 dark:from-gray-800 dark:to-gray-800 rounded-2xl p-6 mb-12">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
              <div className="md:col-span-2">
                <div className="flex items-center gap-2 mb-2">
                  <HiOutlineCurrencyDollar className="w-5 h-5 text-amber-600" />
                ...
                <div className="flex gap-6">
                  <div>
                    <div className="text-xl font-bold text-amber-600">{config?.theftReduction || "80-90%"}</div>
                    <div className="text-xs text-gray-500">Theft Reduction</div>
                  </div>
                  <div>
                    <div className="text-xl font-bold text-amber-600">{config?.wasteReduction || "15-25%"}</div>
                    <div className="text-xs text-gray-500">Waste Reduction</div>
                  </div>
                  <div>
                    <div className="text-xl font-bold text-amber-600">{config?.paybackPeriod || "3-6"}</div>
              ...
              <div>
                <Link
                  ...
                  className="block text-center px-4 py-2 bg-amber-600 text-white rounded-lg font-semibold hover:bg-amber-700 transition-colors"
                >
        ...
        {config?.showPartners && (
          <div className="mb-12 text-center">
            <p className="text-sm text-gray-500 mb-4">{config?.partnersTitle || "Trusted by leading construction firms across North America"}</p>
