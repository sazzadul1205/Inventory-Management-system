// pages/frontend/Industries/ECommerceAndRetailSection/ECommerceAndRetailSection2.jsx

/**
 * E-Commerce & Retail Section 2 Component - Success Stories Carousel
 * Features customer success stories for retail and e-commerce businesses with:
...
const ECommerceAndRetailSection2 = ({ config }) => {
  ...
  const autoplayRef = useRef(null);                                                      // Ref for autoplay interval
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-center">
              <div className="lg:col-span-2">
                ...
                <div className="flex flex-wrap gap-6">
                  <div>
                    <div className="text-xl font-bold text-orange-600 dark:text-orange-400">{config?.roiSavings || "25-35%"}</div>
                    <div className="text-xs text-gray-500 dark:text-gray-400">Inventory Cost Reduction</div>
                  </div>
                  <div>
                    <div className="text-xl font-bold text-orange-600 dark:text-orange-400">{config?.roiTurnover || "2-3x"}</div>
                    <div className="text-xs text-gray-500 dark:text-gray-400">Inventory Turnover Increase</div>
                  </div>
                  <div>
                    <div className="text-xl font-bold text-orange-600 dark:text-orange-400">{config?.roiPayback || "4-6"}</div>
        ...
        {config?.showIntegrations && config?.integrations?.length > 0 && (
          <div className="mb-12 text-center">
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-5">
              {config?.integrationsTitle || "Seamlessly integrates with your retail stack"}
            </p>
