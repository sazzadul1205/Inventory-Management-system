// page/frontend/Industries/ECommerceAndRetailSection/ECommerceAndRetailSection2.jsx
...
const ECommerceAndRetailSection2 = ({ config }) => {
  ...
  return (
    <section
      ...
      role="region"
      aria-label="E-Commerce & Retail Success Stories Section"
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative bg-white dark:bg-gray-800 rounded-3xl shadow-2xl overflow-hidden mb-12">
              ...
              <div className="flex items-center justify-between flex-wrap gap-4">
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <HiOutlineLocationMarker className="w-4 h-4 text-orange-200" />
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-6 border-b border-gray-200 dark:border-gray-700">
              {currentCase.results?.map((result, idx) => (
                <div key={idx} className="text-center">
                  <div className="text-2xl font-bold text-orange-600 dark:text-orange-400">{result.value}</div>
            ...
            <div className="p-6">
              ...
              {currentCase.testimonial && (
                <div className="mt-6 p-6 bg-orange-50 dark:bg-orange-900/20 rounded-2xl">
              ...
              <div className="mt-6 flex flex-col sm:flex-row gap-3">
                <Link
                  ...
                  className="px-4 py-2 bg-orange-600 text-white rounded-lg font-semibold hover:bg-orange-700 transition-colors inline-flex items-center gap-2 justify-center"
                >
                ...
                <Link
                  ...
                  className="px-4 py-2 border-2 border-orange-600 text-orange-600 rounded-lg font-semibold hover:bg-orange-50 dark:hover:bg-orange-900/20 transition-colors inline-flex items-center gap-2 justify-center"
                >
              ...
              {config?.additionalCases?.map((caseStudy, index) => (
                ...
                >
                  <div className="p-6">
                    ...
                    <div className="mb-3">
                      <span className="text-xl font-bold text-orange-600">{caseStudy.result}</span>
        ...
        {config?.showROI && (
          <div className="bg-linear-to-r from-orange-50 to-amber-50 dark:from-gray-800 dark:to-gray-800 rounded-2xl p-6 mb-12">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
              <div className="md:col-span-2">
                <div className="flex items-center gap-2 mb-2">
                  <HiOutlineCurrencyDollar className="w-5 h-5 text-orange-600" />
                  <h3 className="font-bold text-gray-900 dark:text-white">Calculate Your Retail ROI</h3>
                </div>
                <p className="text-gray-600 dark:text-gray-400 text-sm mb-4">
                  See how much you could save with our retail optimization solutions. Based on similar retailers:
                </p>
                <div className="flex gap-6">
                  <div>
                    <div className="text-xl font-bold text-orange-600">{config?.roiSavings || "25-35%"}</div>
                    <div className="text-xs text-gray-500">Inventory Cost Reduction</div>
                  </div>
                  <div>
                    <div className="text-xl font-bold text-orange-600">{config?.roiTurnover || "2-3x"}</div>
                    <div className="text-xs text-gray-500">Inventory Turnover Increase</div>
                  </div>
                  <div>
                    <div className="text-xl font-bold text-orange-600">{config?.roiPayback || "4-6"}</div>
              ...
              <div>
                <Link
                  href={config?.roiLink || "/roi-calculator?industry=retail"}
                  className="block text-center px-4 py-2 bg-orange-600 text-white rounded-lg font-semibold hover:bg-orange-700 transition-colors"
                >
                  Calculate Your ROI
                </Link>
              </div>
        ...
        {config?.showIntegrations && (
          <div className="mb-12 text-center">
            <p className="text-sm text-gray-500 mb-4">{config?.integrationsTitle || "Seamlessly integrates with your retail stack"}</p>
          ...
          <div className="text-center">
            <div className="inline-flex flex-col sm:flex-row items-center gap-4 p-6 bg-linear-to-r from-orange-50 to-amber-50 dark:from-gray-800 dark:to-gray-800 rounded-2xl">
              ...
              <Link
                ...
                className="px-6 py-3 bg-orange-600 text-white rounded-lg font-semibold hover:bg-orange-700 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl inline-flex items-center gap-2"
              >
...
export default ECommerceAndRetailSection2;