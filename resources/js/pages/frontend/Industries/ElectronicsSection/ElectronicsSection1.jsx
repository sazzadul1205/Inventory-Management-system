// page/frontend/Industries/ElectronicsSection/ElectronicsSection1.jsx
...
const ElectronicsSection1 = ({ config }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 right-0 w-1/3 h-full bg-linear-to-l from-purple-50/30 to-transparent dark:from-purple-900/5 pointer-events-none" aria-hidden="true"></div>
      <div className="absolute bottom-0 left-0 w-1/3 h-full bg-linear-to-r from-indigo-50/30 to-transparent dark:from-indigo-900/5 pointer-events-none" aria-hidden="true"></div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {activeTab === 'overview' && (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                <div className="bg-linear-to-br from-purple-100 to-indigo-100 dark:from-purple-900/20 dark:to-indigo-900/20 rounded-2xl p-8">
                  <div className="text-6xl mb-4 text-center">🔌</div>
                  <div className="grid grid-cols-2 gap-4">
                    <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-xl shadow-sm">
                      <div className="text-2xl font-bold text-purple-600">300+</div>
                      <div className="text-xs text-gray-500">Electronics Companies</div>
                    </div>
                    <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-xl shadow-sm">
                      <div className="text-2xl font-bold text-purple-600">5M+</div>
                      <div className="text-xs text-gray-500">Components Managed</div>
                    </div>
                    <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-xl shadow-sm">
          ...
          {activeTab === 'solutions' && (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {solutions.map((solution, index) => (
                <div key={index} className="p-6 bg-linear-to-br from-purple-50 to-indigo-50 dark:from-purple-900/10 dark:to-indigo-900/10 rounded-2xl hover:shadow-lg transition-all">
        ...
        {config?.showFeatures && (
          <div className="mb-12 bg-gray-50 dark:bg-gray-800/50 rounded-2xl p-8">
            <h3 className="text-xl font-bold text-gray-900 dark:text-white text-center mb-6">
              {config?.features?.title || "Why Electronics Leaders Choose Us"}
            </h3>
        ...
        {config?.showStandards && (
          <div className="mb-12 text-center">
            <div className="inline-flex items-center gap-3 px-6 py-3 bg-purple-50 dark:bg-purple-900/20 rounded-full">
              <HiOutlineShieldCheck className="w-5 h-5 text-purple-600" />
              <span className="text-sm text-gray-700 dark:text-gray-300">{config?.standardsText || "ISO 9001 | IPC-A-610 | J-STD-001 | RoHS Compliant | REACH"}</span>
            </div>
          </div>
        )}
