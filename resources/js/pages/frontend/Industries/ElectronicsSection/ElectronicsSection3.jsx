/**
 * Electronics Section 3 Component - Features & FAQ
 * Comprehensive electronics solution showcase featuring:
 * - Interactive feature tabs with detailed descriptions
 * - Industry standards badges (IPC, RoHS, REACH, etc.)
...
const ElectronicsSection3 = ({ config }) => {
  // ==================== STATE MANAGEMENT ====================
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-32 right-10 w-24 h-24 bg-purple-300/5 dark:bg-purple-500/5 rounded-full blur-2xl" aria-hidden="true" />
            ...
            {benefits.map((benefit, index) => (
              ...
              >
                <div className="flex justify-center mb-3">
                  {getIcon(benefit.icon, "w-8 h-8 text-purple-600")}
                </div>
                <div className="text-xl md:text-2xl font-bold text-purple-600 dark:text-purple-400 mb-1 font-mono">
                  {benefit.value}
                </div>
                ...
                {features.map((feature, index) => (
                  <button
                    ...
                    className={`w-full text-left p-4 rounded-xl transition-all duration-200 group ${selectedFeature === index
                      ? 'bg-linear-to-r from-purple-50 to-indigo-50 dark:from-purple-900/20 dark:to-indigo-900/20 border-l-4 border-purple-500 shadow-md'
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className="shrink-0">
                        {getIcon(feature.icon, "w-6 h-6 text-purple-600")}
                      </div>
                      <div>
                  ...
                  <div className="bg-gray-50 dark:bg-gray-800/50 rounded-2xl p-6 md:p-8 transition-all duration-300 animate-fadeIn">
                    <div className="flex items-center gap-3 mb-4">
                      <div className="w-12 h-12 bg-purple-100 dark:bg-purple-900/30 rounded-xl flex items-center justify-center">
                        {getIcon(currentFeature.icon, "w-6 h-6 text-purple-600")}
                      </div>
                    ...
                    {currentFeature.standards && currentFeature.standards.length > 0 && (
                      <div className="mb-5 flex flex-wrap gap-2">
                        {currentFeature.standards.map((badge, idx) => (
          ...
          <div className="mb-12 bg-gray-50 dark:bg-gray-800/50 rounded-2xl overflow-hidden shadow-lg">
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="p-6 md:p-8">
                <div className="text-center mb-5">
                  <div className="flex justify-center mb-3">
                    {getIcon("sparkles", "w-10 h-10 text-purple-500")}
                  </div>
                  <h3 className="text-xl font-bold text-purple-600 dark:text-purple-400">After Our Solution</h3>
                </div>
                <ul className="space-y-3">
        ...
        {config?.showTechStack && config?.techStack?.length > 0 && (
          <div className="mb-12">
            <h3 className="text-xl md:text-2xl font-bold text-gray-900 dark:text-white text-center mb-8">
              {config?.techStackTitle || "Seamlessly Integrates With Your Electronics Stack"}
            </h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {config.steps.map((step, index) => (
                <div key={index} className="text-center relative">
                  ...
                  {/* Step Number */}
                  <div className="relative z-10 w-12 h-12 bg-purple-100 dark:bg-purple-900/30 rounded-full flex items-center justify-center text-lg font-bold text-purple-600 mx-auto mb-4">
                    {index + 1}
                  </div>

                  {/* Step Icon */}
                  <div className="flex justify-center mb-3">
                    {getIcon(step.icon, "w-8 h-8 text-purple-600")}
                  </div>
              ...
              {faqs.map((faq, index) => (
                ...
                >
                  ...
                  >
                    ...
                    <span className="text-purple-500 text-xl shrink-0">
                      {expandedFaq === index ? (
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {config.resources.map((resource, index) => (
                ...
                >
                  <div className="flex justify-center mb-3">
                    {getIcon(resource.icon, "w-10 h-10 text-purple-600")}
                  </div>
                  <h4 className="font-bold text-gray-900 dark:text-white mb-2 text-center group-hover:text-purple-600 transition-colors">
                    {resource.title}
                  </h4>
                  <p className="text-sm text-gray-600 dark:text-gray-400 text-center mb-3 leading-relaxed">
                    {resource.description}
                  </p>
                  <span className="text-sm text-purple-600 dark:text-purple-400 font-semibold inline-flex items-center justify-center gap-1 w-full group-hover:gap-2 transition-all">
                    {resource.cta}
...
export default ElectronicsSection3;