/**
 * Electronics Section 2 Component - Success Stories Carousel
 * Features electronics industry customer success stories with:
 * - Interactive carousel/slider for featured case studies
 * - Results grid display
 * - Compliance badges (RoHS, REACH, IPC, etc.)
 * - Testimonials with quotes
 * - Additional case studies grid
 * - Obsolescence management calculator preview
...
const ElectronicsSection2 = ({ config }) => {
  ...
  const getIcon = useCallback((iconName, className = "w-5 h-5") => {
    ...
    const IconComponent = icons[iconName] || HiOutlineChip;
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-20 right-10 w-24 h-24 bg-purple-300/5 dark:bg-purple-500/5 rounded-full blur-2xl" aria-hidden="true" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative bg-white dark:bg-gray-800 rounded-3xl shadow-2xl overflow-hidden mb-12 transition-all duration-300">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      {getIcon("location", "w-4 h-4 text-purple-200")}
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 p-6 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/30">
              {currentCase.results?.map((result, idx) => (
                <div key={idx} className="text-center">
                  <div className="text-xl md:text-2xl font-bold text-purple-600 dark:text-purple-400 font-mono">
                    {result.value}
                  </div>
            ...
            <div className="p-6 md:p-8">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="animate-fadeIn">
                  <div className="flex items-center gap-2 mb-3">
                    {getIcon("chart", "w-5 h-5 text-purple-500")}
                ...
                <div className="animate-fadeIn" style={{ animationDelay: "100ms" }}>
                  <div className="flex items-center gap-2 mb-3">
                    {getIcon("bulb", "w-5 h-5 text-purple-500")}
              ...
              {currentCase.compliance && currentCase.compliance.length > 0 && (
                <div className="mt-5 flex flex-wrap gap-2">
                  {currentCase.compliance.map((badge, idx) => (
                    <span key={idx} className="text-xs px-2.5 py-1 bg-purple-50 dark:bg-purple-900/20 text-purple-700 dark:text-purple-400 rounded-full flex items-center gap-1">
              ...
              {currentCase.testimonial && (
                <div className="mt-6 p-6 bg-purple-50 dark:bg-purple-900/20 rounded-2xl border border-purple-100 dark:border-purple-800">
              ...
              <div className="mt-6 flex flex-col sm:flex-row gap-3">
                <Link
                  ...
                  className="flex items-center justify-center gap-2 px-5 py-2.5 bg-linear-to-r from-purple-600 to-indigo-600 text-white rounded-xl font-semibold hover:shadow-md transition-all"
                >
                ...
                <Link
                  ...
                  className="flex items-center justify-center gap-2 px-5 py-2.5 border-2 border-purple-600 text-purple-600 dark:text-purple-400 rounded-xl font-semibold hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-all"
                >
                ...
                >
                  <div className="p-6">
                    <div className="flex justify-between items-start mb-3">
                      {getIcon(caseStudy.icon, "w-10 h-10 text-purple-600")}
                    ...
                    <div className="mb-3">
                      <span className="text-xl font-bold text-purple-600 dark:text-purple-400">{caseStudy.result}</span>
                    ...
                    <Link
                      href={caseStudy.link}
                      className="inline-flex items-center gap-1 text-purple-600 dark:text-purple-400 font-semibold text-sm hover:gap-2 transition-all group-hover:text-purple-700"
                    >
                      Read Story
        ...
        {config?.showObsolescenceCalculator && (
          <div className="bg-linear-to-r from-purple-50 to-indigo-50 dark:from-gray-800 dark:to-gray-800 rounded-2xl p-6 mb-12 hover:shadow-lg transition-all">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-center">
              <div className="lg:col-span-2">
                <div className="flex items-center gap-2 mb-2">
                  {getIcon("dollar", "w-5 h-5 text-purple-600")}
                ...
                <div className="flex flex-wrap gap-6">
                  <div>
                    <div className="text-xl font-bold text-purple-600 dark:text-purple-400">{config?.obsolescenceReduction || "40-60%"}</div>
                    <div className="text-xs text-gray-500 dark:text-gray-400">Obsolescence Cost Reduction</div>
                  </div>
                  <div>
                    <div className="text-xl font-bold text-purple-600 dark:text-purple-400">{config?.lastTimeBuySavings || "25-35%"}</div>
                    <div className="text-xs text-gray-500 dark:text-gray-400">Last-Time Buy Savings</div>
                  </div>
                  <div>
                    <div className="text-xl font-bold text-purple-600 dark:text-purple-400">{config?.paybackPeriod || "6-9"}</div>
              ...
              <div>
                <Link
                  ...
                  className="block text-center px-5 py-2.5 bg-linear-to-r from-purple-600 to-indigo-600 text-white rounded-xl font-semibold hover:shadow-md transition-all"
                >
        ...
        {config?.showPartners && config?.partners?.length > 0 && (
          <div className="mb-12 text-center">
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-5">
              {config?.partnersTitle || "Trusted by leading electronics manufacturers and distributors"}
            </p>
          ...
          <div className="text-center">
            <div className="inline-flex flex-col sm:flex-row items-center gap-5 p-6 bg-linear-to-r from-purple-50 to-indigo-50 dark:from-gray-800 dark:to-gray-800 rounded-2xl border border-purple-100 dark:border-gray-700">
              <div className="w-12 h-12 bg-purple-100 dark:bg-purple-900/30 rounded-full flex items-center justify-center">
                {getIcon("chip", "w-6 h-6 text-purple-600")}
              </div>
