// page/frontend/Industries/Manufacturing/ManufacturingSection3.jsx
...
const ManufacturingSection3 = ({ config }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 right-0 w-80 h-80 bg-cyan-100 dark:bg-cyan-900/10 rounded-full filter blur-3xl" aria-hidden="true"></div>
              ...
              {config?.steps?.map((step, index) => (
                <div key={index} className="text-center relative">
                  {index < config?.steps?.length - 1 && (
                    <div className="hidden md:block absolute top-12 left-1/2 w-full h-0.5 bg-linear-to-r from-blue-200 to-cyan-200 dark:from-blue-800 dark:to-cyan-800" aria-hidden="true"></div>
                  )}
