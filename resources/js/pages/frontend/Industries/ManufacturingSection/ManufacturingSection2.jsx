// page/frontend/Industries/ManufacturingSection/ManufacturingSection2.jsx

/**
 * Manufacturing Section 2 Component - Success Stories Carousel
 * Features manufacturing customer success stories with:
...
const ManufacturingSection2 = ({ config }) => {
  ...
  return (
    <section
      ...
      role="region"
      aria-label="Manufacturing Success Stories Section"
    >
      ...
      <div className="absolute bottom-20 left-10 w-32 h-32 bg-cyan-300/5 dark:bg-cyan-500/5 rounded-full blur-2xl" aria-hidden="true" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="p-6 md:p-8">
              ...
              <div className="mt-6 flex flex-col sm:flex-row gap-3">
                <Link
                  ...
                  className="flex items-center justify-center gap-2 px-5 py-2.5 bg-linear-to-r from-blue-600 to-cyan-600 text-white rounded-xl font-semibold hover:shadow-md transition-all"
                >
        ...
        {/* ==================== ROI CALCULATOR PREVIEW ==================== */}
        {config?.showROI && (
          <div className="bg-linear-to-r from-blue-50 to-cyan-50 dark:from-gray-800 dark:to-gray-800 rounded-2xl p-6 mb-12 hover:shadow-lg transition-all">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-center">
              <div className="lg:col-span-2">
                <div className="flex items-center gap-2 mb-2">
                  {getIcon("dollar", "w-5 h-5 text-blue-600")}
                  <h3 className="font-bold text-gray-900 dark:text-white">Calculate Your Manufacturing ROI</h3>
                </div>
                <p className="text-gray-600 dark:text-gray-400 text-sm mb-4">
                  See how much you could save with our manufacturing optimization solutions. Based on similar manufacturers:
                </p>
                <div className="flex flex-wrap gap-6">
                  <div>
                    <div className="text-xl font-bold text-blue-600 dark:text-blue-400">{config?.roiSavings || "20-30%"}</div>
                    <div className="text-xs text-gray-500 dark:text-gray-400">Production Cost Reduction</div>
                  </div>
                  <div>
                    <div className="text-xl font-bold text-blue-600 dark:text-blue-400">{config?.roiDowntime || "50%"}</div>
                    <div className="text-xs text-gray-500 dark:text-gray-400">Downtime Reduction</div>
                  </div>
                  <div>
                    <div className="text-xl font-bold text-blue-600 dark:text-blue-400">{config?.roiPayback || "6-8"}</div>
              ...
              <div>
                <Link
                  href={config?.roiLink || "/roi-calculator?industry=manufacturing"}
                  className="block text-center px-5 py-2.5 bg-linear-to-r from-blue-600 to-cyan-600 text-white rounded-xl font-semibold hover:shadow-md transition-all"
                >
                  Calculate Your ROI
                </Link>
              </div>
        ...
        {config?.showIntegrations && config?.integrations?.length > 0 && (
          <div className="mb-12 text-center">
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-5">
              {config?.integrationsTitle || "Seamlessly integrates with your manufacturing stack"}
            </p>
