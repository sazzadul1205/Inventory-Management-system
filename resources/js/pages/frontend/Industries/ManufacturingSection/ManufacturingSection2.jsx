  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {config?.showROI && (
          <div className="bg-linear-to-r from-blue-50 to-cyan-50 dark:from-gray-800 dark:to-gray-800 rounded-2xl p-6 mb-12">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
              <div className="md:col-span-2">
                ...
                <div className="flex gap-6">
                  <div>
                    <div className="text-xl font-bold text-blue-600">{config?.roiSavings || "20-30%"}</div>
                    <div className="text-xs text-gray-500">Production Cost Reduction</div>
                  </div>
                  <div>
                    <div className="text-xl font-bold text-blue-600">{config?.roiDowntime || "50%"}</div>
                    <div className="text-xs text-gray-500">Downtime Reduction</div>
                  </div>
                  <div>
                    <div className="text-xl font-bold text-blue-600">{config?.roiPayback || "6-8"}</div>
        ...
        {config?.showIntegrations && (
          <div className="mb-12 text-center">
            <p className="text-sm text-gray-500 mb-4">{config?.integrationsTitle || "Seamlessly integrates with your manufacturing stack"}</p>
