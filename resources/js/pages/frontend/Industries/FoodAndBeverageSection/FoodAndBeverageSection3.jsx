/**
 * Food & Beverage Section 3 Component - Features & FAQ
 * Comprehensive food and beverage solution showcase featuring:
...
const FoodAndBeverageSection3 = ({ config }) => {
  ...
  return (
    <section
      ...
      role="region"
      aria-label="Food & Beverage Features Section"
    >
        ...
        {config?.showTechStack && config?.techStack?.length > 0 && (
          <div className="mb-12">
            <h3 className="text-xl md:text-2xl font-bold text-gray-900 dark:text-white text-center mb-8">
              {config?.techStackTitle || "Seamlessly Integrates With Your Food & Beverage Stack"}
            </h3>
...
export default FoodAndBeverageSection3;