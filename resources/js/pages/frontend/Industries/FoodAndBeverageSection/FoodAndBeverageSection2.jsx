// page/frontend/Industries/FoodAndBeverageSection/FoodAndBeverageSection2.jsx
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {currentCase && (
          <div className="relative bg-white dark:bg-gray-800 rounded-3xl shadow-2xl overflow-hidden mb-12">
            ...
            <div className="p-6">
              ...
              {/* Safety Badges */}
              {currentCase.safetyBadges && (
                <div className="mt-4 flex flex-wrap gap-2">
                  {currentCase.safetyBadges.map((badge, idx) => (
                    <span key={idx} className="text-xs px-2 py-1 bg-orange-50 dark:bg-orange-900/20 text-orange-700 dark:text-orange-400 rounded-full">
                      {badge}
                    </span>
                  ))}
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
              <div className="md:col-span-2">
                ...
                <div className="flex gap-6">
                  <div>
                    <div className="text-xl font-bold text-orange-600">{config?.wasteReduction || "25-35%"}</div>
                    <div className="text-xs text-gray-500">Spoilage Reduction</div>
                  </div>
                  <div>
                    <div className="text-xl font-bold text-orange-600">{config?.shelfLifeIncrease || "20-30%"}</div>
                    <div className="text-xs text-gray-500">Shelf-Life Extension</div>
                  </div>
                  <div>
                    <div className="text-xl font-bold text-orange-600">{config?.paybackPeriod || "3-6"}</div>
        ...
        {config?.showPartners && (
          <div className="mb-12 text-center">
            <p className="text-sm text-gray-500 mb-4">{config?.partnersTitle || "Trusted by leading food & beverage companies"}</p>
