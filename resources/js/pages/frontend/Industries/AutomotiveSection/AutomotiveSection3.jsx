/**
 * Automotive Section 3 Component - Features & FAQ
 * Comprehensive automotive solution showcase featuring:
...
const AutomotiveSection3 = ({ config }) => {
  ...
  return (
    <section
      ...
      role="region"
      aria-label="Automotive Features Section"
    >
      ...
      <div className="absolute bottom-0 right-0 w-80 h-80 bg-slate-100 dark:bg-slate-900/10 rounded-full filter blur-3xl" aria-hidden="true" />
      ...
      <div className="absolute bottom-32 left-10 w-32 h-32 bg-slate-300/5 dark:bg-slate-500/5 rounded-full blur-2xl" aria-hidden="true" />
                ...
                {features.map((feature, index) => (
                  <button
                    ...
                    className={`w-full text-left p-4 rounded-xl transition-all duration-200 group ${selectedFeature === index
                      ? 'bg-linear-to-r from-blue-50 to-slate-50 dark:from-blue-900/20 dark:to-slate-900/20 border-l-4 border-blue-500 shadow-md'
        ...
        {config?.showTechStack && config?.techStack?.length > 0 && (
          <div className="mb-12">
            <h3 className="text-xl md:text-2xl font-bold text-gray-900 dark:text-white text-center mb-8">
              {config?.techStackTitle || "Seamlessly Integrates With Your Automotive Stack"}
            </h3>
              ...
              {config.steps.map((step, index) => (
                <div key={index} className="text-center relative">
                  ...
                  {index < config.steps.length - 1 && (
                    <div className="hidden md:block absolute top-12 left-1/2 w-full h-0.5 bg-linear-to-r from-blue-200 to-slate-200 dark:from-blue-800 dark:to-slate-800" aria-hidden="true" />
                  )}
...
export default AutomotiveSection3;