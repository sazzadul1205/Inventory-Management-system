/**
 * Automotive Section 2 Component - Success Stories Carousel
 * Features automotive industry customer success stories with:
 * - Interactive carousel/slider for featured case studies
 * - Results grid display
 * - Quality standards badges (IATF, ISO, etc.)
 * - Testimonials with quotes
 * - Additional case studies grid
 * - JIT inventory savings calculator preview
 * - OEM partners showcase
 * 
...
const AutomotiveSection2 = ({ config }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-20 left-10 w-32 h-32 bg-slate-300/5 dark:bg-slate-500/5 rounded-full blur-2xl" aria-hidden="true" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {currentCase && (
          <div className="relative bg-white dark:bg-gray-800 rounded-3xl shadow-2xl overflow-hidden mb-12 transition-all duration-300">
            ...
            <div className="p-6 md:p-8">
              ...
              {currentCase.standards && currentCase.standards.length > 0 && (
              ...
              <div className="mt-6 flex flex-col sm:flex-row gap-3">
                <Link
                  ...
                  className="flex items-center justify-center gap-2 px-5 py-2.5 bg-linear-to-r from-blue-600 to-slate-600 text-white rounded-xl font-semibold hover:shadow-md transition-all"
                >
        ...
        {config?.showJITCalculator && (
          <div className="bg-linear-to-r from-blue-50 to-slate-50 dark:from-gray-800 dark:to-gray-800 rounded-2xl p-6 mb-12 hover:shadow-lg transition-all">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-center">
              <div className="lg:col-span-2">
                ...
                <div className="flex flex-wrap gap-6">
                  <div>
                    <div className="text-xl font-bold text-blue-600 dark:text-blue-400">{config?.inventoryReduction || "25-35%"}</div>
                    <div className="text-xs text-gray-500 dark:text-gray-400">Inventory Reduction</div>
                  </div>
                  <div>
                    <div className="text-xl font-bold text-blue-600 dark:text-blue-400">{config?.carryingCostSavings || "30-40%"}</div>
                    <div className="text-xs text-gray-500 dark:text-gray-400">Carrying Cost Savings</div>
                  </div>
                  <div>
                    <div className="text-xl font-bold text-blue-600 dark:text-blue-400">{config?.paybackPeriod || "6-8"}</div>
              ...
              <div>
                <Link
                  ...
                  className="block text-center px-5 py-2.5 bg-linear-to-r from-blue-600 to-slate-600 text-white rounded-xl font-semibold hover:shadow-md transition-all"
                >
        ...
        {config?.showPartners && config?.partners?.length > 0 && (
          <div className="mb-12 text-center">
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-5">
              {config?.partnersTitle || "Trusted by leading automotive manufacturers and suppliers"}
            </p>
