// page/frontend/Industries/AutomotiveSection/AutomotiveSection2.jsx
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {currentCase && (
          <div className="relative bg-white dark:bg-gray-800 rounded-3xl shadow-2xl overflow-hidden mb-12">
            ...
            <div className="bg-linear-to-r from-blue-600 to-slate-600 p-8 text-white">
              <div className="flex items-center justify-between flex-wrap gap-4">
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <HiOutlineLocationMarker className="w-4 h-4 text-blue-200" />
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-6 border-b border-gray-200 dark:border-gray-700">
              {currentCase.results?.map((result, idx) => (
                <div key={idx} className="text-center">
                  <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">{result.value}</div>
            ...
            <div className="p-6">
              ...
              {currentCase.standards && (
                <div className="mt-4 flex flex-wrap gap-2">
                  {currentCase.standards.map((badge, idx) => (
                    <span key={idx} className="text-xs px-2 py-1 bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-400 rounded-full">
                      {badge}
                    </span>
                  ))}
                </div>
              ...
              {currentCase.testimonial && (
                <div className="mt-6 p-6 bg-blue-50 dark:bg-blue-900/20 rounded-2xl">
              ...
              <div className="mt-6 flex flex-col sm:flex-row gap-3">
                <Link
                  ...
                  className="px-4 py-2 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition-colors inline-flex items-center gap-2 justify-center"
                >
                ...
                <Link
                  ...
                  className="px-4 py-2 border-2 border-blue-600 text-blue-600 rounded-lg font-semibold hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors inline-flex items-center gap-2 justify-center"
                >
              ...
              {config?.additionalCases?.map((caseStudy, index) => (
                ...
                >
                  <div className="p-6">
                    ...
                    <div className="mb-3">
                      <span className="text-xl font-bold text-blue-600">{caseStudy.result}</span>
        ...
        {/* JIT Savings Calculator Preview */}
        {config?.showJITCalculator && (
          <div className="bg-linear-to-r from-blue-50 to-slate-50 dark:from-gray-800 dark:to-gray-800 rounded-2xl p-6 mb-12">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
              <div className="md:col-span-2">
                <div className="flex items-center gap-2 mb-2">
                  <HiOutlineCurrencyDollar className="w-5 h-5 text-blue-600" />
                  <h3 className="font-bold text-gray-900 dark:text-white">Calculate Your JIT Inventory Savings</h3>
                </div>
                <p className="text-gray-600 dark:text-gray-400 text-sm mb-4">
                  See how much you could save with optimized just-in-time inventory management:
                </p>
                <div className="flex gap-6">
                  <div>
                    <div className="text-xl font-bold text-blue-600">{config?.inventoryReduction || "25-35%"}</div>
                    <div className="text-xs text-gray-500">Inventory Reduction</div>
                  </div>
                  <div>
                    <div className="text-xl font-bold text-blue-600">{config?.carryingCostSavings || "30-40%"}</div>
                    <div className="text-xs text-gray-500">Carrying Cost Savings</div>
                  </div>
                  <div>
                    <div className="text-xl font-bold text-blue-600">{config?.paybackPeriod || "6-8"}</div>
              ...
              <div>
                <Link
                  href={config?.calculatorLink || "/jit-calculator"}
        ...
        {config?.showPartners && (
          <div className="mb-12 text-center">
            <p className="text-sm text-gray-500 mb-4">{config?.partnersTitle || "Trusted by leading automotive manufacturers and suppliers"}</p>
...
export default AutomotiveSection2;