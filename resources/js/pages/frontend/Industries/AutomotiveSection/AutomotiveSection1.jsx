// page/frontend/Industries/AutomotiveSection/AutomotiveSection1.jsx
...
const AutomotiveSection1 = ({ config }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 w-1/3 h-full bg-linear-to-r from-slate-50/30 to-transparent dark:from-slate-900/5 pointer-events-none" aria-hidden="true"></div>
          ...
          {activeTab === 'overview' && (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                <div className="bg-linear-to-br from-blue-100 to-slate-100 dark:from-blue-900/20 dark:to-slate-900/20 rounded-2xl p-8">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-xl shadow-sm">
                      ...
                      <div className="text-xs text-gray-500">Automotive Companies</div>
                    </div>
                    <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-xl shadow-sm">
                      <div className="text-2xl font-bold text-blue-600">2.5M+</div>
                      <div className="text-xs text-gray-500">Parts Managed</div>
                    </div>
                    <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-xl shadow-sm">
          ...
          {activeTab === 'solutions' && (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {solutions.map((solution, index) => (
                <div key={index} className="p-6 bg-linear-to-br from-blue-50 to-slate-50 dark:from-blue-900/10 dark:to-slate-900/10 rounded-2xl hover:shadow-lg transition-all">
        ...
        {config?.showFeatures && (
          <div className="mb-12 bg-gray-50 dark:bg-gray-800/50 rounded-2xl p-8">
            <h3 className="text-xl font-bold text-gray-900 dark:text-white text-center mb-6">
              {config?.features?.title || "Why Automotive Leaders Choose Us"}
            </h3>
        ...
        {config?.showStandards && (
          <div className="mb-12 text-center">
            <div className="inline-flex items-center gap-3 px-6 py-3 bg-blue-50 dark:bg-blue-900/20 rounded-full">
              ...
              <span className="text-sm text-gray-700 dark:text-gray-300">{config?.standardsText || "IATF 16949 | ISO 9001 | MMOG/LE | AIAG Guidelines"}</span>
            </div>
          </div>
        )}
