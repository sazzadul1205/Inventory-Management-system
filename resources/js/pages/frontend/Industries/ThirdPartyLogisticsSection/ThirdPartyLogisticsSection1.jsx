/**
 * Third-Party Logistics Section 1 Component
 * Showcases 3PL industry solutions with:
 * - Statistics display for logistics metrics
 * - Tabbed content (Overview, Challenges, Solutions)
 * - Interactive feature highlights
 * - Industry standards badges (ISO, SOC2, GS1)
 * - Warehouse efficiency information
 * 
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {activeTab === 'overview' && config?.overview && (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center animate-fadeIn">
              ...
              <div className="relative">
                <div className="bg-linear-to-br from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-800 rounded-2xl p-8 border border-blue-100 dark:border-gray-700">
                  <div className="flex justify-center mb-5">
                    {getIcon("truck", "w-12 h-12 text-blue-600")}
                  </div>
          ...
          {activeTab === 'solutions' && solutions.length > 0 && (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 animate-fadeIn">
              {solutions.map((solution, index) => (
                <div
                  key={index}
                  className="p-6 bg-linear-to-br from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-800 rounded-2xl hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-blue-100 dark:border-gray-700 group"
                >
        ...
        {config?.showFeatures && features?.items?.length > 0 && (
          <div className="mb-12 bg-gray-50 dark:bg-gray-800/50 rounded-2xl p-8 hover:shadow-lg transition-all">
            <h3 className="text-xl md:text-2xl font-bold text-gray-900 dark:text-white text-center mb-6">
              {features.title || "Why 3PL Leaders Choose Us"}
            </h3>
          ...
          <div className="mb-12 text-center">
            <div className="inline-flex flex-wrap items-center justify-center gap-3 px-6 py-3 bg-blue-50 dark:bg-blue-900/20 rounded-full">
              ...
              <span className="text-sm text-gray-700 dark:text-gray-300">
                {config?.standardsText || "ISO 9001 | SOC 2 Type II | GS1 Standards | WMS Certified | C-TPAT"}
              </span>
            </div>
          </div>
        )}
        ...
        {config?.showSuccessMetrics && config?.successMetrics && (
          <div className="mb-12 bg-linear-to-r from-blue-600 to-indigo-600 rounded-2xl p-6 text-white shadow-xl">
