// page/frontend/Industries/ThirdPartyLogisticsSection/ThirdPartyLogisticsSection3.jsx
...
const ThirdPartyLogisticsSection3 = ({ config }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 left-0 w-96 h-96 bg-blue-100 dark:bg-blue-900/10 rounded-full filter blur-3xl" aria-hidden="true"></div>
              ...
              {features[selectedFeature] && (
                <div className="bg-gray-50 dark:bg-gray-800/50 rounded-2xl p-8">
                  ...
                  <Link
                    ...
                    className="inline-flex items-center gap-2 text-blue-600 font-semibold hover:gap-3 transition-all mt-4"
                  >
          ...
          <div className="mb-12 bg-gray-50 dark:bg-gray-800/50 rounded-2xl overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="p-8">
                <div className="text-center mb-4">
                  <div className="text-3xl mb-2">😊</div>
                  <h3 className="text-xl font-bold text-blue-600">After Our Solution</h3>
                </div>
                <ul className="space-y-3">
              ...
              {config?.steps?.map((step, index) => (
                <div key={index} className="text-center relative">
                  {index < config?.steps?.length - 1 && (
                    <div className="hidden md:block absolute top-12 left-1/2 w-full h-0.5 bg-linear-to-r from-blue-200 to-indigo-200 dark:from-blue-800 dark:to-indigo-800" aria-hidden="true"></div>
                  )}
                  <div className="relative z-10 w-16 h-16 bg-blue-100 dark:bg-blue-900/30 rounded-full flex items-center justify-center text-2xl font-bold text-blue-600 mx-auto mb-4">
                    {index + 1}
                  </div>
