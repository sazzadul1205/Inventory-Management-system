/**
 * Third-Party Logistics Section 3 Component - Features & FAQ
 * Comprehensive 3PL solution showcase featuring:
...
const ThirdPartyLogisticsSection3 = ({ config }) => {
  // ==================== STATE MANAGEMENT ====================
  ...
  return (
    <section
      ...
      role="region"
      aria-label="Third-Party Logistics Features Section"
    >
                ...
                {features.map((feature, index) => (
                  <button
                    ...
                    className={`w-full text-left p-4 rounded-xl transition-all duration-200 group ${selectedFeature === index
                        ? 'bg-linear-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border-l-4 border-blue-500 shadow-md'
        ...
        {config?.showTechStack && config?.techStack?.length > 0 && (
          <div className="mb-12">
            <h3 className="text-xl md:text-2xl font-bold text-gray-900 dark:text-white text-center mb-8">
              {config?.techStackTitle || "Seamlessly Integrates With Your 3PL Stack"}
            </h3>
              ...
              {config.steps.map((step, index) => (
                <div key={index} className="text-center relative">
                  ...
                  {index < config.steps.length - 1 && (
                    <div className="hidden md:block absolute top-12 left-1/2 w-full h-0.5 bg-linear-to-r from-blue-200 to-indigo-200 dark:from-blue-800 dark:to-indigo-800" aria-hidden="true" />
                  )}
          ...
          <div className="text-center">
            <div className="inline-flex flex-col sm:flex-row items-center gap-5 p-6 bg-linear-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-800 rounded-2xl border border-blue-100 dark:border-gray-700">
              ...
              <span className="text-gray-700 dark:text-gray-300 font-medium text-center sm:text-left">
                {config?.ctaText || "Ready to transform your 3PL operations?"}
              </span>
              <Link
...
export default ThirdPartyLogisticsSection3;