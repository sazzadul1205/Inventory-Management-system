// page/frontend/Industries/ThirdPartyLogisticsSection/ThirdPartyLogisticsSection2.jsx
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
              <div className="md:col-span-2">
                ...
                <div className="flex gap-6">
                  <div>
                    <div className="text-xl font-bold text-blue-600">{config?.billingTimeReduction || "75%"}</div>
                    <div className="text-xs text-gray-500">Billing Time Reduction</div>
                  </div>
                  <div>
                    <div className="text-xl font-bold text-blue-600">{config?.revenueRecovery || "5-10%"}</div>
                    <div className="text-xs text-gray-500">Revenue Recovery</div>
                  </div>
                  <div>
                    <div className="text-xl font-bold text-blue-600">{config?.paybackPeriod || "3-6"}</div>
        ...
        {config?.showPartners && (
          <div className="mb-12 text-center">
            <p className="text-sm text-gray-500 mb-4">{config?.partnersTitle || "Trusted by leading 3PL providers serving diverse industries"}</p>
