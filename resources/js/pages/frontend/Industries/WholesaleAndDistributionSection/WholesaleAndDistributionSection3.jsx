...
const WholesaleAndDistributionSection3 = ({ config }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 left-0 w-96 h-96 bg-cyan-100 dark:bg-cyan-900/10 rounded-full filter blur-3xl" aria-hidden="true" />
      <div className="absolute bottom-0 right-0 w-80 h-80 bg-teal-100 dark:bg-teal-900/10 rounded-full filter blur-3xl" aria-hidden="true" />
              ...
              {config?.steps?.map((step, index) => (
                <div key={index} className="text-center relative">
                  {index < config?.steps?.length - 1 && (
                    <div className="hidden md:block absolute top-12 left-1/2 w-full h-0.5 bg-linear-to-r from-cyan-200 to-teal-200 dark:from-cyan-800 dark:to-teal-800" aria-hidden="true" />
                  )}
