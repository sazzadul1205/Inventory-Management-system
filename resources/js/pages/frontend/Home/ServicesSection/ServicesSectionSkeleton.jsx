        ...
        <div className="bg-linear-to-r from-gray-200 to-gray-300 dark:from-gray-700 dark:to-gray-600 rounded-3xl p-8 md:p-12">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="flex-1 text-center md:text-left">
              <div className="h-8 w-3/4 bg-white/30 dark:bg-gray-600/50 rounded-lg mb-2 animate-pulse mx-auto md:mx-0" />
              <div className="h-5 w-2/3 bg-white/30 dark:bg-gray-600/50 rounded animate-pulse mx-auto md:mx-0" />
            </div>

            {/* CTA Button Skeleton */}
            <div className="h-14 w-48 bg-white/50 dark:bg-gray-600/50 rounded-xl animate-pulse" />
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-16">
          {[1, 2, 3, 4].map((stat) => (
            <div key={stat} className="text-center">
              <div className="h-10 w-24 bg-gray-200 dark:bg-gray-700 rounded-lg animate-pulse mx-auto mb-2" />
