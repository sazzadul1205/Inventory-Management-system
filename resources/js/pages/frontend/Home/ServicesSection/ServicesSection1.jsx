...
const ServicesSection1 = ({
  ...
  const structuredData = {
    ...
    "name": seo.structuredData?.name || "Our Services",
  ...
  return (
    <>
      {/* SEO Meta Tags */}
      <Head>
        <title>{seo.title || "Our Services - Sazzad Inventory & Logistics"}</title>
        <meta name="description" content={seo.description || config?.description} />
        <meta name="keywords" content={seo.keywords || "inventory services, logistics services, supply chain solutions, warehouse management, freight services"} />

        {/* Open Graph */}
        <meta property="og:type" content="website" />
        <meta property="og:title" content={seo.title || "Our Services - Sazzad Inventory & Logistics"} />
        ...
        <meta name="twitter:title" content={seo.title || "Our Services - Sazzad Inventory & Logistics"} />
