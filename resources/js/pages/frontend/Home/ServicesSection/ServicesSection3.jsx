...
const ServicesSection3 = ({
  ...
  // State for expanded service (mobile accordion)
  ...
  const structuredData = {
    ...
    "@type": seo.structuredData?.["@type"] || "ItemList",
    "name": seo.structuredData?.name || "Our Service Categories",
    "description": config?.description,
    "numberOfItems": config?.services?.length || 0,
  ...
  return (
    <>
      {/* SEO Meta Tags */}
      <Head>
        <title>{seo.title || "Service Categories - Sazzad Inventory & Logistics"}</title>
        <meta name="description" content={seo.description || config?.description} />
        <meta name="keywords" content={seo.keywords || "service categories, logistics services, inventory solutions, supply chain services, warehouse solutions"} />

        {/* Open Graph */}
        <meta property="og:type" content="website" />
        <meta property="og:title" content={seo.title || "Service Categories - Sazzad Inventory & Logistics"} />
        ...
        <meta name="twitter:title" content={seo.title || "Service Categories - Sazzad Inventory & Logistics"} />
