...
const ServicesSection2 = ({
  ...
  const structuredData = {
    ...
    "name": seo.structuredData?.name || "Sazzad Logistics Services",
    "description": config?.description,
    "provider": {
      "@type": "Organization",
      "name": siteConfig.name || "Sazzad Inventory & Logistics",
      "url": currentUrl
    },
    "hasOfferCatalog": {
      "@type": "OfferCatalog",
  ...
  return (
    <>
      {/* SEO Meta Tags */}
      <Head>
        <title>{seo.title || "Logistics Solutions - Sazzad Inventory & Logistics"}</title>
        <meta name="description" content={seo.description || config?.description} />
        <meta name="keywords" content={seo.keywords || "logistics solutions, supply chain optimization, warehouse automation, freight management, inventory control"} />

        {/* Open Graph */}
        <meta property="og:type" content="website" />
        <meta property="og:title" content={seo.title || "Logistics Solutions - Sazzad Inventory & Logistics"} />
        <meta property="og:description" content={seo.description || config?.description} />
        <meta property="og:image" content={seo.ogImage || config?.headerImage?.src} />
        <meta property="og:url" content={currentUrl} />
        <meta property="og:site_name" content={siteConfig.name || "Sazzad Inventory & Logistics"} />

        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={seo.title || "Logistics Solutions - Sazzad Inventory & Logistics"} />
        <meta name="twitter:description" content={seo.description || config?.description} />
        <meta name="twitter:image" content={seo.ogImage || config?.headerImage?.src} />
