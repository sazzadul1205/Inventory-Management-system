  ...
  return (
    <section className="w-full bg-white dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="mb-20">
          <div className="bg-gray-200 dark:bg-gray-700 rounded-3xl p-8 md:p-12 h-64 animate-pulse"></div>
        </div>
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    <div className="w-4 h-4 bg-gray-200 dark:bg-gray-700 rounded mr-1 animate-pulse"></div>
        ...
        <div className="mb-16">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {[1, 2, 3, 4].map((category) => (
              ...
              >
                <div className="w-12 h-12 bg-gray-200 dark:bg-gray-700 rounded-xl mb-3 animate-pulse"></div>
                <div className="h-4 w-16 bg-gray-200 dark:bg-gray-700 rounded animate-pulse"></div>
              </div>
            ))}
          </div>
        ...
        <div className="text-center">
          <div className="h-14 w-48 bg-gray-200 dark:bg-gray-700 rounded-xl mx-auto animate-pulse"></div>
        </div>
      </div>
    </section>
  );
