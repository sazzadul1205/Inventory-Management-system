        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="grid sm:grid-cols-2 gap-4 pt-4">
              {[1, 2, 3, 4, 5, 6].map((feature) => (
                <div key={feature} className="flex items-start">
                  <div className="w-8 h-8 bg-gray-200 dark:bg-gray-700 rounded-lg mr-3 animate-pulse" />
            ...
            <div className="flex flex-wrap gap-4 pt-6">
              <div className="h-14 w-36 bg-gray-200 dark:bg-gray-700 rounded-xl animate-pulse" />
              <div className="h-14 w-36 bg-gray-200 dark:bg-gray-700 rounded-xl animate-pulse" />
            </div>
          ...
          <div className="relative">
            <div className="relative mx-auto max-w-75">
              ...
              <div className="relative bg-gray-200 dark:bg-gray-700 rounded-[40px] p-3 shadow-2xl">
                <div className="bg-gray-300 dark:bg-gray-600 rounded-4xl h-150 animate-pulse" />

                {/* Dynamic Island Skeleton */}
                <div className="absolute top-4 left-1/2 transform -translate-x-1/2 w-20 h-6 bg-gray-400 dark:bg-gray-500 rounded-full animate-pulse" />
              </div>

              {/* Floating Screenshots Skeleton */}
              <div className="absolute -top-6 -right-6 w-24 h-24 bg-gray-200 dark:bg-gray-700 rounded-2xl animate-pulse hidden lg:block" />
              <div className="absolute -bottom-6 -left-6 w-24 h-24 bg-gray-200 dark:bg-gray-700 rounded-2xl animate-pulse hidden lg:block" />

              {/* Rating Badge Skeleton */}
              <div className="absolute -bottom-6 -left-6 bg-gray-200 dark:bg-gray-700 rounded-2xl p-4 w-32 h-20 animate-pulse" />
            </div>
          </div>
        </div>
        ...
        <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-8 pt-8 border-t border-gray-200 dark:border-gray-800">
          {[1, 2, 3, 4].map((stat) => (
            <div key={stat} className="text-center">
              <div className="h-8 w-20 bg-gray-200 dark:bg-gray-700 rounded mx-auto mb-2 animate-pulse" />
