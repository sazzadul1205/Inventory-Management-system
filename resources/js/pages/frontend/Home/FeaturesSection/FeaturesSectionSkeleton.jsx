      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20 lg:py-24">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16 lg:mb-20">
          ...
          <div className="space-y-3 mb-4">
            <div className="h-10 w-3/4 bg-gray-200 dark:bg-gray-700 rounded-lg animate-pulse mx-auto"></div>
            <div className="h-10 w-2/3 bg-gray-200 dark:bg-gray-700 rounded-lg animate-pulse mx-auto"></div>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 lg:gap-10">
          {[1, 2, 3, 4, 5, 6].map((card) => (
            ...
            >
              ...
              {/* Title Skeleton */}
              <div className="h-6 w-3/4 bg-gray-200 dark:bg-gray-700 rounded-lg mb-3 animate-pulse"></div>
              ...
              <div className="flex justify-between mt-4 pt-4 border-t border-gray-100 dark:border-gray-700">
                <div className="flex items-center">
                  <div className="h-5 w-12 bg-gray-200 dark:bg-gray-700 rounded animate-pulse mr-1"></div>
          ...
          <div className="bg-linear-to-r from-gray-200 to-gray-300 dark:from-gray-700 dark:to-gray-600 rounded-2xl p-8 sm:p-10 md:p-12">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <div className="text-center md:text-left flex-1">
                <div className="h-8 w-3/4 bg-white/50 dark:bg-gray-600/50 rounded-lg mb-2 animate-pulse mx-auto md:mx-0"></div>
                <div className="h-5 w-2/3 bg-white/50 dark:bg-gray-600/50 rounded animate-pulse mx-auto md:mx-0"></div>
              </div>

              {/* CTA Button Skeleton */}
              <div className="h-12 w-40 bg-white/50 dark:bg-gray-600/50 rounded-lg animate-pulse"></div>
            </div>
          </div>
        </div>
        ...
        <div className="px-4 mt-12 sm:mt-16 md:mt-20">
          <div className="h-px w-full bg-linear-to-r from-gray-200 via-gray-300 to-gray-200 dark:from-gray-700 dark:via-gray-600 dark:to-gray-700 animate-pulse"></div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 px-4 mt-8 sm:mt-12 md:mt-16">
          {[1, 2, 3, 4].map((stat) => (
            <div key={stat} className="text-center">
              <div className="h-8 w-20 bg-gray-200 dark:bg-gray-700 rounded-lg animate-pulse mx-auto mb-2"></div>
