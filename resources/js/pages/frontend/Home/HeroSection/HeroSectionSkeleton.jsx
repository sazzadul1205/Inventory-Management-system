        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-3">
              ...
              <div className="h-12 w-5/6 bg-gray-200 dark:bg-gray-700 rounded-lg animate-pulse" />
              <div className="h-12 w-4/6 bg-gray-200 dark:bg-gray-700 rounded-lg animate-pulse" />
            </div>
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <div className="h-14 w-40 bg-gray-200 dark:bg-gray-700 rounded-lg animate-pulse" />
              <div className="h-14 w-40 bg-gray-200 dark:bg-gray-700 rounded-lg animate-pulse" />
            </div>
          ...
          <div className="relative">
            ...
            <div className="absolute -top-4 -right-4 w-20 h-20 bg-gray-200 dark:bg-gray-700 rounded-full opacity-20 animate-pulse" />
            <div className="absolute -bottom-4 -left-4 w-32 h-32 bg-gray-200 dark:bg-gray-700 rounded-full opacity-20 animate-pulse delay-700" />
          </div>
        </div>
      </div>
    </section>
