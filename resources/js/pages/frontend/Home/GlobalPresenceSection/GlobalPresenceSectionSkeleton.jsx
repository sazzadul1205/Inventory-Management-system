      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="relative mb-20">
          <div className="relative mx-auto max-w-4xl">
            ...
            <div className="absolute top-1/4 left-1/4 w-4 h-4 bg-gray-300 dark:bg-gray-600 rounded-full animate-pulse"></div>
            <div className="absolute top-1/3 left-1/2 w-4 h-4 bg-gray-300 dark:bg-gray-600 rounded-full animate-pulse"></div>
            <div className="absolute top-2/3 left-3/4 w-4 h-4 bg-gray-300 dark:bg-gray-600 rounded-full animate-pulse"></div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
          {[1, 2, 3, 4].map((region) => (
            ...
            >
              {/* Icon Skeleton */}
              <div className="w-16 h-16 bg-gray-200 dark:bg-gray-700 rounded-2xl mb-4 animate-pulse"></div>
        ...
        <div className="mb-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[1, 2, 3, 4, 5, 6].map((office) => (
              ...
              >
                <div className="w-10 h-10 bg-gray-200 dark:bg-gray-700 rounded-lg mr-3 shrink-0 animate-pulse"></div>
        ...
        <div className="bg-gray-200 dark:bg-gray-700 rounded-3xl p-8 md:p-12">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            <div className="flex-1">
              <div className="h-8 w-64 bg-gray-300 dark:bg-gray-600 rounded mb-4 animate-pulse"></div>
              <div className="h-4 w-96 bg-gray-300 dark:bg-gray-600 rounded mb-6 animate-pulse"></div>
              ...
              <div className="grid grid-cols-2 gap-4">
                {[1, 2, 3, 4].map((item) => (
                  <div key={item} className="text-center">
                    <div className="h-8 w-16 bg-gray-400 dark:bg-gray-500 rounded mx-auto mb-2 animate-pulse"></div>
                    <div className="h-3 w-12 bg-gray-400 dark:bg-gray-500 rounded mx-auto animate-pulse"></div>
                  </div>
                ))}
              </div>
            </div>
