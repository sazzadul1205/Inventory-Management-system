      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center mb-16">
          ...
          <div className="relative">
            <div className="w-full h-96 bg-gray-200 dark:bg-gray-700 rounded-2xl animate-pulse" />

            {/* Navigation Dots Skeleton */}
            <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 flex space-x-2">
              {[1, 2, 3, 4].map((item) => (
                <div key={item} className="w-2 h-2 bg-gray-300 dark:bg-gray-600 rounded-full animate-pulse" />
              ))}
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center space-x-1">
              {[1, 2, 3, 4, 5].map((item) => (
                <div key={item} className="w-5 h-5 bg-gray-200 dark:bg-gray-700 rounded animate-pulse" />
              ))}
            </div>
            ...
            <div className="grid grid-cols-3 gap-4">
              {[1, 2, 3].map((item) => (
                <div key={item} className="text-center p-3 bg-gray-100 dark:bg-gray-800/50 rounded-lg">
                  <div className="h-6 w-12 bg-gray-200 dark:bg-gray-700 rounded mx-auto mb-1 animate-pulse" />
            ...
            <div className="flex items-center justify-between pt-4 border-t border-gray-200 dark:border-gray-700">
              <div className="flex items-center">
                <div className="w-10 h-10 bg-gray-200 dark:bg-gray-700 rounded-full mr-3 animate-pulse" />
                <div>
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="mb-4 p-3 bg-gray-100 dark:bg-gray-700/30 rounded-xl">
                  <div className="h-6 w-16 bg-gray-200 dark:bg-gray-700 rounded mx-auto mb-1 animate-pulse" />
                  <div className="h-3 w-20 bg-gray-200 dark:bg-gray-700 rounded mx-auto animate-pulse" />
                </div>
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-200 dark:border-gray-700">
                  <div className="flex items-center">
                    <div className="w-8 h-8 bg-gray-200 dark:bg-gray-700 rounded-full mr-2 animate-pulse" />
        ...
        <div className="text-center mt-16">
          <div className="h-14 w-48 bg-gray-200 dark:bg-gray-700 rounded-xl animate-pulse mx-auto" />
        </div>
      </div>
    </section>
  );
