// page/frontend/Home/BlogSection/BlogSectionSkeleton.jsx
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-8">
            ...
            <div className="bg-gray-200 dark:bg-gray-700 rounded-2xl p-6">
              <div className="h-6 w-32 bg-gray-300 dark:bg-gray-600 rounded animate-pulse mb-2" />
              <div className="h-4 w-full bg-gray-300 dark:bg-gray-600 rounded animate-pulse mb-4" />
              <div className="space-y-3">
                <div className="h-10 w-full bg-gray-300 dark:bg-gray-600 rounded-xl animate-pulse" />
                <div className="h-10 w-full bg-gray-300 dark:bg-gray-600 rounded-xl animate-pulse" />
              </div>
            </div>
