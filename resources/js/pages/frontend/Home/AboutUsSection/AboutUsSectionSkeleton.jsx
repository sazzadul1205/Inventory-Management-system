      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          <div className="relative">
            <div className="rounded-2xl overflow-hidden shadow-2xl bg-gray-200 dark:bg-gray-700 h-96 animate-pulse" />

            {/* Experience Badge Skeleton */}
            <div className="absolute -bottom-6 -right-6 bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-xl border border-gray-100 dark:border-gray-700 w-32 h-32 animate-pulse" />
          </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4 pt-4">
              {[1, 2, 3, 4].map((point) => (
                <div key={point} className="flex items-start">
                  <div className="w-5 h-5 bg-gray-200 dark:bg-gray-700 rounded-full mr-2 animate-pulse" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[1, 2, 3, 4].map((value) => (
              <div key={value} className="bg-gray-50 dark:bg-gray-800/50 rounded-2xl p-8 border border-gray-100 dark:border-gray-700">
                <div className="w-16 h-16 bg-gray-200 dark:bg-gray-700 rounded-xl mx-auto mb-4 animate-pulse" />
                <div className="h-6 w-24 bg-gray-200 dark:bg-gray-700 rounded mx-auto mb-3 animate-pulse" />
                <div className="space-y-2">
                  <div className="h-4 w-full bg-gray-200 dark:bg-gray-700 rounded animate-pulse" />
        ...
        <div className="mt-20">
          ...
          <div className="h-4 w-96 bg-gray-200 dark:bg-gray-700 rounded mx-auto mb-12 animate-pulse" />

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[1, 2, 3, 4].map((member) => (
              <div key={member} className="text-center">
                <div className="w-full h-64 bg-gray-200 dark:bg-gray-700 rounded-2xl mb-4 animate-pulse" />
