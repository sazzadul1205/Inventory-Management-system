      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center space-x-4 pt-4">
              <div className="flex -space-x-2">
                {[1, 2, 3, 4].map((item) => (
                  <div key={item} className="w-8 h-8 bg-gray-200 dark:bg-gray-700 rounded-full border-2 border-white dark:border-gray-800 animate-pulse" />
                ))}
              </div>
          ...
          <div className="bg-gray-100 dark:bg-gray-800 rounded-3xl p-8 shadow-2xl border border-gray-200 dark:border-gray-700">
            <div className="space-y-6">
              {/* Form Title Skeleton */}
              <div className="h-8 w-48 bg-gray-200 dark:bg-gray-700 rounded mx-auto mb-6 animate-pulse" />
                ...
                <div className="space-y-2">
                  {[1, 2, 3].map((item) => (
                    <div key={item} className="flex items-center">
                      <div className="w-4 h-4 bg-gray-200 dark:bg-gray-700 rounded mr-3 animate-pulse" />
              ...
              <div className="h-3 w-48 bg-gray-200 dark:bg-gray-700 rounded mx-auto animate-pulse" />
            </div>
          </div>
        </div>
