      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-4">
                  {[1, 2, 3].map((badge) => (
                    <div key={badge} className="h-8 w-24 bg-gray-200 dark:bg-gray-700 rounded-full animate-pulse"></div>
                  ))}
                </div>
              ...
              <div className="grid grid-cols-2 gap-6">
                {[1, 2, 3, 4].map((metric) => (
                  <div key={metric} className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg text-center">
                    <div className="h-8 w-16 bg-gray-200 dark:bg-gray-700 rounded mx-auto mb-2 animate-pulse"></div>
                    <div className="h-4 w-20 bg-gray-200 dark:bg-gray-700 rounded mx-auto animate-pulse"></div>
                  </div>
                ))}
              </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {[1, 2, 3, 4, 5, 6, 7, 8].map((partner) => (
            ...
            >
              {/* Logo Skeleton */}
              <div className="h-24 bg-gray-200 dark:bg-gray-700 rounded-lg mb-4 animate-pulse"></div>

              {/* Name Skeleton */}
              <div className="h-5 w-32 bg-gray-200 dark:bg-gray-700 rounded mx-auto mb-2 animate-pulse"></div>

              {/* Type Skeleton */}
              <div className="h-4 w-20 bg-gray-200 dark:bg-gray-700 rounded mx-auto mb-3 animate-pulse"></div>

              {/* Description Skeleton */}
              <div className="space-y-2 mb-4">
                <div className="h-3 w-full bg-gray-200 dark:bg-gray-700 rounded animate-pulse"></div>
                <div className="h-3 w-5/6 bg-gray-200 dark:bg-gray-700 rounded mx-auto animate-pulse"></div>
              </div>
        ...
        <div className="text-center mt-20">
          <div className="bg-gray-200 dark:bg-gray-700 rounded-3xl p-8 md:p-12">
            <div className="max-w-3xl mx-auto">
              <div className="h-8 w-64 bg-gray-300 dark:bg-gray-600 rounded mx-auto mb-4 animate-pulse"></div>
              <div className="h-4 w-96 bg-gray-300 dark:bg-gray-600 rounded mx-auto mb-8 animate-pulse"></div>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <div className="h-14 w-48 bg-gray-300 dark:bg-gray-600 rounded-xl animate-pulse"></div>
                <div className="h-14 w-48 bg-gray-300 dark:bg-gray-600 rounded-xl animate-pulse"></div>
              </div>
              <div className="h-4 w-64 bg-gray-300 dark:bg-gray-600 rounded mx-auto mt-6 animate-pulse"></div>
            </div>
          </div>
        </div>
            ...
            {[1, 2, 3].map((testimonial) => (
              ...
              >
                <div className="flex items-center mb-4">
                  <div className="w-12 h-12 bg-gray-200 dark:bg-gray-700 rounded-lg mr-3 animate-pulse"></div>
                  <div>
