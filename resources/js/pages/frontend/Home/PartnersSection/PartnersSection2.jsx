...
const PartnersSection2 = ({ config }) => {
  ...
  return (
    ...
    >
      ...
      {/* Animated Blobs */}
      <div className="absolute top-40 left-0 w-72 h-72 bg-indigo-200 dark:bg-indigo-900/20 rounded-full mix-blend-multiply filter blur-3xl animate-blob" aria-hidden="true"></div>
