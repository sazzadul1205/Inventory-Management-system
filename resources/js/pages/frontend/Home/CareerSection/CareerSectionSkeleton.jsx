          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[1, 2, 3, 4, 5, 6].map((job) => (
              ...
              >
                ...
                <div className="h-8 w-full bg-gray-200 dark:bg-gray-700 rounded-xl animate-pulse"></div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="mb-20">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="row-span-2 h-64 bg-gray-200 dark:bg-gray-700 rounded-2xl animate-pulse"></div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[1, 2, 3, 4].map((perk) => (
              <div key={perk} className="text-center">
                ...
                <div className="h-5 w-24 bg-gray-200 dark:bg-gray-700 rounded mx-auto mb-2 animate-pulse"></div>
