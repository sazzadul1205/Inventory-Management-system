    ...
    <section className="w-full bg-white dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-12">
          {[1, 2, 3, 4, 5].map((item) => (
            <div key={item} className="h-10 w-28 bg-gray-200 dark:bg-gray-700 rounded-full animate-pulse" />
          ))}
        </div>
          ...
          <div className="grid md:grid-cols-5 gap-8">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center mt-1">
                    <div className="w-4 h-4 bg-gray-200 dark:bg-gray-700 rounded-full mr-1 animate-pulse" />
            ...
            <div className="md:col-span-2">
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg border border-gray-100 dark:border-gray-700 text-center">
                ...
                <div className="w-24 h-24 mx-auto mb-4 bg-gray-200 dark:bg-gray-700 rounded-2xl animate-pulse" />

                {/* Company Name Skeleton */}
                <div className="h-6 w-32 bg-gray-200 dark:bg-gray-700 rounded mx-auto mb-2 animate-pulse" />

                {/* Industry Skeleton */}
                <div className="h-4 w-24 bg-gray-200 dark:bg-gray-700 rounded mx-auto mb-4 animate-pulse" />

                {/* Key Benefit Skeleton */}
                <div className="inline-flex items-center px-4 py-2 bg-gray-200 dark:bg-gray-700 rounded-full mx-auto">
                  <div className="w-4 h-4 bg-gray-300 dark:bg-gray-600 rounded-full mr-1 animate-pulse" />
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[1, 2, 3].map((item) => (
            ...
            >
              ...
              <div className="mb-3">
                <div className="h-4 w-28 bg-gray-200 dark:bg-gray-700 rounded mb-1 animate-pulse" />
                <div className="h-3 w-20 bg-gray-200 dark:bg-gray-700 rounded animate-pulse" />
              </div>
              ...
              <div className="inline-flex items-center px-3 py-1 bg-gray-100 dark:bg-gray-700 rounded-full mb-4">
                <div className="w-3 h-3 bg-gray-200 dark:bg-gray-600 rounded-full mr-1 animate-pulse" />
              ...
              <div className="flex items-center justify-between pt-4 border-t border-gray-100 dark:border-gray-700">
                <div className="flex items-center">
                  <div className="w-3 h-3 bg-gray-200 dark:bg-gray-700 rounded-full mr-1 animate-pulse" />
                  <div className="h-3 w-20 bg-gray-200 dark:bg-gray-700 rounded animate-pulse" />
                </div>
