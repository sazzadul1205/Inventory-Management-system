        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {[1, 2, 3, 4].map((step) => (
            <div key={step} className="relative group">
              ...
              <div className="absolute -top-4 -right-4 w-24 h-24 bg-gray-100 dark:bg-gray-800/30 rounded-full animate-pulse" />
              ...
              <div className="relative z-10 bg-gray-50 dark:bg-gray-800/50 rounded-2xl p-8 border border-gray-100 dark:border-gray-700">
                ...
                <div className="w-8 h-8 bg-gray-200 dark:bg-gray-700 rounded-full mb-4 animate-pulse" />

                {/* Title Skeleton */}
                <div className="h-7 w-3/4 bg-gray-200 dark:bg-gray-700 rounded-lg mb-3 animate-pulse" />
                ...
                <div className="flex items-center mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                  <div className="w-4 h-4 bg-gray-200 dark:bg-gray-700 rounded-full mr-2 animate-pulse" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-20 pt-12 border-t border-gray-200 dark:border-gray-800">
          {[1, 2, 3].map((item) => (
            <div key={item} className="flex items-start space-x-3">
              <div className="w-6 h-6 bg-gray-200 dark:bg-gray-700 rounded-full shrink-0 animate-pulse" />
