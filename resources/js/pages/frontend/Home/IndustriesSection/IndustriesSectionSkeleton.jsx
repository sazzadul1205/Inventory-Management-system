              ...
              <div className="space-y-2 mb-4">
                {[1, 2, 3].map((feature) => (
                  <div key={feature} className="flex items-start">
                    <div className="w-3 h-3 bg-gray-200 dark:bg-gray-700 rounded-full mr-2 mt-1 animate-pulse"></div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[1, 2, 3, 4].map((item) => (
              <div key={item} className="text-center">
                <div className="h-10 w-20 bg-gray-200 dark:bg-gray-700 rounded-lg animate-pulse mx-auto mb-2"></div>
