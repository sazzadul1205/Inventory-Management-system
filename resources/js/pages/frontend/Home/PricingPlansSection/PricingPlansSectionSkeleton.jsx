      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            ...
            >
              ...
              {plan === 2 && (
                <div className="flex justify-center mb-4">
                  <div className="h-6 w-32 bg-yellow-200 dark:bg-yellow-900/30 rounded-full animate-pulse" />
                </div>
              )}

              {/* Plan Header Skeleton */}
              <div className="text-center mb-6">
                <div className="h-8 w-24 bg-gray-200 dark:bg-gray-700 rounded-lg mx-auto mb-2 animate-pulse" />
              ...
              <div className="text-center mb-6">
                <div className="flex items-center justify-center">
                  ...
                  <div className="h-4 w-12 bg-gray-200 dark:bg-gray-700 rounded ml-2 animate-pulse" />
                </div>
              </div>
              ...
              <div className="space-y-4 mb-8">
                {[1, 2, 3, 4, 5, 6].map((feature) => (
                  <div key={feature} className="flex items-start">
                    <div className="w-5 h-5 bg-gray-200 dark:bg-gray-700 rounded-full mr-3 animate-pulse" />
        ...
        <div className="mt-20 bg-linear-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 rounded-3xl p-8 md:p-12">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div>
              <div className="h-6 w-24 bg-gray-300 dark:bg-gray-700 rounded-full mb-4 animate-pulse" />
              ...
              <div className="h-4 w-5/6 bg-gray-300 dark:bg-gray-700 rounded mb-6 animate-pulse" />
            ...
            <div className="bg-linear-to-br from-gray-200 to-gray-300 dark:from-gray-700 dark:to-gray-800 rounded-2xl p-1">
              <div className="bg-white dark:bg-gray-900 rounded-2xl p-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {[1, 2, 3, 4].map((logo) => (
                    <div key={logo} className="h-12 bg-gray-100 dark:bg-gray-800 rounded-lg animate-pulse" />
                  ))}
                </div>
              </div>
            </div>
