        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-gray-100 dark:bg-gray-800 rounded-3xl overflow-hidden shadow-2xl border border-gray-200 dark:border-gray-700">
              <div className="grid md:grid-cols-2 gap-0">
                ...
                <div className="h-64 md:h-full bg-gray-200 dark:bg-gray-700 animate-pulse" />
              ...
              {[1, 2, 3, 4].map((item) => (
                ...
                >
                  <div className="flex flex-col sm:flex-row">
                    {/* Thumbnail Skeleton */}
                    <div className="sm:w-32 h-32 bg-gray-200 dark:bg-gray-700 animate-pulse" />
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          <div className="flex items-center mb-2">
                            <div className="h-5 w-16 bg-gray-200 dark:bg-gray-700 rounded-full mr-3 animate-pulse" />
                            <div className="h-4 w-24 bg-gray-200 dark:bg-gray-700 rounded animate-pulse" />
                          </div>
                        ...
                        <div className="ml-4 w-8 h-8 bg-gray-200 dark:bg-gray-700 rounded-lg animate-pulse" />
                      </div>
          ...
          <div className="lg:col-span-1 space-y-8">
              ...
              <div className="space-y-2">
                {[1, 2, 3, 4, 5].map((item) => (
                  <div key={item} className="flex items-center justify-between">
                    ...
                    <div className="h-4 w-8 bg-gray-200 dark:bg-gray-700 rounded-full animate-pulse" />
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="bg-gray-200 dark:bg-gray-700 rounded-2xl p-6">
              <div className="h-6 w-24 bg-gray-300 dark:bg-gray-600 rounded animate-pulse mb-2" />
              <div className="h-4 w-full bg-gray-300 dark:bg-gray-600 rounded animate-pulse mb-4" />
