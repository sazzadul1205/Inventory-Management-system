        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-linear-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 rounded-2xl p-6 border border-gray-100 dark:border-gray-700">
              <div className="h-5 w-32 bg-gray-300 dark:bg-gray-700 rounded mb-4 animate-pulse" />
              <div className="flex space-x-4">
                {[1, 2, 3, 4].map((social) => (
                  <div key={social} className="w-10 h-10 bg-gray-300 dark:bg-gray-700 rounded-full animate-pulse" />
                ))}
              </div>
            </div>

            {/* Map Skeleton */}
            <div className="rounded-2xl overflow-hidden h-48 bg-gray-200 dark:bg-gray-700 animate-pulse" />
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-xl border border-gray-100 dark:border-gray-700">
            ...
            <div className="space-y-5">
              ...
              <div className="h-4 w-64 bg-gray-200 dark:bg-gray-700 rounded mx-auto mt-4 animate-pulse" />
            </div>
          </div>
        </div>
      </div>
