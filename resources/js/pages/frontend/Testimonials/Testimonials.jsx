...
const PageHero = ({ heroData }) => {
  ...
  const title = heroData?.title || 'What Our';
  const highlightedText = heroData?.highlightedText || 'Clients Say';
  const description = heroData?.description || 'Real feedback from businesses that have transformed their operations with our solutions. Join thousands of satisfied customers worldwide.';
      ...
      <div className="container mx-auto px-4 py-20 md:py-28 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <nav aria-label="Breadcrumb" className="flex items-center justify-center gap-2 text-sm text-purple-100 dark:text-purple-200 mb-6">
            ...
            <span className="text-white dark:text-white" aria-current="page">Testimonials</span>
          </nav>
          ...
          <div
            ...
            role="list"
            aria-label="Testimonial statistics"
          >
