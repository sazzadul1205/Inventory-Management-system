...
const Testimonials = ({ pageData = { meta: {}, sections: [] } }) => {
  ...
  const pageSeoData = useMemo(() => ({
    title: seo.title || meta.title || "What Our Clients Say",
    description: seo.description || meta.description || "Real feedback from businesses that have transformed their operations with our solutions. Join thousands of satisfied customers worldwide.",
    keywords: seo.keywords || meta.keywords || "",
    ogImage: seo.ogImage || meta.ogImage || "/testimonials-og-image.jpg",
