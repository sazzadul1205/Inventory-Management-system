              ...
              <div className="p-6">
                {!ticketSubmitted ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-sm text-gray-500">A support representative will respond within 24 hours.</p>
                  </div>
                )}
              </div>
            </div>
          ...
          <div className="text-center mt-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-green-50 dark:bg-green-900/20 rounded-full">
              ...
              <span className="text-xs text-gray-600 dark:text-gray-400">
                {config?.guaranteeText || "All support tickets receive a response within 24 hours. Enterprise customers get priority 1-hour response."}
              </span>
            </div>
          </div>
        )}
