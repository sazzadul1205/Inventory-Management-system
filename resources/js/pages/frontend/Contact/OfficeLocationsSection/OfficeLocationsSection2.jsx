// frontend/Contact/OfficeLocationsSection/OfficeLocationsSection2.jsx

/**
 * Office Locations Section Component - Interactive Office Directory with Modal Details
 * A comprehensive office locations section featuring:
 * - Interactive office cards with team size and contact details
 * - Region and country filtering with visual indicators
 * - Interactive map preview with region selection
 * - Office detail modal with full contact information
 * - Search functionality across office locations and FAQs
 ...
 * - Save/bookmark favorite FAQs with localStorage
...
const OfficeLocationsSection2 = ({ config }) => {
  ...
  return (
    <section
      ...
      role="region"
      aria-label="Office Locations Help Center"
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          >
            ...
            <span className={`text-sm font-medium ${config?.badge?.textColor || 'text-violet-700 dark:text-violet-300'}`}>
              {config?.badge?.text || "Our Offices"}
            </span>
          </div>
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
            {config?.title?.prefix || 'Visit Our'}{' '}
            <span className={`bg-linear-to-r ${config?.title?.highlightGradient || 'from-violet-600 to-purple-600'} bg-clip-text text-transparent`}>
              {config?.title?.highlightedText || 'Global Offices'}
            </span>{' '}
            {config?.title?.suffix || "We're Here to Welcome You"}
          </h2>
          <p className="text-xl text-gray-600 dark:text-gray-300">
            {config?.description || "With offices spanning across continents, we're always within reach. Visit us for meetings, events, or just to say hello. Our doors are open to partners and customers alike."}
          </p>
        </div>
        ...
        <div className="mb-12 bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden border border-gray-100 dark:border-gray-700">
          <div className="bg-linear-to-r from-violet-600 to-purple-600 p-4 text-white">
            <div className="flex items-center gap-2">
              {getIcon("HiOutlineGlobeAlt", "w-5 h-5")}
              ...
              {regions.map((region) => (
                <button
                  ...
                  className={`text-center p-4 rounded-xl transition-all duration-300 transform hover:scale-105 ${activeRegion === region.id
                    ? 'bg-linear-to-r from-violet-100 to-purple-100 dark:from-violet-900/30 dark:to-purple-900/30 ring-2 ring-violet-500'
                    : 'bg-gray-50 dark:bg-gray-700/50 hover:bg-violet-50 dark:hover:bg-violet-900/20'
                    }`}
                >
                  ...
                  <div className="text-xs text-gray-400 dark:text-gray-500 mt-1">{region.flag}</div>
                </button>
              ))}
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          {filteredOffices.map((office, index) => (
            ...
            >
              <div className={`h-32 ${office.image || 'bg-linear-to-r from-violet-500 to-purple-600'} relative`}>
              ...
              <div className="p-5">
                <div className="flex items-start gap-3 mb-3">
                  <div className="text-violet-500 dark:text-violet-400 mt-0.5 shrink-0">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-violet-600 dark:text-violet-400 text-sm font-semibold group-hover:underline">
                    View Details →
                  </div>
                </div>
              </div>
        ...
        {showOfficeModal && selectedOffice && (
          ...
          >
            ...
            >
              <div className={`relative h-40 ${selectedOffice.image || 'bg-linear-to-r from-violet-500 to-purple-600'} rounded-t-3xl`}>
              ...
              <div className="p-6 space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    {selectedOffice.mapLink && (
                      <Link href={selectedOffice.mapLink} className="inline-flex items-center gap-1 text-violet-600 dark:text-violet-400 text-xs mt-1 hover:underline">
                        View on Map
                ...
                <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
                  <Link
                    ...
                    className="w-full inline-flex items-center justify-center gap-2 px-4 py-3 bg-linear-to-r from-violet-600 to-purple-600 text-white rounded-xl font-semibold hover:shadow-lg transition-all duration-300 transform hover:scale-[1.02]"
                  >
                    Contact This Office
          ...
          <div className="mb-6">
            <div className="relative">
              ...
              <input
                ...
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                className="w-full pl-12 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-violet-500 focus:border-transparent transition-all"
              />
            </div>
          </div>
        ...
        <div className="bg-linear-to-r from-violet-50 to-purple-50 dark:from-gray-800 dark:to-gray-800 rounded-2xl p-8 mb-12 border border-violet-100 dark:border-gray-700">
          <div className="flex items-center gap-3 mb-4">
            {getIcon("HiOutlineBuildingOffice", "w-8 h-8 text-violet-600")}
            <h3 className="text-2xl font-bold text-gray-900 dark:text-white">Corporate Headquarters</h3>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-2">
              <p className="text-gray-600 dark:text-gray-400">
                <span className="font-semibold">Address:</span> 123 Main Street, Suite 100, San Francisco, CA 94105, USA
              </p>
              <p className="text-gray-600 dark:text-gray-400">
                <span className="font-semibold">Phone:</span> +1 (888) 123-4567
              </p>
              <p className="text-gray-600 dark:text-gray-400">
                <span className="font-semibold">Email:</span> corporate@inventory-platform.com
              </p>
            </div>
        ...
        <div className="text-center">
          <div className="inline-flex flex-col sm:flex-row items-center gap-5 p-6 bg-linear-to-r from-violet-50 to-purple-50 dark:from-gray-800 dark:to-gray-800 rounded-2xl border border-violet-100 dark:border-gray-700">
            <div className="w-12 h-12 bg-violet-100 dark:bg-violet-900/30 rounded-full flex items-center justify-center">
              {getIcon("HiOutlineGlobeAlt", "w-6 h-6 text-violet-600")}
            </div>
...
export default OfficeLocationsSection2;