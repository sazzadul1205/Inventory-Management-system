// page/frontend/Contact/Contact.jsx
...
const Contact = ({ pageData = { meta: {}, sections: [] } }) => {
  const {
    sections = [],
    meta = {},
    seo = {}
  ...
  const pageSeoData = useMemo(() => ({
    title: seo.title || meta.title || "Contact Us | Get in Touch with Our Support Team",
    description: seo.description || meta.description || "Have questions about our platform? Our team is ready to help. Reach out through any of the channels below, and we'll get back to you as soon as possible.",
    keywords: seo.keywords || meta.keywords || "contact, support, sales, inquiries, customer service, help desk",
    ogImage: seo.ogImage || meta.ogImage || "/contact-og-image.jpg",
      ...
      <FrontEnd_Layout>
        ...
        <PageHero
          ...
          defaults={{
            ...
            description:
              "Have questions about our platform? Our team is ready to help. Reach out through any of the channels below, and we'll get back to you as soon as possible.",
            stats: [
              { value: "24/7", label: "Support Available" },
              { value: "< 1hr", label: "Avg Response Time" },
              { value: "98%", label: "Satisfaction Rate" }
            ],
            primaryCta: { label: "Start Live Chat", ariaLabel: "Start live chat" },
            secondaryCta: { label: "Send Message", ariaLabel: "Send message" },
            statsAriaLabel: "Contact statistics",
            theme: {
              wrapperClass:
                "relative bg-linear-to-r from-cyan-600 to-blue-700 dark:from-cyan-900 dark:to-blue-900 text-white overflow-hidden",
              breadcrumbClass:
                "flex items-center justify-center gap-2 text-sm text-cyan-100 dark:text-cyan-200 mb-6",
              descriptionClass:
                "text-lg md:text-xl text-cyan-100 dark:text-cyan-200 mb-8 max-w-2xl mx-auto",
              statValueClass: "text-3xl font-bold text-yellow-300 dark:text-yellow-400 mb-1",
              statLabelClass: "text-sm text-cyan-100 dark:text-cyan-200",
              highlightClass: "text-yellow-300 dark:text-yellow-400",
              primaryBtnClass:
                "px-8 py-3 bg-yellow-400 dark:bg-yellow-500 text-cyan-900 dark:text-cyan-950 font-semibold rounded-lg hover:bg-yellow-300 dark:hover:bg-yellow-400 transition-colors transform hover:scale-105 duration-200",
              secondaryBtnClass:
