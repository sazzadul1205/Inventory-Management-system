...
const PageHero = ({ heroData }) => {
  ...
  const highlightedText = heroData?.highlightedText || 'Touch';
  const description = heroData?.description || 'Have questions about our platform? Our team is ready to help. Reach out through any of the channels below, and we\'ll get back to you as soon as possible.';
  ...
  return (
    <section
      className="relative bg-linear-to-r from-cyan-600 to-blue-700 dark:from-cyan-900 dark:to-blue-900 text-white overflow-hidden"
    ...
    >
      ...
      <div className="container mx-auto px-4 py-20 md:py-28 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          {/* Breadcrumb */}
          <nav aria-label="Breadcrumb" className="flex items-center justify-center gap-2 text-sm text-cyan-100 dark:text-cyan-200 mb-6">
            <a href="/" className="hover:text-white dark:hover:text-cyan-100 transition-colors">Home</a>
            <span aria-hidden="true">•</span>
            <span className="text-white dark:text-white" aria-current="page">Contact</span>
          </nav>
          ...
          {/* Description */}
          <p className="text-lg md:text-xl text-cyan-100 dark:text-cyan-200 mb-8 max-w-2xl mx-auto">
            {description}
          </p>
          ...
          >
            {stats.map((stat, index) => (
              ...
              >
                ...
                <div className="text-sm text-cyan-100 dark:text-cyan-200">{stat.label}</div>
              </div>
            ))}
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mt-10">
            <button
              className="px-8 py-3 bg-yellow-400 dark:bg-yellow-500 text-cyan-900 dark:text-cyan-950 font-semibold rounded-lg hover:bg-yellow-300 dark:hover:bg-yellow-400 transition-colors transform hover:scale-105 duration-200"
