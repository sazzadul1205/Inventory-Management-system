      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <div className="space-y-2">
            ...
            <div className="h-5 w-4/6 mx-auto bg-gray-200 dark:bg-gray-700 rounded animate-pulse"></div>
          </div>
        </div>
        ...
        <div className="bg-gray-50 dark:bg-gray-800 rounded-3xl p-12">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <div className="h-4 w-96 mx-auto bg-gray-200 dark:bg-gray-700 rounded animate-pulse"></div>
          </div>
        ...
        <div className="mt-20 text-center">
          <div className="inline-flex flex-col sm:flex-row items-center gap-4 sm:gap-6 p-8 bg-gray-50 dark:bg-gray-800 rounded-2xl">
            <div className="flex -space-x-2">
              {[1, 2, 3, 4].map((i) => (
                <div key={i} className="w-10 h-10 bg-gray-200 dark:bg-gray-700 rounded-full border-2 border-white dark:border-gray-800 animate-pulse"></div>
              ))}
            </div>
