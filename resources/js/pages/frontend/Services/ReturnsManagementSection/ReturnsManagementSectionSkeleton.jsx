    ...
    <section className="py-24 bg-white dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {[1, 2].map((card) => (
            <div key={card} className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700">
              ...
              <div className="space-y-3">
                {[1, 2, 3, 4].map((item) => (
                  <div key={item} className="h-4 w-3/4 bg-gray-200 dark:bg-gray-700 rounded animate-pulse"></div>
                ))}
              </div>
            </div>
          ))}
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-20">
          {[1, 2, 3, 4].map((benefit) => (
            <div key={benefit} className="text-center">
              ...
              {/* Value Skeleton */}
              <div className="h-5 w-16 mx-auto bg-gray-200 dark:bg-gray-700 rounded mb-1 animate-pulse"></div>
        ...
        <div className="bg-linear-to-r from-orange-600/20 to-yellow-600/20 dark:from-orange-500/20 dark:to-yellow-500/20 rounded-3xl p-12 text-center">
          ...
          {/* Button Skeleton */}
          <div className="h-14 w-40 mx-auto bg-gray-200 dark:bg-gray-700 rounded-xl animate-pulse"></div>
        </div>
      </div>
    </section>
  );
