      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
            ...
            <div className="space-y-4">
              {[1, 2, 3].map((feature) => (
                <div key={feature} className="flex gap-3">
                  <div className="w-8 h-8 bg-gray-200 dark:bg-gray-700 rounded-lg animate-pulse shrink-0"></div>
          ...
          <div className="relative">
            ...
            <div className="absolute -top-4 -right-4 flex gap-2">
              {[1, 2].map((icon) => (
                <div key={icon} className="w-12 h-12 bg-gray-200 dark:bg-gray-700 rounded-xl animate-pulse"></div>
              ))}
            </div>
          </div>
        </div>
            ...
            {[1, 2, 3, 4].map((step) => (
              <div key={step} className="relative">
                <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 text-center border border-gray-200 dark:border-gray-700">
                  ...
                  {/* Title Skeleton */}
                  <div className="h-5 w-20 mx-auto bg-gray-200 dark:bg-gray-700 rounded mb-2 animate-pulse"></div>
                  ...
                  {/* Duration Skeleton */}
                  <div className="h-3 w-16 mx-auto mt-2 bg-gray-200 dark:bg-gray-700 rounded animate-pulse"></div>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[1, 2, 3, 4, 5, 6, 7, 8].map((tech) => (
              <div key={tech} className="text-center">
                ...
                {/* Name Skeleton */}
                <div className="h-4 w-20 mx-auto bg-gray-200 dark:bg-gray-700 rounded mb-1 animate-pulse"></div>

                {/* Category Skeleton */}
                <div className="h-3 w-12 mx-auto bg-gray-200 dark:bg-gray-700 rounded animate-pulse"></div>
              </div>
            ))}
          </div>
        </div>
                ...
                <div className="grid grid-cols-3 gap-2 mb-4">
                  {[1, 2, 3].map((result) => (
                    <div key={result} className="text-center">
                      <div className="h-5 w-12 mx-auto bg-gray-200 dark:bg-gray-700 rounded mb-1 animate-pulse"></div>
        ...
        <div className="bg-linear-to-r from-indigo-600/20 to-purple-600/20 rounded-3xl p-12 text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <div className="h-14 w-40 bg-gray-200 dark:bg-gray-700 rounded-xl animate-pulse"></div>
            <div className="h-14 w-40 bg-gray-200 dark:bg-gray-700 rounded-xl animate-pulse"></div>
          </div>
        </div>
      </div>
