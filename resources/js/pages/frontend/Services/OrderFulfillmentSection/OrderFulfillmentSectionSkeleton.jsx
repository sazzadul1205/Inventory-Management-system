    ...
    <section className="py-24 bg-white dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              {[1, 2, 3, 4].map((step) => (
                <div key={step} className="flex gap-4">
                  ...
                  <div className="relative">
                    ...
                    {step < 4 && (
                      <div className="absolute top-12 left-6 w-0.5 h-12 bg-gray-200 dark:bg-gray-700" />
                    )}
                  </div>
        ...
        <div className="text-center">
          <div className="h-5 w-48 mx-auto bg-gray-200 dark:bg-gray-700 rounded animate-pulse mb-8" />
