          ...
          <div className="relative">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
              ...
              <div className="absolute top-4 left-4">
                <div className="w-32 h-10 bg-white/30 dark:bg-gray-800/30 backdrop-blur-sm rounded-xl animate-pulse"></div>
              </div>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[1, 2, 3, 4].map((mode) => (
              <div key={mode} className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-6 text-center">
                {/* Icon Skeleton */}
                <div className="w-16 h-16 mx-auto mb-4 bg-gray-200 dark:bg-gray-700 rounded-xl animate-pulse"></div>
            ...
            <div className="grid grid-cols-3 gap-4">
              {[1, 2, 3, 4, 5, 6].map((carrier) => (
                <div key={carrier} className="bg-white/10 backdrop-blur-sm rounded-xl p-4 text-center">
                  <div className="w-8 h-8 mx-auto mb-2 bg-gray-200 dark:bg-gray-700 rounded animate-pulse"></div>
