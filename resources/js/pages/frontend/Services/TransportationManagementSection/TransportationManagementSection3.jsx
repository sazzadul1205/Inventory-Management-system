    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-4xl mx-auto mb-20">
          <div className="inline-flex items-center gap-2 bg-linear-to-r from-blue-600 to-cyan-600 text-white px-4 py-2 rounded-full mb-8 shadow-lg">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link
              ...
              className="group bg-linear-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white px-8 py-4 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 shadow-xl hover:shadow-2xl inline-flex items-center gap-2"
            >
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          <div className="relative">
            <div className="bg-linear-to-br from-blue-600 to-cyan-600 rounded-3xl p-8 text-white">
              ...
              <div className="mt-6 pt-6 border-t border-white/20">
                <p className="text-sm text-blue-100">Last updated: {config?.intelligence?.lastUpdated}</p>
              </div>
            </div>
        ...
        <div className="bg-linear-to-r from-gray-900 to-gray-800 dark:from-gray-950 dark:to-gray-900 rounded-3xl p-12 text-white mb-20">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-300 mb-8">{config?.network?.description}</p>
            ...
            <div className="grid grid-cols-3 gap-4">
              {config?.network?.regions?.map((region, idx) => (
                <div key={idx} className="text-center p-4 bg-white/5 rounded-xl">
                  <div className="text-lg font-bold mb-1">{region.percentage}</div>
        ...
        {/* CTA Banner */}
        <div className="bg-linear-to-r from-blue-600 to-cyan-600 dark:from-blue-500 dark:to-cyan-500 rounded-3xl p-12 text-center text-white">
