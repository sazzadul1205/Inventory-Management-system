// page/frontend/Events/Events.jsx
...
const Events = ({ pageData = { meta: {}, sections: [] } }) => {
  const {
    sections = [],
    meta = {},
    seo = {}
  ...
  const pageSeoData = useMemo(() => ({
    title: seo.title || meta.title || "Events | Stay Connected Through Events & Experiences",
    description: seo.description || meta.description || "Join our webinars, conferences, and training sessions to stay ahead. Connect with industry experts, learn new skills, and explore past event recordings anytime.",
    keywords: seo.keywords || meta.keywords || "events, webinars, conferences, user groups, training sessions, virtual events, event calendar, past event recordings, industry events",
    ogImage: seo.ogImage || meta.ogImage || "/events-og-image.jpg",
  ...
  const sectionsWithDisplayName = useMemo(() => [
    ...
    ...sections.map((section) => {
      const displayNames = {
        ...
        pastEventRecordings: "Past Event Recordings",
      };
      ...
      <FrontEnd_Layout>
        ...
        <PageHero
          ...
          defaults={{
            ...
            ariaLabel: "Events page hero section",
            breadcrumbLabel: "Events",
            title: "Stay Connected Through",
            highlightedText: "Events & Experiences",
            description:
              "Join our webinars, conferences, and training sessions to stay ahead. Connect with industry experts, learn new skills, and explore past event recordings anytime.",
            stats: [
            ...
            secondaryCta: {
              label: "Explore Recordings",
              ariaLabel: "View past event recordings",
            },
            statsAriaLabel: "Events statistics",
            theme: {
              wrapperClass:
                "relative bg-linear-to-r from-blue-600 to-indigo-700 dark:from-blue-900 dark:to-indigo-900 text-white overflow-hidden",
              breadcrumbClass:
