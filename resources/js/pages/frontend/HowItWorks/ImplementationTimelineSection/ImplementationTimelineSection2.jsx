...
const ImplementationTimelineSection2 = ({ config }) => {
  ...
  const weeks = config?.weeks || Array.from({ length: 12 }, (_, i) => i + 1);
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-between items-center mb-6">
          <div className="flex gap-2">
            <button
              ...
              aria-label="Zoom in"
            >
              <HiOutlineZoomIn className="w-5 h-5 text-gray-600" />
            </button>
            <button
              ...
              aria-label="Zoom out"
            >
              <HiOutlineZoomOut className="w-5 h-5 text-gray-600" />
            </button>
                  ...
                  >
                    ...
                    <div className="flex">
                      <div className="w-48 shrink-0 p-4 border-r border-gray-200 dark:border-gray-700">
                        <div className="flex items-center gap-2">
                          <div className="w-8 h-8 bg-blue-100 dark:bg-blue-900/30 rounded-lg flex items-center justify-center">
                            <span className="text-sm font-bold text-blue-600">{phase.number}</span>
                          </div>
                          <div>
                      ...
                      <div className="flex-1 relative p-2">
                        {/* Task Bar */}
                        <div
                          className="absolute h-12 rounded-lg cursor-pointer transition-all duration-300 hover:shadow-lg"
                          style={{
                    ...
                    {phase.milestones?.map((milestone) => (
                      <div key={milestone.id} className="flex border-t border-gray-50 dark:border-gray-700/50">
                        <div className="w-48 shrink-0 p-3 pl-12 border-r border-gray-200 dark:border-gray-700 text-xs text-gray-500">
                        ...
                        <div className="flex-1 relative p-2">
                          <div
                            className="absolute w-3 h-3 rounded-full cursor-pointer transition-all duration-300 hover:scale-125"
                            style={{
                      ...
                      <div className="flex border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700/30">
                        ...
                        <div className="flex-1 p-4">
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              <h4 className="font-semibold text-gray-900 dark:text-white text-sm mb-2">Key Activities:</h4>
                            ...
                            <div>
                              <h4 className="font-semibold text-gray-900 dark:text-white text-sm mb-2">Deliverables:</h4>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-xl shadow">
            <div className="text-2xl font-bold text-blue-600">{config?.totalDuration || "4-6 weeks"}</div>
            <div className="text-xs text-gray-500">Total Implementation</div>
          </div>
          <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-xl shadow">
            <div className="text-2xl font-bold text-blue-600">{config?.totalMilestones || "12+"}</div>
            <div className="text-xs text-gray-500">Key Milestones</div>
          </div>
          <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-xl shadow">
            <div className="text-2xl font-bold text-blue-600">{config?.dedicatedTeam || "Dedicated"}</div>
            <div className="text-xs text-gray-500">Project Team</div>
          </div>
          <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-xl shadow">
            <div className="text-2xl font-bold text-blue-600">{config?.supportHours || "24/7"}</div>
