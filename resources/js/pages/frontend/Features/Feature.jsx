...
// ============================================================================
// Main Features Component - Receives data from server via Inertia
// ============================================================================
...
const Feature = ({ pageData = { meta: {}, sections: [] } }) => {
  ...
  const pageSeoData = useMemo(() => ({
    title: seo.title || meta.title || "Our Features",
    description: seo.description || meta.description || "Powerful inventory and logistics features designed to optimize your business operations",
    keywords: seo.keywords || meta.keywords || "",
    ogImage: seo.ogImage || meta.ogImage || "/features-og-image.jpg",
  ...
  const sectionsWithDisplayName = useMemo(() => [
    ...
    ...sections.map(section => {
      ...
      const id = `section-${normalizedType}`;
      ...
      <FrontEnd_Layout>
        ...
        <PageHero
          ...
          defaults={{
            ...
            ariaLabel: "Features page hero section",
        ...
        >
          ...
          {sections?.map((section, index) => {
            ...
            if (!SectionComponent) {
              return renderErrorSection(normalizedType, variant, sectionId);
            }
