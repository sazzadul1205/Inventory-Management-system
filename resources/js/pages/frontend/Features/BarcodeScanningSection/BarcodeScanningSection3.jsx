...
const BarcodeScanningSection3 = ({ config }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 right-0 w-1/2 h-full bg-linear-to-l from-cyan-50/50 to-transparent dark:from-cyan-900/10 pointer-events-none" aria-hidden="true"></div>
      <div className="absolute bottom-0 left-0 w-1/2 h-full bg-linear-to-r from-blue-50/50 to-transparent dark:from-blue-900/10 pointer-events-none" aria-hidden="true"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
          {config?.features?.map((feature, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-linear-to-br from-cyan-600/0 via-cyan-600/0 to-cyan-600/5 dark:from-cyan-400/0 dark:via-cyan-400/0 dark:to-cyan-400/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"></div>

              {/* Top accent line */}
              <div className="absolute top-0 left-0 right-0 h-1 bg-linear-to-r from-cyan-500 to-blue-500 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left"></div>

              <div className="p-8">
                {/* Icon with animated background */}
                <div className="relative mb-6">
                  <div className="absolute inset-0 bg-cyan-500/10 dark:bg-cyan-400/10 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              ...
              <div className="absolute bottom-0 right-0 w-20 h-20 bg-linear-to-tl from-cyan-500/5 to-transparent rounded-tl-full pointer-events-none"></div>
            </div>
          ))}
        </div>
