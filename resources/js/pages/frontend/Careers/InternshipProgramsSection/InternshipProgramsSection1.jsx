...
const InternshipProgramsSection1 = ({ config }) => {
    ...
    const getProgramConfig = (program) => {
        const configs = {
            'engineering': { color: 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400', icon: 'code', label: 'Software Engineering' },
            'product': { color: 'bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-400', icon: 'briefcase', label: 'Product Management' },
            'data': { color: 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400', icon: 'chart', label: 'Data Science & Analytics' },
            ...
            'design': { color: 'bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-400', icon: 'template', label: 'Product Design' }
        };
    ...
    const getLocationConfig = (location) => {
        const configs = {
            ...
            'sf': { flag: '🇺🇸', label: 'San Francisco' },
            'nyc': { flag: '🇺🇸', label: 'New York' },
            'london': { flag: '🇬🇧', label: 'London' },
            'bangalore': { flag: '🇮🇳', label: 'Bangalore' }
        };
        return configs[location] || { flag: '🌍', label: location };
    };
    ...
    // Featured program
    const featuredProgram = config?.featuredProgram || filteredPrograms[0];
    ...
    return (
        <section
            ...
            role="region"
            aria-label="Internship Programs Section"
        >
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                                    ...
                                    <div>
                                        <div className="flex items-center gap-2 mb-4">
                                            ...
                                            <div className="flex items-center gap-1 text-sm text-gray-500 dark:text-gray-400">
                                                <span className={`px-2 py-1 rounded-full text-xs font-semibold ${getProgramConfig(featuredProgram.type).color}`}>
                                        ...
                                        <div className="flex flex-wrap gap-3 mb-6">
                                            {featuredProgram.skills?.map((skill, idx) => (
                                        ...
                                        <div className="flex flex-wrap items-center gap-4 mb-6">
                                            <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
                                                ...
                                                <span>{getLocationConfig(featuredProgram.location).flag} {getLocationConfig(featuredProgram.location).label}</span>
                                            </div>
                                            <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
                                        ...
                                        <div className="flex flex-wrap gap-3">
                                            <button
                                                onClick={() => {
                                                    setFormData({ ...formData, program: featuredProgram.title });
                            ...
                            >
                                <div className="p-6">
                                    ...
                                    <div className="space-y-2 mb-4">
                                        <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
                                            <HiOutlineLocationMarker className="w-4 h-4" />
                                            <span>{locationConfig.flag} {locationConfig.label}</span>
                                        </div>
                                        <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
                                            <HiOutlineClock className="w-4 h-4" />
                                    ...
                                    <div className="flex items-center justify-between pt-4 border-t border-gray-100 dark:border-gray-700">
                                        ...
                                        <span className="text-xs text-green-600">{program.deadline}</span>
                                    </div>
                                </div>
                            </div>
                        );
                ...
                <div id="application-form" className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-xl border border-gray-200 dark:border-gray-700">
                    <div className="text-center mb-8">
                        <HiOutlineAcademicCap className="w-12 h-12 mx-auto text-blue-600 dark:text-blue-400 mb-4" />
