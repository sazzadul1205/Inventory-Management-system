...
const ApplicationProcessSection1 = ({ config }) => {
    ...
    return (
        <section
            ...
            role="region"
            aria-label="Application Process Section"
        >
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center max-w-3xl mx-auto mb-12">
                    ...
                    <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
                        {config?.title?.prefix || "Your Journey to"} <span className="bg-linear-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">{config?.title?.highlight || "Joining Us"}</span> {config?.title?.suffix || ""}
                    </h2>
                ...
                <div className="mb-16">
                    ...
                    <div className="relative">
                        ...
                        <div className="space-y-8 md:space-y-0">
                            {steps.map((step, idx) => (
                                <div key={step.id} className={`flex flex-col md:flex-row items-center gap-6 md:gap-12 ${idx % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
                                    {/* Timeline Dot */}
                                    <div className="hidden md:block w-8 h-8 rounded-full bg-blue-600 text-white items-center justify-center z-10 shrink-0">
                                        {step.id}
                                    </div>

                                    {/* Content */}
                                    <div className={`flex-1 bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-200 dark:border-gray-700 ${idx % 2 === 0 ? 'md:text-right' : 'md:text-left'}`}>
                                        <div className={`flex items-center gap-3 mb-3 ${idx % 2 === 0 ? 'md:justify-end' : 'md:justify-start'}`}>
                                            <div className="w-10 h-10 rounded-xl bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center">
                                                {getIcon(step.icon, "w-5 h-5 text-blue-600")}
                                            </div>
                        ...
                        {tips.map((tip, idx) => (
                            <div key={idx} className="text-center">
                                <div className="w-12 h-12 rounded-full bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center mx-auto mb-3">
                                    {getIcon(tip.icon, "w-6 h-6 text-blue-600")}
                                </div>
                ...
                <div id="application-form" className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-xl border border-gray-200 dark:border-gray-700">
                    ...
                    {formSubmitted ? (
                        <div className="text-center py-12">
                            ...
                            <p className="text-gray-600 dark:text-gray-400">Thank you for your application. Our recruiting team will review it and reach out within 3-5 business days.</p>
                        </div>
                    ) : (
