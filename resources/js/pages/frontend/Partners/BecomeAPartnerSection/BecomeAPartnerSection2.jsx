...
const BecomeAPartnerSection2 = ({ config }) => {
    ...
    const programDetails = {
        technology: {
            ...
            requirements: ['Technology integration capability', 'Development team', 'API expertise', 'Commitment to joint solution development']
        },
        solution: {
            ...
            requirements: ['Supply chain expertise', 'Implementation methodology', 'Customer success track record', 'Solution consulting team']
        },
        consulting: {
            ...
            requirements: ['Consulting practice', 'Supply chain certifications', 'Project management expertise', 'Client references']
        },
        reseller: {
            ...
            requirements: ['Sales team', 'Customer base', 'Business development capability', 'Sales process alignment']
        }
    };
                            ...
                            <tbody>
                                {config?.comparisonFeatures?.map((feature, idx) => (
                                    <tr key={idx} className="border-b border-gray-100 dark:border-gray-700">
                                        ...
                                        <td className="p-4 text-center">{feature.technology && <HiOutlineCheckCircle className="w-5 h-5 text-green-500 mx-auto" />}</td>
                                        <td className="p-4 text-center">{feature.solution && <HiOutlineCheckCircle className="w-5 h-5 text-green-500 mx-auto" />}</td>
                                        <td className="p-4 text-center">{feature.consulting && <HiOutlineCheckCircle className="w-5 h-5 text-green-500 mx-auto" />}</td>
                                        <td className="p-4 text-center">{feature.reseller && <HiOutlineCheckCircle className="w-5 h-5 text-green-500 mx-auto" />}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
                            ...
                            <form onSubmit={handleSubmit}>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            <div>
                                                ...
                                                <select
                                                    ...
                                                    onChange={handleInputChange}
                                                    className={`w-full px-4 py-3 bg-gray-50 dark:bg-gray-700 border rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.companySize ? 'border-red-500' : 'border-gray-200 dark:border-gray-600'
                                                        }`}
                                                >
                                ...
                                <div className="flex justify-between mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
                                    ...
                                    {formStep < 4 ? (
                                        ...
                                        <button
                                            type="submit"
                                            className="ml-auto px-6 py-2 bg-green-600 text-white rounded-xl font-medium hover:bg-green-700 transition-all duration-300 flex items-center gap-2"
                                        >
                                            Submit Application
