...
const PageHero = ({ heroData }) => {
  ...
  const title = heroData?.title || 'Strategic';
  const highlightedText = heroData?.highlightedText || 'Partners';
  const description = heroData?.description || 'Join our global network of partners and unlock new opportunities. Together, we deliver innovative solutions that transform supply chains worldwide.';
  ...
  return (
    <section
      ...
      aria-label="Partners page hero section"
    >
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-4 py-20 md:py-28 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <nav aria-label="Breadcrumb" className="flex items-center justify-center gap-2 text-sm text-indigo-100 dark:text-indigo-200 mb-6">
            ...
            <span className="text-white dark:text-white" aria-current="page">Partners</span>
          </nav>
