...
const PartnerDirectorySection3 = ({ config }) => {
    ...
    const getProgramConfig = (program) => {
        const configs = {
            ...
            'solution': { color: 'bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-400', icon: 'briefcase', label: 'Solution Partner', gradient: 'from-purple-500 to-purple-600' },
            'consulting': { color: 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400', icon: 'users', label: 'Consulting Partner', gradient: 'from-green-500 to-green-600' },
            'reseller': { color: 'bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-400', icon: 'globe', label: 'Reseller Partner', gradient: 'from-orange-500 to-orange-600' },
            'integration': { color: 'bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-400', icon: 'code', label: 'Integration Partner', gradient: 'from-indigo-500 to-indigo-600' }
        };
    ...
    const getTierConfig = (tier) => {
        ...
        return configs[tier] || { color: 'bg-gray-100 text-gray-700', label: 'Registered', badge: '📝 Registered' };
    };
    ...
    const getFilteredPartners = useCallback(() => {
        ...
        return partners;
    }, [config?.partners, searchQuery, selectedProgram, selectedRegion, selectedIndustry, activeTab, savedPartners]);
    ...
    const programTypes = config?.programTypes || [
        ...
        { id: 'solution', label: 'Solution', icon: 'briefcase' },
    ...
    const activeFiltersCount = [selectedProgram !== 'all', selectedRegion !== 'all', selectedIndustry !== 'all', searchQuery !== ''].filter(Boolean).length;
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center max-w-4xl mx-auto mb-12">
                    ...
                    <h1 className="text-5xl md:text-7xl font-bold text-gray-900 dark:text-white mb-6">
                        {config?.title?.prefix || "Find the"} <span className="bg-linear-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">{config?.title?.highlight || "Right Partner"}</span>
                    </h1>
                    ...
                    {tabs.map((tab) => (
                        ...
                        >
                            ...
                            {tab.id === 'saved' && savedPartners.length > 0 && (
                                <span className="ml-1 px-2 py-0.5 bg-white/20 rounded-full text-xs">{savedPartners.length}</span>
                            )}
                        </button>
                    ))}
                </div>
                                            ...
                                            <div className="relative h-96 rounded-3xl overflow-hidden">
                                                ...
                                                <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
                                                    ...
                                                    <div className="flex items-center gap-4">
                                                        ...
                                                        <button
                                                            onClick={(e) => { e.stopPropagation(); handleSavePartner(partner.id); }}
                            ...
                            >
                                <div className="p-5">
                                    <div className="flex items-start justify-between mb-3">
                                        <div className="flex items-center gap-3">
                                            {partner.logo ? (
                                                ...
                                                <div className={`w-10 h-10 rounded-xl bg-linear-to-r ${programConfig.gradient} flex items-center justify-center`}>
                                    ...
                                    <div className="flex items-center justify-between pt-3 border-t border-gray-100 dark:border-gray-700">
                                        ...
                                        <span className="text-blue-600 text-xs font-semibold hover:underline">View Profile →</span>
                                    </div>
                                </div>
                            </div>
                        );
                ...
                {filteredPartners.length === 0 && (
                    <div className="text-center py-12">
                        ...
                        <p className="text-gray-500 dark:text-gray-400">
                            {activeTab === 'saved' ? "You haven't saved any partners yet." : "Try adjusting your search or filter criteria"}
                        </p>
                        {activeTab === 'saved' && (
                            ...
                            <div className="p-6">
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {selectedPartner.industries.map((ind, idx) => (
                                                <span key={idx} className="text-xs bg-blue-50 dark:bg-blue-900/20 text-blue-700 px-2 py-1 rounded-full">
                                ...
                                <div className="flex gap-3 pt-4 border-t border-gray-100 dark:border-gray-700">
                                    ...
                                    <button
                                        ...
                                        className={`px-4 py-2 rounded-lg transition-colors ${savedPartners.includes(selectedPartner.id) ? 'bg-yellow-100 text-yellow-600' : 'bg-gray-100 text-gray-600'}`}
                                    >
