...
const ContentPreviewSection1 = ({ config }) => {
    const [, setActiveArticle] = useState(0);
    ...
    // Featured content for the upcoming newsletter
    ...
    return (
        <section
            ...
            role="region"
            aria-label="Content Preview Section"
        >
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center max-w-3xl mx-auto mb-12">
                    ...
                    <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
                        {config?.title?.prefix || "Preview Our"} <span className="bg-linear-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">{config?.title?.highlight || "Latest Issue"}</span> {config?.title?.suffix || ""}
                    </h2>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-xl border border-gray-200 dark:border-gray-700">
                    <div className="text-center mb-8">
                        <div className="w-16 h-16 rounded-2xl bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center mx-auto mb-4">
                            <HiOutlineNewspaper className="w-8 h-8 text-blue-600" />
                        </div>
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                        ...
                        <button className="inline-flex items-center gap-2 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 px-8 py-4 rounded-xl font-semibold hover:bg-gray-200 dark:hover:bg-gray-600 transition-all duration-300">
