...
const UnsubscribeOptionSection2 = ({ config }) => {
    ...
    const handleManageAllSubscriptions = () => {
        // In a real implementation, this would redirect to a full preferences center
            ...
            <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center max-w-3xl mx-auto mb-12">
                    ...
                    <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-4">
                        {step === 'success' ? "Preferences Updated!" : 
                         step === 'confirm' ? "Confirm Unsubscription" : 
                ...
                {step === 'form' && (
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-12">
                        {stats.map((stat, idx) => (
                            <div key={idx} className="bg-white dark:bg-gray-800 rounded-2xl p-3 shadow-lg border border-gray-200 dark:border-gray-700 text-center">
