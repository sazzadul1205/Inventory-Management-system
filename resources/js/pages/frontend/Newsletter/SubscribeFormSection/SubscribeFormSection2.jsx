...
/**
 * Newsletter Subscribe Form Section II - Advanced Subscription Hub with Tabs
 *
 * Unique Design Elements:
 * - Stats Cards with Trend Indicators (Subscribers, Open Rate, CTR, Satisfaction)
 * - Multi-tab UI (Subscribe, Preview Newsletter, Benefits)
 * - Enhanced Form with Additional Fields (Company, Role, Frequency)
 * - Newsletter Preview Grid with Read Time and Categories
 * - Benefits Cards with Gradient Backgrounds
...
const SubscribeFormSection2 = ({ config }) => {
  ...
  const [formData, setFormData] = useState({email: '',firstName: '',lastName: '',company: '',role: '',interests: [],frequency: 'weekly',agreeToTerms: false,subscribeToUpdates: false});
  ...
  const benefits = config?.benefits || [
    { title: "Weekly Insights", description: "Get the latest supply chain trends", icon: "newspaper", gradient: "from-blue-500 to-blue-600" },
    { title: "Expert Tips", description: "Actionable advice from leaders", icon: "academic", gradient: "from-emerald-500 to-emerald-600" },
    { title: "Product Updates", description: "Stay informed about new features", icon: "chip", gradient: "from-purple-500 to-purple-600" },
    { title: "Exclusive Content", description: "Access subscriber-only resources", icon: "star", gradient: "from-amber-500 to-amber-600" }
  ];
  ...
  return (
    <section
      ...
      role="region"
      aria-label="Newsletter Subscription Center"
      itemScope
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-xl border border-gray-200 dark:border-gray-700">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {recentNewsletters.map((newsletter, idx) => (
                <div
                  key={idx}
                  className="bg-gray-50 dark:bg-gray-700/30 rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-all duration-300 group"
                >
                  ...
                  <div className="p-5">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-xs font-semibold text-blue-600 dark:text-blue-400">{newsletter.category}</span>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button className="text-blue-600 dark:text-blue-400 text-sm font-semibold hover:underline" aria-label="Read more">
                        Read More →
                      </button>
                    </div>
                  </div>
            ...
            <div className="text-center mt-6">
              <button className="text-blue-600 dark:text-blue-400 font-semibold hover:underline" aria-label="View all issues">
        ...
        {activeTab === 'benefits' && (
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {benefits.map((benefit, idx) => (
              ...
              >
                <div
                  className={`w-14 h-14 rounded-2xl bg-linear-to-r ${benefit.gradient} flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform`}
                >
        ...
        <div className="mt-12 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-8 mt-4 opacity-60">
            <span className="text-xs font-semibold text-gray-400 dark:text-gray-500">GLOBAL RETAIL CORP</span>
            <span className="text-xs font-semibold text-gray-400 dark:text-gray-500">HEALTHTECH SOLUTIONS</span>
            <span className="text-xs font-semibold text-gray-400 dark:text-gray-500">EUROLOGISTICS</span>
            <span className="text-xs font-semibold text-gray-400 dark:text-gray-500">FINSERVE GLOBAL</span>
          </div>
        </div>
      </div>
