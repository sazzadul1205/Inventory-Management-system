...
const PricingPlans = ({ pageData = { meta: {}, sections: [] } }) => {
  ...
  const pageSeoData = useMemo(() => ({
    title: seo.title || meta.title || "Simple, Transparent Pricing Plans",
    description: seo.description || meta.description || "Choose the plan that fits your business needs. All plans include our core features with flexible options to scale as you grow.",
    keywords: seo.keywords || meta.keywords || "",
    ogImage: seo.ogImage || meta.ogImage || "/pricing-og-image.jpg",
      ...
      <FrontEnd_Layout>
        ...
        <PageHero
          ...
          defaults={{
            ...
            ariaLabel: "Pricing Plans page hero section",
            breadcrumbLabel: "Pricing Plans",
            title: "Simple,",
            highlightedText: "Transparent Pricing Plans",
            description:
              "Choose the plan that fits your business needs. All plans include our core features with flexible options to scale as you grow.",
            stats: [
              { value: "14 Days", label: "Free Trial" },
              { value: "No Setup Fee", label: "Get Started Today" },
              { value: "Cancel Anytime", label: "Flexible Commitment" }
            ],
            primaryCta: { label: "Start Free Trial", ariaLabel: "Start free trial" },
            secondaryCta: { label: "Contact Sales", ariaLabel: "Contact sales" },
            statsAriaLabel: "Pricing Plans highlights",
            theme: {
              wrapperClass:
