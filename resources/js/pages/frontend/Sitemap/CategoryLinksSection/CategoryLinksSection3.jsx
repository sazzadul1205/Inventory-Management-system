    ...
    >
      ...
      <div className="absolute inset-0 opacity-5" aria-hidden="true">
        <svg className="absolute inset-0 w-full h-full" xmlns="http://www.w3.org/2000/svg">
          ...
          <rect width="100%" height="100%" fill="url(#circuit-pattern-category)" />
        </svg>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-4xl mx-auto mb-12">
          <div className="inline-flex items-center gap-2 bg-linear-to-r from-blue-600 to-indigo-600 text-white px-4 py-2 rounded-full mb-6 shadow-lg animate-pulse">
            ...
            <span className="text-sm font-medium">{config?.badge || "Category Links"}</span>
          </div>
            ...
            >
              {featuredCategories.map((category, idx) => (
                <div key={idx} className="w-full shrink-0">
                  <div className={`relative h-80 rounded-3xl overflow-hidden bg-linear-to-r ${category.color}`}>
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-8 text-white">
                      <div className="w-20 h-20 rounded-2xl bg-white/20 backdrop-blur-sm flex items-center justify-center mb-6">
                        {getIcon(category.icon, "w-10 h-10 text-white")}
                      </div>
...
export default CategoryLinksSection3;