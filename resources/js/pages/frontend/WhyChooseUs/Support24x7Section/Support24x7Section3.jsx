                ...
                {activeTab === 'metrics' && (
                    <>
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-md p-6 mb-12">
                            <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-4">SLA Compliance Rate</h3>
                        ...
                        <div className="bg-linear-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-800 rounded-2xl p-6 text-center mb-12">
                            <div className="text-4xl mb-3">⭐</div>
                            <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Customer Satisfaction Score</h3>
                            <div className="text-5xl font-bold text-blue-600 mb-2">4.9/5</div>
                            <p className="text-sm text-gray-600 dark:text-gray-400">Based on {config?.reviewCount || "1,200+"} post-support survey responses</p>
