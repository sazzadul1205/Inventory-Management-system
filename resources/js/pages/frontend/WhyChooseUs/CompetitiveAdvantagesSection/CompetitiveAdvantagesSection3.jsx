...
const CompetitiveAdvantagesSection3 = ({ config }) => {
    ...
    const calculateROI = () => {
        const wasteSavings = (roiValues.monthlySales * roiValues.currentWaste / 100) * 0.3;
        const laborSavings = roiValues.currentLaborHours * 30 * 4 * 0.5;
        ...
        const roi = (netAnnualSavings / (platformCost * 12)) * 100;
        return { wasteSavings, laborSavings, totalMonthlySavings, annualSavings, netAnnualSavings, roi };
    };
    ...
    return (
        <section
            ...
            role="region"
            aria-label="Competitive Advantages Knowledge Base"
        >
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex justify-center gap-4 mb-12">
                    <button
                        ...
                        className={`px-6 py-2 rounded-full text-sm font-medium transition-all ${activeTab === 'advantages'
                    ...
                    <button
                        ...
                        className={`px-6 py-2 rounded-full text-sm font-medium transition-all ${activeTab === 'compare'
                            ? 'bg-blue-600 text-white shadow-lg'
                            : 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400'
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`px-6 py-2 rounded-full text-sm font-medium transition-all ${activeTab === 'roi'
                            ? 'bg-blue-600 text-white shadow-lg'
                            : 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400'
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`px-6 py-2 rounded-full text-sm font-medium transition-all ${activeTab === 'testimonials'
                            ? 'bg-blue-600 text-white shadow-lg'
                            : 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400'
                            }`}
                    >
                        <HiOutlineUsers className="inline w-4 h-4 mr-2" />
                        Success Stories
                    </button>
                    <button
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden">
                            <div className="bg-linear-to-r from-blue-600 to-indigo-600 p-4 text-white">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="font-semibold">How We Stack Up Against Competitors</span>
                                </div>
                            </div>
                            <div className="p-6">
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden">
                            <div className="bg-linear-to-r from-blue-600 to-indigo-600 p-4 text-white">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="font-semibold">Calculate Your Potential ROI</span>
                                </div>
                            </div>
                            <div className="p-6">
                                    ...
                                    <div className="space-y-4">
                                        <div>
                                            ...
                                            <div className="relative">
                                                ...
                                                <input
                                                    type="number"
                                                    value={roiValues.monthlySales}
                                                    onChange={(e) => setRoiValues({ ...roiValues, monthlySales: parseInt(e.target.value) || 0 })}
                                                    className="w-full pl-8 pr-4 py-2 border border-gray-300 rounded-lg dark:bg-gray-700"
                                                />
                                            </div>
                                        </div>
                                        <div>
                                            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                                Current Inventory Waste (% of sales)
                                            </label>
                                            <input
                                                type="range"
                                                min="0"
                                                max="50"
                                                value={roiValues.currentWaste}
                                                onChange={(e) => setRoiValues({ ...roiValues, currentWaste: parseInt(e.target.value) })}
                                                className="w-full"
                                            />
                                            <div className="text-center text-sm text-blue-600 mt-1">{roiValues.currentWaste}% waste</div>
                                        </div>
                                        <div>
                                            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                                Weekly Labor Hours on Inventory
                                            </label>
                                            <input
                                                type="range"
                                                min="0"
                                                max="100"
                                                value={roiValues.currentLaborHours}
                                                onChange={(e) => setRoiValues({ ...roiValues, currentLaborHours: parseInt(e.target.value) })}
                                                className="w-full"
                                            />
                                            <div className="text-center text-sm text-blue-600 mt-1">{roiValues.currentLaborHours} hours/week</div>
                                        </div>
                                    </div>
                                    <div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-6">
                                        <h4 className="text-lg font-bold text-gray-900 dark:text-white mb-4">Your Estimated Savings</h4>
                                        <div className="space-y-3">
                                            <div className="flex justify-between">
                                                <span className="text-gray-600 dark:text-gray-400">Inventory Waste Reduction (30%):</span>
                                                <span className="font-semibold text-green-600">${Math.round(roiResults.wasteSavings)}/month</span>
                                            </div>
                                            <div className="flex justify-between">
                                                <span className="text-gray-600 dark:text-gray-400">Labor Time Savings (50%):</span>
                                                <span className="font-semibold text-green-600">${Math.round(roiResults.laborSavings)}/month</span>
                                            </div>
                                            <div className="border-t border-gray-200 dark:border-gray-600 pt-2 mt-2">
                                                <div className="flex justify-between">
                                                    <span className="font-semibold text-gray-900 dark:text-white">Total Monthly Savings:</span>
                                                    <span className="font-bold text-blue-600">${Math.round(roiResults.totalMonthlySavings)}</span>
                                                </div>
                                                <div className="flex justify-between mt-1">
                                                    <span className="font-semibold text-gray-900 dark:text-white">Annual Savings:</span>
                                                    <span className="font-bold text-blue-600">${Math.round(roiResults.annualSavings)}</span>
                                                </div>
                                                <div className="flex justify-between mt-1">
                                                    <span className="font-semibold text-gray-900 dark:text-white">Net Annual Savings (after subscription):</span>
                                                    <span className="font-bold text-green-600">${Math.round(roiResults.netAnnualSavings)}</span>
                                                </div>
                                                <div className="flex justify-between mt-2 pt-2 border-t border-gray-200 dark:border-gray-600">
                                                    ...
                                                    <span className="font-bold text-green-600 text-xl">{Math.round(roiResults.roi)}%</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="mt-12">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    {videos.map((video, index) => (
                                        <div key={index} className="bg-white dark:bg-gray-800 rounded-2xl shadow-md hover:shadow-lg transition-all overflow-hidden cursor-pointer group">
