        ...
        >
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
                    {testimonials.map((testimonial, index) => (
                        <div key={index} className="bg-white dark:bg-gray-800 rounded-2xl shadow-md hover:shadow-lg transition-all p-6">
                            ...
                            <p className="text-gray-600 dark:text-gray-400 text-sm italic mb-4">"{testimonial.quote}"</p>
                ...
                <div className="bg-linear-to-r from-blue-600 to-indigo-600 rounded-2xl p-8 text-center text-white mb-16">
                    ...
                    <div className="text-6xl font-bold mb-2">{config?.satisfactionScore || "4.9"}/5</div>
                    ...
                    <div className="flex items-center justify-center gap-2 text-sm text-blue-100">
                        ...
                        <span>Based on {config?.reviewCount || "1,200+"} verified reviews</span>
                    </div>
                </div>
                ...
                <div className="max-w-2xl mx-auto mb-8">
                    <div className="relative">
                        ...
                        <input
                            type="text"
                            placeholder="Search customer satisfaction FAQs..."
                            value={searchQuery}
