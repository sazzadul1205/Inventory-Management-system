...
const CustomerSatisfactionStatsSection2 = ({ config }) => {
    ...
    return (
        <section
            ...
            role="region"
            aria-label="Customer Satisfaction Stats Help Center"
        >
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-wrap justify-center gap-2 mb-8">
                    <button
                        ...
                        className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${activeRatingFilter === 'all'
                    ...
                    {[5, 4, 3, 2, 1].map((stars) => (
                        <button
                            ...
                            className={`px-4 py-2 rounded-full text-sm font-medium transition-all flex items-center gap-1 ${activeRatingFilter === stars.toString()
                                ? 'bg-blue-600 text-white shadow-lg'
                                : 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-gray-200'
                                }`}
                        >
                ...
                {config?.featuredTestimonial && (
                    <div className="bg-linear-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-800 rounded-2xl p-8 text-center mb-12 cursor-pointer" onClick={() => {
                        setSelectedTestimonial(config.featuredTestimonial);
                        setShowModal(true);
                    }}>
                        ...
                        <div>
                            <div className="font-bold text-gray-900 dark:text-white">{config.featuredTestimonial.name}</div>
                            <div className="text-sm text-gray-500">{config.featuredTestimonial.role}, {config.featuredTestimonial.company}</div>
                        </div>
                    </div>
                )}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
                    {filteredTestimonials.map((testimonial, index) => (
                        ...
                        >
                            ...
                            <p className="text-gray-600 dark:text-gray-400 text-sm italic mb-4 line-clamp-4">"{testimonial.quote}"</p>
                ...
                {filteredTestimonials.length === 0 && (
                    <div className="text-center py-12">
                        ...
                        <p className="text-gray-500">Try adjusting your rating filter to see more reviews.</p>
                    </div>
                )}
