...
const IndustryExpertiseSection2 = ({ config }) => {
    ...
    return (
        <section
            ...
            role="region"
            aria-label="Industry Expertise Help Center"
        >
                ...
                <div className="mb-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {industries.map((industry, index) => (
                            <div
                                key={index}
                                className="bg-white dark:bg-gray-800 rounded-2xl shadow-md hover:shadow-lg transition-all p-6 text-center group cursor-pointer"
                                onClick={() => {
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center gap-2 text-sm text-gray-500 mb-2">
                                            <span className="text-blue-600">{study.industry}</span>
                                            <span>•</span>
