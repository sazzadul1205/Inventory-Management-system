// frontend/WhyChooseUs/IndustryExpertiseSection/IndustryExpertiseSection2.jsx

/**
 * Industry Expertise Section 2 - Vertical-Specific Solutions Hub
 * 
 * Unique design elements:
 * - Industry filterable case studies with results
 * - Vertical-specific challenge/solution breakdowns
 * - Industry modal with detailed capabilities
 * - Multi-echelon BOM optimization explanation
 * - Omnichannel retail allocation features
 * - 3PL multi-tenant architecture details
 * - Expert quote from Fortune 100 SVP
 * 
 * All icons from react-icons (tb, gi, hi, etc.)
...
// React Icons - Industry vertical focused set
...
const IndustryExpertiseSection2 = ({ config }) => {
  // ==================== STATE MANAGEMENT ====================
  ...
  const getIcon = useCallback((iconName, className = "w-5 h-5") => {
    const icons = {
      ...
      HiOutlineCalendar, HiOutlineTrendingUp, HiOutlineStar, HiOutlineUserGroup,
  ...
  return (
    <section
      ...
      role="region"
      aria-label="Industry Expertise Solutions"
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
            {config?.title?.prefix || 'Vertical-Specific'}{' '}
            <span className={`bg-linear-to-r ${config?.title?.highlightGradient || 'from-indigo-600 to-purple-600'} bg-clip-text text-transparent`}>
              {config?.title?.highlightedText || 'Supply Chain Solutions'}
            </span>{' '}
            {config?.title?.suffix || ''}
          </h2>
          <p className="text-xl text-gray-600 dark:text-gray-300">
            {config?.description || "Every industry has unique inventory challenges. Our platform is purpose-built with deep domain expertise across manufacturing, retail, distribution, and logistics — backed by real customer success stories."}
          </p>
        </div>
        ...
        <div className="mb-16">
          ...
          <p className="text-center text-gray-600 dark:text-gray-400 mb-10 max-w-2xl mx-auto">
            Purpose-built solutions for your vertical's unique challenges.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {industries.map((industry, index) => (
              ...
              >
                <div className="flex justify-center mb-3 text-indigo-600 dark:text-indigo-400 group-hover:scale-110 transition-transform">
        ...
        <div className="mb-16">
          ...
          <p className="text-center text-gray-600 dark:text-gray-400 mb-10 max-w-2xl mx-auto">
            Deep capabilities that drive real business outcomes across verticals.
          </p>
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    {item.stat && (
                      <div className="mt-2 inline-flex items-center gap-1 text-xs font-semibold text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-900/30 px-2 py-1 rounded-full">
        ...
        <div className="mb-16">
          ...
          <p className="text-center text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto">
            Real results from customers across every vertical.
          </p>

          {/* Industry Filters for Case Studies */}
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap items-center gap-2 text-sm text-gray-500 dark:text-gray-400 mb-2">
                      <span className="text-indigo-600 dark:text-indigo-400 font-medium">{industries.find(i => i.id === study.industry)?.name || study.industry}</span>
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-2">
                      ...
                      <Link href={study.link} className="text-indigo-600 dark:text-indigo-400 text-sm font-semibold hover:underline inline-flex items-center gap-1">
                        Read full story
        ...
        {/* ==================== EXPERT QUOTE ==================== */}
        <div className="bg-linear-to-r from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 rounded-2xl p-8 text-center mb-16 border border-indigo-100 dark:border-indigo-800 shadow-md">
          <div className="flex justify-center mb-4">
            <div className="w-16 h-16 bg-indigo-100 dark:bg-indigo-900/30 rounded-full flex items-center justify-center">
              {getIcon("FaUserTie", "w-8 h-8 text-indigo-600")}
            </div>
          </div>
          <div className="flex justify-center mb-3">
            {getIcon("FaQuoteLeft", "w-8 h-8 text-indigo-400 opacity-50")}
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-center text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto">
            Deep dive answers for your industry's unique challenges.
          </p>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400">Vertical-specific solutions</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
        ...
        {showModal && selectedIndustry && (
          ...
          >
            ...
            >
              <div className="bg-linear-to-r from-indigo-600 to-purple-600 p-6 rounded-t-3xl text-white">
              ...
              <div className="p-6">
                ...
                {selectedIndustry.caseStudy && (
                  <div className="bg-indigo-50 dark:bg-indigo-900/20 rounded-lg p-4">
                    <h4 className="font-semibold text-indigo-600 dark:text-indigo-400 mb-1 flex items-center gap-2">
                ...
                <Link
                  ...
                  className="mt-5 w-full inline-flex items-center justify-center gap-2 px-4 py-3 bg-linear-to-r from-indigo-600 to-purple-600 text-white rounded-xl font-semibold hover:shadow-lg transition-all duration-300 transform hover:scale-[1.02]"
                >
        ...
        <div className="text-center">
          <div className="inline-flex flex-col sm:flex-row items-center gap-5 p-6 bg-linear-to-r from-indigo-50 to-purple-50 dark:from-gray-800 dark:to-gray-800 rounded-2xl border border-indigo-100 dark:border-gray-700">
            <div className="w-12 h-12 bg-indigo-100 dark:bg-indigo-900/30 rounded-full flex items-center justify-center">
              {getIcon("FaIndustry", "w-6 h-6 text-indigo-600")}
            </div>
            <span className="text-gray-700 dark:text-gray-300 font-medium text-center sm:text-left">
              {config?.contactText || "Let's discuss your industry-specific challenges."}
            </span>
            <Link
            ...
            >
              {config?.contactButtonText || "Request Industry Consultation"}
              {getIcon("HiOutlineArrowRight", "w-4 h-4")}
            </Link>
          </div>
        </div>
...
export default IndustryExpertiseSection2;