...
const UniqueSellingPointsSection3 = ({ config }) => {
    ...
    return (
        <section
            ...
            role="region"
            aria-label="Unique Selling Points Knowledge Base"
        >
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex justify-center gap-4 mb-12">
                    <button
                        ...
                        className={`px-6 py-2 rounded-full text-sm font-medium transition-all ${activeTab === 'usps'
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
                        {usps.map((usp, index) => (
                            ...
                            >
                                ...
                                <p className="text-gray-600 dark:text-gray-400 mb-4 line-clamp-2">{usp.description}</p>
                ...
                {activeTab === 'metrics' && (
                    <div className="mb-16">
                        ...
                        <div className="bg-linear-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-800 rounded-2xl p-8 text-center">
                            ...
                            <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Industry-Leading Results</h3>
                            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                                Our customers consistently achieve measurable improvements in inventory efficiency, cost reduction, and revenue growth.
