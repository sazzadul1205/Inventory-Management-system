...
const UniqueSellingPointsSection2 = ({ config }) => {
    ...
    const comparisonPoints = config?.comparisonPoints || [];
    ...
    const handleExport = () => {
        ...
        linkElement.setAttribute('download', 'usp-faq-export.json');
        linkElement.click();
    };
    ...
    const filteredComparison = comparisonPoints.filter(point => {
    ...
    return (
        <section
            ...
            role="region"
            aria-label="Unique Selling Points Help Center"
        >
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
                    {usps.map((usp, index) => (
                        <div
                            key={index}
                            className="bg-white dark:bg-gray-800 rounded-2xl shadow-md hover:shadow-xl transition-all p-6 group cursor-pointer"
                            onClick={() => {
                                setSelectedUsp(usp);
                                setShowModal(true);
                            }}
                        >
                            <div className="text-4xl mb-4 group-hover:scale-110 transition-transform">{usp.icon}</div>
                            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">{usp.title}</h3>
                            <p className="text-gray-600 dark:text-gray-400 mb-4">{usp.description}</p>
                ...
                <div className="mb-16">
                    ...
                    <div className="flex flex-wrap justify-center gap-2 mb-6">
                        <button
                            ...
                            className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${activeComparison === 'all'
                        ...
                        <button
                            ...
                            className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${activeComparison === 'ai'
                                ? 'bg-blue-600 text-white shadow-lg'
                                : 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-gray-200'
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${activeComparison === 'support'
                                ? 'bg-blue-600 text-white shadow-lg'
                                : 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-gray-200'
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${activeComparison === 'integrations'
                                ? 'bg-blue-600 text-white shadow-lg'
                                : 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-gray-200'
                                }`}
                        >
                        ...
                        <table className="w-full bg-white dark:bg-gray-800 rounded-2xl shadow-md">
                            <thead>
                                <tr className="border-b border-gray-200 dark:border-gray-700">
                                    ...
                                    <th className="px-6 py-4 text-center text-sm font-semibold text-gray-500">Traditional Solutions</th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
                                {filteredComparison.map((point, index) => (
                                    <tr key={index}>
                                        ...
                                        <td className="px-6 py-4 text-center text-sm text-gray-500">{point.other}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
                ...
                <div className="bg-linear-to-r from-blue-600 to-indigo-600 rounded-2xl p-8 text-center text-white mb-16">
                    ...
                    <p className="text-blue-100 max-w-2xl mx-auto">
                        {config?.highlightText || "We combine cutting-edge AI technology with human-centered design to deliver an inventory management experience that's powerful yet simple. Our platform is built by supply chain experts who understand real business needs."}
                    </p>
                </div>
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl max-w-md w-full" onClick={(e) => e.stopPropagation()}>
                            <div className="bg-linear-to-r from-blue-600 to-indigo-600 p-6 rounded-t-3xl text-white">
                                <div className="flex justify-between items-start">
                                    <div className="text-4xl">{selectedUsp.icon}</div>
                                    <button onClick={() => setShowModal(false)} className="text-white hover:text-gray-200">
                                        <HiOutlineX className="w-6 h-6" />
                                    </button>
                                </div>
                                <h3 className="text-xl font-bold mt-2">{selectedUsp.title}</h3>
                            </div>
                            <div className="p-6">
                                <p className="text-gray-600 dark:text-gray-400 mb-4">{selectedUsp.description}</p>
                                ...
                                {selectedUsp.detail && (
                                    <div className="border-t border-gray-100 dark:border-gray-700 pt-4">
                                        <p className="text-sm text-gray-500">{selectedUsp.detail}</p>
                                    </div>
                                )}
                                <Link
                                    href="/signup"
                ...
                <div className="text-center">
                    <div className="inline-flex flex-col sm:flex-row items-center gap-4 p-6 bg-linear-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-800 rounded-2xl">
                        ...
                        <span className="text-gray-700 dark:text-gray-300 font-medium">
                            {config?.contactText || "Ready to experience what makes us different? Start your free trial today."}
                        </span>
                        <Link
