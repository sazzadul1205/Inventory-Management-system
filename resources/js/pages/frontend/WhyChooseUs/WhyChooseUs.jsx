...
const PageHero = ({ heroData }) => {
  ...
  const title = heroData?.title || 'Why Choose';
  const highlightedText = heroData?.highlightedText || 'Us';
  const description = heroData?.description || 'Discover what makes us the trusted choice for businesses worldwide. From innovative technology to dedicated support, see why thousands of companies rely on our platform.';
  ...
  return (
    <section
      ...
      aria-label="Why Choose Us page hero section"
    >
      ...
      <div className="container mx-auto px-4 py-20 md:py-28 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <nav aria-label="Breadcrumb" className="flex items-center justify-center gap-2 text-sm text-blue-100 dark:text-blue-200 mb-6">
            ...
            <span className="text-white dark:text-white" aria-current="page">Why Choose Us</span>
          </nav>
