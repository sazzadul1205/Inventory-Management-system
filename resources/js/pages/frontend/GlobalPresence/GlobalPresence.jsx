...
const GlobalPresence = ({ pageData = { meta: {}, sections: [] } }) => {
  ...
  const pageSeoData = useMemo(() => ({
    title: seo.title || meta.title || "Global Presence | Worldwide Locations & Local Support",
    description: seo.description || meta.description || "Expand your reach with our worldwide locations, regional offices, and localized services. We deliver seamless global operations backed by strong local expertise across 100+ countries.",
    keywords: seo.keywords || meta.keywords || "global presence, worldwide locations, regional offices, global coverage, international operations, local support, language support, currency support, global reach, international clients",
    ogImage: seo.ogImage || meta.ogImage || "/global-presence-og-image.jpg",
  ...
  return (
    <>
      <Head>
        ...
        <meta name="geo.region" content={seo.geoRegion || meta.geoRegion || "US"} />
        <meta name="geo.placename" content={seo.geoPlacename || meta.geoPlacename || "Global"} />
        <meta name="geo.position" content={seo.geoPosition || meta.geoPosition} />
        <meta name="ICBM" content={seo.icbm || meta.icbm} />
      </Head>
