                                        ...
                                        <div className="flex gap-1">
                                            {values.map((_, idx) => (
                                                <button
                                                    ...
                                                    className={`h-1.5 rounded-full transition-all ${activeValue === idx ? 'w-6 bg-blue-600' : 'w-1.5 bg-gray-300'}`}
                                                />
                                            ))}
                                        </div>
                                        <button
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {recognitions.map((recognition, index) => (
                                <div key={index} className="bg-white dark:bg-gray-800 rounded-2xl shadow-md hover:shadow-lg transition-all p-6 text-center group">
                                    <div className="text-4xl mb-3 group-hover:scale-110 transition-transform">{recognition.icon}</div>
                                    ...
                                    <p className="text-xs text-gray-500">{recognition.year}</p>
                                </div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="mb-16">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {videos.map((video, index) => (
                                ...
                                >
                                    <div className="relative h-40 bg-linear-to-r from-blue-500 to-indigo-600 flex items-center justify-center">
                                    ...
                                    <div className="p-4">
                                        ...
                                        <p className="text-xs text-gray-500">{video.duration} • {video.author}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
