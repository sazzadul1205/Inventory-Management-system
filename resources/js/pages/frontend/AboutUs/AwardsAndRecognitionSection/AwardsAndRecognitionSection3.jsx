...
const AwardsAndRecognitionSection3 = ({ config }) => {
    ...
    const groupedAwards = years.reduce((acc, year) => {
    ...
    const yearTimeline = [...years].sort((a, b) => parseInt(b) - parseInt(a));
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex justify-center gap-4 mb-12">
                    <button
                        ...
                        className={`px-6 py-2 rounded-full text-sm font-medium transition-all ${activeTab === 'awards'
                                                ...
                                                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-md hover:shadow-xl transition-all p-6">
                                                    ...
                                                    <div className="space-y-4">
                                                        {yearAwards.map((award, idx) => (
                                                            <div key={idx} className="border-l-2 border-blue-200 dark:border-blue-800 pl-4 cursor-pointer hover:border-blue-500 transition-all" onClick={() => {
                                                                setSelectedAward(award);
                                                                setShowModal(true);
                                                            }}>
                                    ...
                                    <div className="flex items-start gap-3 mb-3">
                                        ...
                                        <div>
                                            ...
                                            <div className="mt-3">
                                                ...
                                                {testimonial.award && (
                                                    <div className="text-xs text-blue-600 mt-1">Award: {testimonial.award}</div>
                                                )}
                                            </div>
                                        </div>
                                    </div>
                ...
                {showModal && selectedAward && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4" onClick={() => setShowModal(false)}>
                        <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl max-w-lg w-full" onClick={(e) => e.stopPropagation()}>
                            <div className={`bg-linear-to-r ${selectedAward.type === 'product' ? 'from-blue-500 to-indigo-500' : selectedAward.type === 'company' ? 'from-green-500 to-emerald-500' : selectedAward.type === 'customer' ? 'from-purple-500 to-pink-500' : selectedAward.type === 'workplace' ? 'from-orange-500 to-amber-500' : 'from-indigo-500 to-purple-500'} p-6 rounded-t-3xl text-white`}>
