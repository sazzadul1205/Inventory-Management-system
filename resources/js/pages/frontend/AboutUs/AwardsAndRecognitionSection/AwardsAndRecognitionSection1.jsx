        ...
        >
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {config?.featuredAward && (
                    <div className="mb-16">
                        <div className="bg-linear-to-r from-yellow-50 to-amber-50 dark:from-yellow-900/20 dark:to-amber-900/20 rounded-2xl p-8 text-center border border-yellow-200 dark:border-yellow-800">
