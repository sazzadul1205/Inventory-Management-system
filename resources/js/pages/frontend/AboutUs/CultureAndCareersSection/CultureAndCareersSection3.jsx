...
const CultureAndCareersSection3 = ({ config }) => {
  ...
  }, [openPositions, activeDepartment, activeLocation, searchQuery]);
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          >
            ...
            <span className={`text-sm font-medium ${config?.badge?.textColor || 'text-violet-700 dark:text-violet-300'}`}>
              {config?.badge?.text || "Come Grow With Us"}
            </span>
          </div>
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
            {config?.title?.prefix || 'Where Your'}{' '}
            <span className={`bg-linear-to-r ${config?.title?.highlightGradient || 'from-violet-600 to-purple-600'} bg-clip-text text-transparent`}>
              {config?.title?.highlightedText || 'Career Takes Flight'}
            </span>{' '}
            {config?.title?.suffix || ''}
          </h2>
          <p className="text-xl text-gray-600 dark:text-gray-300">
            {config?.description || "We believe that great companies are built by great people. If you're looking for a place where you can make an impact, grow continuously, and work alongside passionate colleagues, you've found your home."}
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-12">
          <button
            ...
            className={`px-6 py-2.5 rounded-full text-sm font-medium transition-all duration-300 transform hover:scale-105 inline-flex items-center gap-2 ${activeTab === 'positions'
          ...
          <button
            ...
            className={`px-6 py-2.5 rounded-full text-sm font-medium transition-all duration-300 transform hover:scale-105 inline-flex items-center gap-2 ${activeTab === 'life'
              ? 'bg-linear-to-r from-violet-600 to-purple-600 text-white shadow-lg'
              : 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700'
              }`}
          >
          ...
          <>
            ...
            <div className="flex flex-wrap justify-center gap-2 mb-6">
              <button
                ...
                className={`px-4 py-2 rounded-full text-sm font-medium transition-all duration-300 transform hover:scale-105 ${activeLocation === 'all'
                  ? 'bg-linear-to-r from-violet-600 to-purple-600 text-white shadow-lg'
                  : 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700'
                  }`}
              >
              ...
              {locations.map((loc) => (
                <button
                  ...
                  className={`px-4 py-2 rounded-full text-sm font-medium transition-all duration-300 transform hover:scale-105 ${activeLocation === loc
                    ? 'bg-linear-to-r from-violet-600 to-purple-600 text-white shadow-lg'
                    : 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700'
                    }`}
                >
            ...
            {searchQuery && (
              <div className="text-center mb-4 text-sm text-gray-500 dark:text-gray-400">
                Found {filteredPositions.length} position{filteredPositions.length !== 1 ? 's' : ''} for "{searchQuery}"
              </div>
            )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
              {filteredPositions.map((position, index) => (
                ...
                >
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 mb-4 line-clamp-2 leading-relaxed">{position.description}</p>
                  <div className="flex flex-wrap items-center justify-between gap-2">
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1 text-violet-600 dark:text-violet-400 text-sm font-semibold hover:gap-2 transition-all duration-200 group"
                    >
                      Apply Now
        ...
        {activeTab === 'life' && (
          <>
              ...
              <div className="mb-16">
                ...
                <div className="relative max-w-3xl mx-auto">
                  <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 text-center border border-gray-100 dark:border-gray-700">
                    <div className="flex justify-center mb-4 text-violet-600 dark:text-violet-400 text-5xl">
                      {testimonials[activeTestimonial]?.icon || getIcon("HiOutlineHeart", "w-12 h-12")}
                    </div>
                  ...
                  <div className="flex justify-center gap-2 mt-4">
                    {testimonials.map((_, idx) => (
                      <button
                        ...
                        className={`h-2 rounded-full transition-all duration-300 ${activeTestimonial === idx ? 'w-6 bg-violet-600' : 'w-2 bg-gray-300 dark:bg-gray-600'}`}
                  ...
                  <button
                    ...
                    className="absolute bottom-0 right-0 text-xs text-gray-400 dark:text-gray-500 hover:text-violet-600 dark:hover:text-violet-400 transition-colors"
            ...
            <div className="mb-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {cultureMoments.map((moment, index) => (
                  ...
                  >
                    <div className="h-48 bg-linear-to-r from-violet-500 to-purple-600 flex items-center justify-center">
            ...
            <div className="mb-16">
              ...
              <p className="text-center text-gray-600 dark:text-gray-400 mb-10 max-w-2xl mx-auto">
                Get to know the people who make our culture special.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {teamMembers.map((member, index) => (
                  ...
                  >
                    <div className="w-24 h-24 mx-auto bg-linear-to-r from-violet-500 to-purple-600 rounded-full flex items-center justify-center text-4xl text-white mb-4">
            ...
            {videos.length > 0 && (
              <div className="mb-16">
                ...
                <p className="text-center text-gray-600 dark:text-gray-400 mb-10 max-w-2xl mx-auto">
                  Watch and hear from our team members themselves.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {values.map((value, index) => (
                <div
                  ...
                  className="bg-white dark:bg-gray-800 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 p-6 text-center border border-gray-100 dark:border-gray-700"
                >
                  <div className="flex justify-center mb-3 text-violet-600 dark:text-violet-400 text-5xl">
                    {value.icon}
                  </div>
                  ...
                  <div className="text-xs font-medium text-violet-600 dark:text-violet-400 border-t border-gray-100 dark:border-gray-700 pt-3 mt-2">
                    {value.example}
                  </div>
                </div>
              ))}
        ...
        {/* ==================== BENEFITS SECTION ==================== */}
        <div className="bg-linear-to-r from-violet-50 to-purple-50 dark:from-gray-800 dark:to-gray-800 rounded-2xl p-8 text-center mb-12 border border-violet-100 dark:border-gray-700">
          <h3 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white mb-6">Benefits & Perks</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {benefits.map((benefit, index) => (
              <div
                key={index}
                className="bg-white dark:bg-gray-800 rounded-xl p-4 text-center border border-gray-100 dark:border-gray-700 hover:shadow-md transition-all duration-300"
              >
                <div className="flex justify-center mb-2 text-violet-600 dark:text-violet-400 text-3xl">
                  ...
                  <form onSubmit={handleApplicationSubmit} className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-violet-500 focus:border-transparent transition-all"
                        required
                      />
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        accept=".pdf,.doc,.docx"
                        className="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-violet-500 focus:border-transparent transition-all file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-violet-50 file:text-violet-700 hover:file:bg-violet-100 dark:file:bg-violet-900/30 dark:file:text-violet-400"
                        required
                      />
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-violet-500 focus:border-transparent transition-all resize-none"
                      />
                    </div>
                    <div>
                    ...
                    <div className="flex items-start gap-3">
                      <input
                        ...
                        className="w-4 h-4 text-violet-600 rounded focus:ring-violet-500 mt-0.5"
                      />
                      <label className="text-sm text-gray-600 dark:text-gray-400">
                        I agree to the <Link href="/privacy" className="text-violet-600 hover:underline">Privacy Policy</Link> and confirm that the information provided is accurate. *
                      </label>
                    </div>
                    <button
                      type="submit"
