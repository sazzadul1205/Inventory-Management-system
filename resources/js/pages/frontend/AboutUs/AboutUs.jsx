...
const PageHero = ({ heroData }) => {
  ...
  const description = heroData?.description || 'We are on a mission to transform inventory management through innovative technology and exceptional customer service. Learn more about our story, values, and the team behind the platform.';
  ...
  return (
    <section
      className="relative bg-linear-to-r from-blue-600 to-indigo-700 dark:from-blue-900 dark:to-indigo-950 text-white overflow-hidden"
      aria-label="About Us page hero section"
    >
      ...
      <div className="container mx-auto px-4 py-20 md:py-28 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <nav aria-label="Breadcrumb" className="flex items-center justify-center gap-2 text-sm text-blue-100 dark:text-blue-200 mb-6">
            ...
            <span className="text-white dark:text-white" aria-current="page">About Us</span>
          </nav>
