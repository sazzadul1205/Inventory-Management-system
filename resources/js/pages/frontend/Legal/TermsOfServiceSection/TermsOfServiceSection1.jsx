...
/**
 * Terms of Service Section I - Legal Agreement & Compliance Hub
 *
 * Unique Design Elements:
 * - Sticky Navigation Sidebar with Scroll Spy
 * - Subscription Plans Comparison Cards
        ...
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="hidden lg:block lg:col-span-1">
            <div className="sticky top-24 bg-gray-50 dark:bg-gray-800 rounded-2xl p-4 border border-gray-200 dark:border-gray-700">
              ...
              <nav className="space-y-1 max-h-96 overflow-y-auto" aria-label="Terms of service navigation">
          ...
          <div className="lg:col-span-3 space-y-8">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
                ...
                <div className="space-y-4 text-gray-600 dark:text-gray-400">
                  ...
                  <div className="flex items-start gap-3 p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg">
                    <HiOutlineCheckCircle className="w-5 h-5 text-yellow-600 dark:text-yellow-400 shrink-0 mt-0.5" />
            ...
            <div
              id="license-grant"
              ref={el => sectionRefs.current['license-grant'] = el}
              className="scroll-mt-24"
            >
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
                <div className="flex items-center gap-3 mb-4">
                ...
                <div className="space-y-4 text-gray-600 dark:text-gray-400">
                  ...
                  <p>This license does not grant you any ownership rights to our Services or intellectual property.</p>
                </div>
              </div>
            </div>
            ...
            <div
              id="user-obligations"
              ref={el => sectionRefs.current['user-obligations'] = el}
              className="scroll-mt-24"
            >
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
                <div className="flex items-center gap-3 mb-4">
                ...
                <div className="space-y-4 text-gray-600 dark:text-gray-400">
                  <p>You agree to use our Services responsibly and in compliance with all applicable laws and regulations. You are responsible for:</p>
                  <ul className="space-y-2 ml-4">
                    <li className="flex items-start gap-2">
                      <HiOutlineCheckCircle className="w-4 h-4 text-green-500 dark:text-green-400 mt-0.5 shrink-0" />
            ...
            >
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
                ...
                <div className="space-y-4 text-gray-600 dark:text-gray-400">
                  <p>You may not use our Services for any unlawful purpose or in any way that could damage, disable, overburden, or impair our Services. Prohibited activities include:</p>
                  <ul className="space-y-2 ml-4">
                    <li className="flex items-start gap-2">
            ...
            {/* Subscriptions & Fees Section */}
            <div
              id="subscriptions-fees"
              ref={el => sectionRefs.current['subscriptions-fees'] = el}
              className="scroll-mt-24"
            >
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
                <div className="flex items-center gap-3 mb-4">
                ...
                <div className="space-y-4 text-gray-600 dark:text-gray-400">
                  <p>Certain features of our Services require a paid subscription. By subscribing, you agree to pay all applicable fees as described.</p>
                        ...
                        <ul className="mt-3 space-y-1 text-sm">
                          {plan.features.map((feature, fIdx) => (
                            <li key={fIdx} className="flex items-center gap-1">
                              <HiOutlineCheckCircle className="w-3 h-3 text-green-500 dark:text-green-400" />
                              <span>{feature}</span>
                            </li>
                          ))}
                        </ul>
            ...
            <div id="data-privacy"
              ref={el => sectionRefs.current['data-privacy'] = el}
              className="scroll-mt-24"
            >
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 rounded-xl bg-indigo-100 dark:bg-indigo-900/30 flex items-center justify-center">
                    <HiOutlineDatabase className="w-5 h-5 text-indigo-600 dark:text-indigo-400" />
                  </div>
                ...
                <div className="space-y-4 text-gray-600 dark:text-gray-400">
                  ...
                  <div className="flex items-start gap-3 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                    <HiOutlineLockClosed className="w-5 h-5 text-blue-600 dark:text-blue-400 shrink-0 mt-0.5" />
            ...
            >
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 rounded-xl bg-indigo-100 dark:bg-indigo-900/30 flex items-center justify-center">
                    <HiOutlineX className="w-5 h-5 text-indigo-600 dark:text-indigo-400" />
                  </div>
                  <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Termination</h2>
                </div>
                <div className="space-y-4 text-gray-600 dark:text-gray-400">
                  <p>You may terminate your account at any time by following the account deletion process in our app.</p>
                  <p>We may suspend or terminate your access to our Services immediately, without notice, for:</p>
                  <ul className="space-y-2 ml-4">
                    <li className="flex items-start gap-2">
                      <HiOutlineX className="w-4 h-4 text-red-500 dark:text-red-400 mt-0.5 shrink-0" />
                  ...
                  <p>Upon termination, your right to use our Services will immediately cease, and we may delete your data in accordance with our data retention policies.</p>
                </div>
              </div>
            </div>
            ...
            >
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
                ...
                <div className="space-y-4 text-gray-600 dark:text-gray-400">
                  <p>You agree to indemnify, defend, and hold harmless SupplyChainPro and its officers, directors, employees, and agents from any claims, damages, losses, or expenses arising from:</p>
                  <ul className="space-y-2 ml-4">
                    <li className="flex items-start gap-2">
                      <HiOutlineCheckCircle className="w-4 h-4 text-green-500 dark:text-green-400 mt-0.5 shrink-0" />
            ...
            >
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
                ...
                <div className="space-y-4 text-gray-600 dark:text-gray-400">
                  ...
                  <p>Any legal action arising from these Terms shall be brought exclusively in the federal or state courts located in San Francisco County, California.</p>
                  <p className="text-sm">
            ...
            >
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
                ...
                <div className="space-y-4 text-gray-600 dark:text-gray-400">
                  ...
                  <p>Your continued use of our Services after the effective date constitutes your acceptance of the modified Terms.</p>
                </div>
              </div>
            </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
                ...
                <div className="space-y-3 text-gray-600 dark:text-gray-400">
                  ...
                  <div className="bg-gray-50 dark:bg-gray-900/50 rounded-xl p-4 space-y-2">
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400">{company.registration}</p>
                  </div>
                </div>
              </div>
            </div>
