...
/**
 * Security Policy Section III - AI-Powered Enterprise Security Hub
 *
 * Unique Design Elements:
 * - Video Integration for Key Security Concepts
 * - Multi-Tab Interface (Overview, Highlights, Controls, Certifications, Reports, FAQ)
 * - Interactive Highlights Carousel with Video Demos
 * - Security Controls Grid with Expandable Details and Videos
 * - Certifications Showcase with Watch/View Options
 * - Security Report Request Form with Validation
 * - Customer Testimonials Section
 * - Security Leadership Profile
                  ...
                  <div key={idx} className="bg-white dark:bg-gray-900 rounded-xl p-4 shadow-sm">
                    <div className="flex items-center gap-3 mb-2">
                      <div className="w-8 h-8 rounded-full bg-cyan-100 dark:bg-cyan-900/30 flex items-center justify-center">
                        <HiOutlineUserCircle className="w-5 h-5 text-cyan-600 dark:text-cyan-400" />
                      </div>
                      <div>
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-100 dark:border-gray-700 animate-fadeIn">
                      ...
                      {control.videoUrl && (
                        <button
                          ...
                          className="mt-3 inline-flex items-center gap-2 text-cyan-600 dark:text-cyan-400 text-sm font-semibold hover:underline"
                    ...
                    <div className="flex gap-2">
                      {cert.videoUrl && (
                        <button
                          ...
                          className="text-cyan-600 dark:text-cyan-400 text-xs font-semibold hover:underline flex items-center gap-1"
                          aria-label="Watch video"
                        >
        ...
        {activeTab === 'reports' && (
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-xl border border-gray-200 dark:border-gray-700">
            <div className="text-center mb-8">
              <HiOutlineDocumentText className="w-12 h-12 mx-auto text-cyan-600 dark:text-cyan-400 mb-4" />
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 bg-gray-50 dark:bg-gray-700 border rounded-xl focus:outline-none focus:ring-2 focus:ring-cyan-500 text-gray-900 dark:text-white ${reportRequestErrors.name ? 'border-red-500' : 'border-gray-200 dark:border-gray-600'
                        }`}
                      aria-label="Your full name"
                    />
                    {reportRequestErrors.name && <p className="text-red-500 dark:text-red-400 text-xs mt-1">{reportRequestErrors.name}</p>}
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 bg-gray-50 dark:bg-gray-700 border rounded-xl focus:outline-none focus:ring-2 focus:ring-cyan-500 text-gray-900 dark:text-white ${reportRequestErrors.email ? 'border-red-500' : 'border-gray-200 dark:border-gray-600'
                        }`}
                      aria-label="Your email address"
                    />
                    {reportRequestErrors.email && <p className="text-red-500 dark:text-red-400 text-xs mt-1">{reportRequestErrors.email}</p>}
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 bg-gray-50 dark:bg-gray-700 border rounded-xl focus:outline-none focus:ring-2 focus:ring-cyan-500 text-gray-900 dark:text-white ${reportRequestErrors.company ? 'border-red-500' : 'border-gray-200 dark:border-gray-600'
                        }`}
                      aria-label="Your company name"
                    />
                    {reportRequestErrors.company && <p className="text-red-500 dark:text-red-400 text-xs mt-1">{reportRequestErrors.company}</p>}
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className={`w-full px-4 py-3 bg-gray-50 dark:bg-gray-700 border rounded-xl focus:outline-none focus:ring-2 focus:ring-cyan-500 text-gray-900 dark:text-white ${reportRequestErrors.type ? 'border-red-500' : 'border-gray-200 dark:border-gray-600'
                        }`}
                    ...
                    {reportRequestErrors.type && <p className="text-red-500 dark:text-red-400 text-xs mt-1">{reportRequestErrors.type}</p>}
                  </div>
                ...
                <div key={idx} className="border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden">
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      {faq.videoUrl && (
                        <span className="text-cyan-500 dark:text-cyan-400 text-sm flex items-center gap-1">
                          <HiOutlinePlay className="w-4 h-4" />
