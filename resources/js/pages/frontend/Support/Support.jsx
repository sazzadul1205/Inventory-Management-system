...
const Support = ({ pageData = { meta: {}, sections: [] } }) => {
  ...
  const pageSeoData = useMemo(() => ({
    title: seo.title || meta.title || "Support | We're Here to Help You Succeed",
    description: seo.description || meta.description || "Find answers, access documentation, watch tutorials, or connect with our support team. Whatever you need, we're here to ensure your success.",
    keywords: seo.keywords || meta.keywords || "support, help center, knowledge base, video tutorials, documentation, ticket system, live chat, community forum, customer support, technical support",
    ogImage: seo.ogImage || meta.ogImage || "/support-og-image.jpg",
