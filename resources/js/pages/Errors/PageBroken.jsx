...
const PageBroken = ({ reason, errorCode = 500, errorMessage = "Page Error" }) => {
  ...
  }, [errorId, reason, errorCode]);

  // Function to reload the original page without cache
  const handleReload = () => {
  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta name="description" content="The page you're trying to access encountered an error and cannot be displayed properly. Please try again or contact support." />
        <meta name="robots" content="noindex, nofollow" />

        {/* Open Graph tags for error page */}
        <meta property="og:title" content={`${errorCode} - Page Error`} />
        <meta property="og:description" content="The page you're trying to access encountered an error and cannot be displayed properly." />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="Website" />

        {/* Twitter Card tags */}
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:title" content={`${errorCode} - Page Error`} />
        <meta name="twitter:description" content="The page you're trying to access encountered an error and cannot be displayed properly." />
      </Head>
