...
class PageSectionsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('page_sections')->insert([
            ...
            // News Page Section
            $this->command->info('Starting News page sections...'),
            [
                'id' => 112,
                'page_id' => 14,
            ...
            $this->command->info('Completed News page sections...'),

            // Partners Page Section
            $this->command->info('Starting Partners page sections...'),
            [
                'id' => 118,
                'page_id' => 15,
            ...
            $this->command->info('Completed Partners page sections...'),

            // Global Presence Page Section
            $this->command->info('Starting Global Presence page sections...'),
            [
                'id' => 125,
                'page_id' => 16,
            ...
            $this->command->info('Completed Global Presence page sections...'),

            // Careers Page Section
            $this->command->info('Starting Careers page sections...'),
            [
                'id' => 132,
                'page_id' => 17,
            ...
            $this->command->info('Completed Careers page sections...'),

            // Trust Signals Page Section
            $this->command->info('Starting Trust Signals page sections...'),
            [
                'id' => 139,
                'page_id' => 18,
            ...
            $this->command->info('Completed Trust Signals page sections...'),
